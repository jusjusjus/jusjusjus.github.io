!function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module ? t(exports, require('crypto'))  : 'function' == typeof define && define.amd ? define(['exports',
  'crypto'], t)  : t(e.tf = e.tf || {
  }, e.crypto)
  ...
  function shuffle(e) {
    for (var t = e.length, r = 0, n = 0; t > 0; ) n = Math.random() * t | 0,
    r = e[--t],
    e[t] = e[n],
    e[n] = r
  }
  ...
  function assertShapesMatch(e, t, r) {
    void 0 === r && (r = ''),
    assert(arraysEqual(e, t), r + ' Shapes ' + e + ' and ' + t + ' must match')
  }
  ...
  function flatten(e, t) {
    if (void 0 === t && (t = [
    ]), Array.isArray(e)) for (var r = 0; r < e.length; ++r) flatten(e[r], t);
     else t.push(e);
    return t
  }
  function inferShape(e) {
    ...
    for (var t = [
    ]; e instanceof Array; ) t.push(e.length),
    e = e[0];
    return t
  }
  ...
  function sizeToSquarishShape(e) {
    for (var t = Math.floor(Math.sqrt(e)); t > 1; --t) if (e % t == 0) return [t,
    e / t];
    return [1,
    e]
  }
  ...
  function inferFromImplicitShape(e, t) {
    for (var r = 1, n = - 1, a = 0; a < e.length; ++a) if (e[a] > 0) r *= e[a];
     else if ( - 1 === e[a]) {
  ...
  function squeezeShape(e, t) {
    for (var r = [
      ...
      if (null != t) {
        ...
        (null == t[a] || t[a] > o) && 1 === e[o] && (r.push(e[o]), n.push(o)),
        t[a] <= o && a++
      }
  ...
  function flattenNameArrayMap(e, t) {
    ...
    if (e instanceof Tensor) r.push(e);
     else for (var n = e, a = 0; a < t.length; a++) r.push(n[t[a]]);
    return r
  }
  ...
  function extractTensorsFromContainer(e) {
    return extractTensorsFromAny(e)
  }
  function extractTensorsFromAny(e) {
    if (null == e) return [];
    if (e instanceof Tensor) return [e];
    var t = [
    ],
    r = e;
    if (!isIterable(r)) return [];
    for (var n in r) {
      var a = flatten(r[n]).filter(function (e) {
  ...
  function tensorToString(e, t) {
    ...
    return t && (o.push('  dtype: ' + e.dtype), o.push('  rank: ' + e.rank), o.push('  shape: [' + e.shape + ']'), o.push('  values:')),
  ...
  function computeMaxSizePerColumn(e) {
    ...
    if (e.rank > 1) for (var o = 0; o < r / n; o++) for (var i = o * n, s = 0; s < n; s++) a[s] = Math.max(a[s], valToString(t[i + s], 0).length);
    return a
  }
  ...
  function subTensorToString(e, t, r, n, a) {
    ...
    for (var g = ',\n', y = 2; y < i; y++) g += '\n';
    return d[d.length - 1] = ' ' + d[d.length - 1] + ']' + (a ? '' : g),
    d
  }
  ...
  function combineLocations(e, t, r) {
    for (var n = e.length + t.length, a = [
    ], o = 0, i = 0, s = 0; s < n; s++) - 1 === r.indexOf(s) ? a.push(e[o++])  : a.push(t[i++]);
    return a
  }
  function computeOutAndReduceShapes(e, t) {
    for (var r = [
    ], n = e.length, a = 0; a < n; a++) - 1 === t.indexOf(a) && r.push(e[a]);
    return [r,
    t.map(function (t) {
      return e[t]
    })]
  ...
  function getAxesPermutation(e, t) {
    ...
    for (var r = [
    ], n = 0; n < t; ++n) - 1 === e.indexOf(n) && r.push(n);
  ...
  function getInnerMostAxes(e, t) {
    for (var r = [
    ], n = t - e; n < t; ++n) r.push(n);
    return r
  }
  function assertParams(e, t, r) {
    var n = e.length,
    a = t.length;
    assert(e.length === t.length, 'Error in concat' + n + 'D: rank of x1 (' + n + ') and x2 (' + a + ') must be the same.'),
    assert(r >= 0 && r < n, 'Error in concat' + n + 'D: axis must be between 0 and ' + (n - 1) + '.');
  ...
  function operation(e, t, r) {
    ...
    return r.value = function () {
      for (var e = [
      ], r = 0; r < arguments.length; r++) e[r] = arguments[r];
  ...
  function assertAndGetBroadcastShape(e, t) {
    for (var r = [
    ], n = 'Operands could not be broadcast together with shapes ' + e + ' and ' + t + '.', a = Math.max(e.length, t.length), o = 0; o < a; o++) {
  ...
  function assertParamsValid(e, t, r) {
    assert(e.rank === t.length, 'Error in slice' + e.rank + 'D: Length of begin ' + t + ' must match the rank of the array (' + e.rank + ').'),
    assert(e.rank === r.length, 'Error in slice' + e.rank + 'D: Length of size ' + r + ' must match the rank of the array (' + e.rank + ').');
  ...
  function getStridedSlicedInfo(e, t, r, n, a, o) {
    ...
    ], u = 0; u < e.length; u++) i[u] = startForAxis(a, t, n, e, u),
    s[u] = stopForAxis(o, r, n, e, u);
  ...
  function stopForAxis(e, t, r, n, a) {
    ...
    var i = n[a];
    return o < 0 && (o += i),
    o = r[a] > 0 ? clamp(0, o, i)  : clamp( - 1, o, i - 1)
  }
  ...
  function getFilteredNodesXToY(e, t, r) {
    ...
    }, o = 0; o < t.length; o++) n[t[o].id] = !0;
    for (o = 0; o < e.length; o++) {
      d = (m = e[o]).inputs;
      for (var i in d) {
        for (var s = d[i], u = !1, l = 0; l < t.length; l++) if (n[s.id]) {
          n[m.output.id] = !0,
          u = !0,
          a[m.id] = !0;
          break
    ...
    for (var p = {
      ...
      h.push(m.output);
      for (l = 0; l < h.length; l++) if (c[h[l].id]) {
        for (var i in d) c[d[i].id] = !0,
        p[m.id] = !0;
        break
      }
    }
  ...
  function getWebGLDisjointQueryTimerVersion(e) {
    if (0 === e) return 0;
    var t,
    r = getWebGLRenderingContext(e);
    return t = hasExtension(r, 'EXT_disjoint_timer_query_webgl2') && 2 === e ? 2 : hasExtension(r, 'EXT_disjoint_timer_query') ? 1 : 0,
    null != r && loseContext(r),
    t
  }
  function isFloatTextureReadPixelsEnabled(e) {
    ...
    t.texImage2D(t.TEXTURE_2D, 0, a, 1, 1, 0, t.RGBA, t.FLOAT, null),
  ...
  function getOrMakeEnvironment() {
    ...
    return e.ENV = e.ENV || new Environment(getFeaturesFromURL()),
    e.ENV
  }
  ...
  function encodeMatrixToUnpackedArray(e, t, r) {
    ...
    for (var a = 0, o = 0; o < e.length; ++o) t[a] = e[o],
    a += r
  }
  function encodeFloatArray(e) {
    for (var t = new Uint8Array(4 * e.length), r = 0; r < t.length; r += 4) !function (r) {
      var n = e[r / 4];
      if (isNaN(n)) return t[r] = BYTE_NAN_VALUE,
      t[r + 1] = BYTE_NAN_VALUE,
      t[r + 2] = BYTE_NAN_VALUE,
      t[r + 3] = BYTE_NAN_VALUE,
      'continue';
  ...
  function decodeToFloatArray(e) {
    for (var t = new Float32Array(e.length / 4), r = 0; r < e.length; r += 4) !function (r) {
      if (e[r] === BYTE_NAN_VALUE && e[r + 1] === BYTE_NAN_VALUE && e[r + 2] === BYTE_NAN_VALUE && e[r + 3] === BYTE_NAN_VALUE) return t[r / 4] = NaN,
      'continue';
      var n = 0;
  ...
  function decodeMatrixFromUnpackedColorRGBAArray(e, t, r) {
    var n = e.length * r / 4;
    if (t.length < n) throw new Error('matrix length (' + t.length + ') must be >= ' + n);
    for (var a = 0, o = 0; o < e.length; o += 4) for (var i = 0; i < r; i++) t[a++] = e[o + i]
  }
  ...
  function encodeMatrixToPackedRGBA(e, t, r, n) {
    ...
    if (u) for (var v = r - 1, f = 4 * (i - 1), b = 2 * r, d = 4 * i, m = 0; m < p; ++m) n[f] = e[v],
    n[f + 2] = e[v + r],
    v += b,
    f += d;
    if (l) for (var v = (t - 1) * r, f = (s - 1) * i * 4, y = 0; y < c; ++y) n[f++] = e[v++],
    n[f++] = e[v++],
    f += 2;
    return u && l && (n[n.length - 4] = e[e.length - 1]),
    n
  }
  function decodeMatrixFromPackedRGBA(e, t, r, n) {
    ...
    if (o) for (var f = 4 * (c - 1), v = r - 1, d = 4 * c, h = 2 * r, y = 0; y < u; ++y) n[v] = e[f],
    n[v + r] = e[f + 2],
    f += d,
    v += h;
    if (i) for (var f = (p - 1) * c * 4, v = (t - 1) * r, b = 0; b < s; ++b) n[v++] = e[f++],
    n[v++] = e[f++],
    f += 2;
    return o && i && (n[n.length - 1] = e[e.length - 4]),
    n
  }
  ...
  function getInputSamplingSnippet(e, t, r) {
    ...
    return n += getSamplerFromInInfo(e),
    (r || arraysEqual(e.shapeInfo.logicalShape, t.logicalShape)) && (n += getSamplerAtOutputCoords(e, t, r)),
    n
  }
  ...
  function squeezeInputInfo(e, t) {
    ...
    return r.shapeInfo.logicalShape = t,
    r
  }
  ...
  function getSourceCoords(e, t) {
    ...
    ], o = 0; o < e.length; o++) o === t ? a.push('int(getIndices(' + n[o] + '))')  : a.push('' + n[o]);
    return a.join()
  }
  function createWebGLRenderingContext(e) {
    ...
    return t.width = 1,
    t.height = 1,
    createWebGLRenderingContextFromCanvas(t, e)
  }
  function createWebGLRenderingContextFromCanvas(e, t) {
    var r,
    n = ENV.get('WEBGL_VERSION');
  ...
  function createVertexShader(e, t) {
    ...
    }), !1 === e.getShaderParameter(r, e.COMPILE_STATUS)) throw console.log(e.getShaderInfoLog(r)),
  ...
  function createFragmentShader(e, t) {
    ...
    if (callAndCheck(e, function () {
      ...
      return e.compileShader(r)
    }), !1 === e.getShaderParameter(r, e.COMPILE_STATUS)) throw logShaderSourceAndInfoLog(t, e.getShaderInfoLog(r)),
    new Error('Failed to compile fragment shader.');
    return r
  }
  function logShaderSourceAndInfoLog(e, t) {
    var r = lineNumberRegex.exec(t);
    if (null == r) return console.log('Couldn\'t parse line number in error: ' + t),
    void console.log(e);
    ...
    console.log(l.join('\n')),
    console.log(t.split('\n') [0]),
    console.log('%c ' + rightPad(c[0], s), 'border:1px solid red; background-color:#e3d2d2; color:#a61717'),
    console.log(p.join('\n'))
  }
  ...
  function linkProgram(e, t) {
    ...
    }), !1 === e.getProgramParameter(t, e.LINK_STATUS)) throw console.log(e.getProgramInfoLog(t)),
    new Error('Failed to link vertex and fragment shaders.')
  }
  function validateProgram(e, t) {
    if (callAndCheck(e, function () {
      return e.validateProgram(t)
    }), !1 === e.getProgramParameter(t, e.VALIDATE_STATUS)) throw console.log(e.getProgramInfoLog(t)),
  ...
  function getTextureShapeFromLogicalShape(e, t) {
    ...
    return t.length <= 1 && n <= r ? [
      n,
      1
    ] : 2 === t.length && t[0] <= r && t[1] <= r ? t : 3 === t.length && t[0] <= r && t[1] * t[2] <= r ? [
      t[0],
      t[1] * t[2]
    ] : 4 === t.length && t[0] <= r && t[1] * t[2] * t[3] <= r ? [
      t[0],
      t[1] * t[2] * t[3]
  ...
  function createWebGLContext(e) {
    var t,
    r = getWebGLContextAttributes();
    return t = null != e ? createWebGLRenderingContextFromCanvas(e, r)  : createWebGLRenderingContext(r),
  ...
  function createVertexBuffer(e) {
    return createStaticVertexBuffer(e, new Float32Array([ - 1,
    1,
    0,
    0,
    1,
  ...
  function createIndexBuffer(e) {
    return createStaticIndexBuffer(e, new Uint16Array([0,
    1,
    2,
    2,
    1,
  ...
  function uploadMatrixToTexture(e, t, r, n, a, o) {
    var i,
    s = getUnpackedMatrixTextureShapeWidthHeight(r, n),
    u = s[0],
    l = s[1];
  ...
  function getDownloadTargetArrayBuffer(e, t, r) {
    return ENV.get('WEBGL_FLOAT_TEXTURE_ENABLED') ? new Float32Array(getUnpackedArraySizeFromMatrixSize(e * t, r))  : new Uint8Array(e * t * r)
  }
  function decodeDownloadTargetArrayBuffer(e, t, r, n) {
    if (ENV.get('WEBGL_FLOAT_TEXTURE_ENABLED')) {
      var a = new Float32Array(t * r);
      return decodeMatrixFromUnpackedArray(e, a, n),
      a
    }
      ...
      return __generator$3(this, function (l) {
        switch (l.label) {
          case 0:
            return a = e,
            o = 4,
            i = getDownloadTargetArrayBuffer(r, n, o),
            s = i instanceof Float32Array ? 4 * i.length : i,
            u = e.createBuffer(),
            callAndCheck(e, function () {
            ...
            [
              4,
              t.getBufferSubDataAsync(a.PIXEL_PACK_BUFFER, 0, i)
            ];
          case 1:
            return l.sent(),
            [
              2,
              decodeDownloadTargetArrayBuffer(i, r, n, o)
            ]
        }
      })
    })
  ...
  function downloadMatrixFromRGBAColorTexture(e, t, r, n) {
    ...
    return decodeMatrixFromUnpackedColorRGBAArray(i, u, n),
    u
  }
  ...
  function compileProgram(e, t, r, n) {
    ...
    }, u = makeShader(o, s, a, !0 === t.supportsBroadcasting), l = e.createProgram(u), c = {
  ...
  function runProgram(e, t, r, n) {
    validateBinaryAndProgram(e.inShapeInfos, t),
    validateBinaryAndProgram([e.outShapeInfo], [
      r
    ]);
    var a = r.texData.texture,
    o = r.texData.texShape,
    i = e.gpgpu;
    i.setOutputMatrixTexture(a, o[0], o[1]),
    i.setProgram(e.webGLProgram),
    ...
    shouldUploadNaNUniform() && i.gl.uniform1f(e.uniformLocations[NAN_UNIFORM_NAME], NaN),
    null != n && n(i, e.webGLProgram),
    i.executeProgram()
  }
  ...
  function getSourceCoords$1(e) {
    ...
    ], a = 0; a < e.length; a++) n.push('imod(' + r[a] + ', ' + e[a] + ')');
    return n.join()
  }
  function getSwitchedCoords(e) {
    ...
    for (var r = [
      ...
      'resRC.z',
      'resRC.w'
    ], n = new Array(t), a = 0; a < e.length; a++) n[e[a]] = r[a];
    return n.join()
  }
  function STEP(e) {
    return void 0 === e && (e = 0),
  ...
  function concatenateTypedArrays(e) {
    ...
    n = 0;
    return e.forEach(function (e) {
      r.set(new Uint8Array(e.buffer), n),
      e instanceof Float32Array || e instanceof Int32Array ? n += 4 * e.length : n += e.length
    }),
    r.buffer
  }
  ...
  function cloneModelInternal(e, t, r) {
    ...
    __awaiter$8(this, void 0, void 0, function () {
      ...
      return __generator$8(this, function (d) {
        switch (d.label) {
          case 0:
            return assert(e !== t, 'Old path and new path are the same: \'' + e + '\''),
            n = IORouterRegistry.getLoadHandlers(e),
            assert(n.length > 0, 'Copying failed because no load handler is found for source URL ' + e + '.'),
            assert(n.length < 2, 'Copying failed because more than one (' + n.length + ') load handlers for source URL ' + e + '.'),
            a = n[0],
            o = IORouterRegistry.getSaveHandlers(t),
            assert(o.length > 0, 'Copying failed because no save handler is found for destination URL ' + t + '.'),
            assert(o.length < 2, 'Copying failed because more than one (' + n.length + ') save handlers for destination URL ' + t + '.'),
            i = o[0],
            s = parseURL(e).scheme,
            u = parseURL(e).path,
            l = s === parseURL(e).scheme,
            [
              4,
              a.load()
            ];
  ...
  function browserDownloads(e) {
    return void 0 === e && (e = 'model'),
    new BrowserDownloads(e)
  }
  ...
  function loadWeights(e, t, r, n) {
    return void 0 === t && (t = ''),
    __awaiter$13(this, void 0, void 0, function () {
      var a,
      o,
      i,
      s,
      ...
      h,
      f;
      return __generator$13(this, function (m) {
        switch (m.label) {
          case 0:
            if (a = e.map(function () {
              return !1
            }), o = {
            }, i = null != r ? r.map(function () {
              return !1
            })  : [
            ], s = [
          ...
          case 2:
            ...
            l.forEach(function (t) {
              for (var r = e[t].paths.length, n = 0, a = 0; a < r; a++) n += d[f + a].byteLength;
              for (var i = new ArrayBuffer(n), s = new Uint8Array(i), u = 0, l = 0; l < r; l++) {
                var c = new Uint8Array(d[f + l]);
                s.set(c, u),
                u += c.byteLength
              }
              o[t].forEach(function (e) {
                var t,
                r = i.slice(e.groupOffset, e.groupOffset + e.sizeBytes),
                ...
                if (null != h[s]) throw new Error('Duplicate weight with name ' + s + '. Please make sure weights names are unique in the manifest JSON.');
                h[s] = tensor(t, e.manifestEntry.shape, e.manifestEntry.dtype)
              }),
              f += r
            }),
            [
  ...
  function expectValuesInRange(e, t, r) {
    ...
    for (var a = 0; a < n.length; a++) if (n[a] < t || n[a] > r) throw new Error('Value out of range:' + n[a] + ' low: ' + t + ', high: ' + r)
  }
  function pyListRepeat(e, t) {
    if (Array.isArray(e)) {
      for (var r = [
      ], n = 0; n < t; n++) r = r.concat(e);
      return r
    }
    return (r = new Array(t)).fill(e),
    r
  }
  ...
  function deserializeKerasObject(e, t, r, n) {
    ...
    u = void 0,
    l = void 0;
    if (s in r ? (u = (_ = r.get(s)) [0], l = _[1])  : s in _GLOBAL_CUSTOM_OBJECTS ? (u = (S = _GLOBAL_CUSTOM_OBJECTS.className) [0], l = S[1])  : s in t && (u = (A = t[s]) [0], l = A[1]), null == u) throw new ValueError('Unknown ' + n + ': ' + s);
    if (null != l) {
      for (var c = {
      }, p = 0, d = Object.keys(_GLOBAL_CUSTOM_OBJECTS); p < d.length; p++) c[x = d[p]] = _GLOBAL_CUSTOM_OBJECTS[x];
      for (var h = 0, f = Object.keys(r); h < f.length; h++) c[x = f[h]] = r[x];
      i.config.customObjects = c;
      for (var m = __assign({
      }, _GLOBAL_CUSTOM_OBJECTS), g = 0, y = Object.keys(r); g < y.length; g++) {
        x = y[g];
    ...
    for (var m = __assign({
    }, _GLOBAL_CUSTOM_OBJECTS), v = 0, b = Object.keys(r); v < b.length; v++) {
      var x = b[v];
      _GLOBAL_CUSTOM_OBJECTS[x] = r[x]
    }
  ...
  function nameScope(e, t) {
    ...
    try {
      var r = t();
      return _nameScopeStack.pop(),
      r
    } catch (e) {
      throw _nameScopeStack.pop(),
      e
    }
  }
  ...
  function toArray1D(e) {
    return e = Array.isArray(e) ? new Float32Array(e)  : e,
    tensor1d(e)
  }
  function min$1(e) {
  ...
  function getScalar(e, t) {
    return void 0 === t && (t = DEFAULT_DTYPE),
    null == scalarCache[t][e] && (scalarCache[t][e] = scalar(e, t), keep(scalarCache[t][e])),
    scalarCache[t][e]
  }
  function shape(e) {
    return e.shape
...
n = e.shape[1],
a = e.shape[2];
return e = e.reshape([r * n,
a]),
matMul(e, t).reshape([r,
n,
t.shape[1]])
}
...
return tidy(function () {
return t = Array.isArray(t) ? tensor1d(t, 'int32')  : t.toInt(),
gather(e, t, r)
})
}
function square$1(e) {
...
return tidy(function () {
  ...
  var n,
  a = t.shape;
  if (5 === e.rank) 'channelsFirst' === r ? n = 1 === a.length ? e.add(t.reshape([1,
  a[0], 1, 1, 1]))  : e.add(t.reshape([1, a[3], a[0], a[1], a[2]]))  : 'channelsLast' === r && (n = 1 === a.length ? e.add(t.reshape([1,
  1, 1, 1,
  a[0]]))  : e.add(t.reshape([1].concat(a))));
   else if (4 === e.rank) 'channelsFirst' === r ? n = 1 === a.length ? e.add(t.reshape([1,
  a[0], 1, 1]))  : e.add(t.reshape([1,
  a[2], a[0], a[1]]))  : 'channelsLast' === r && (n = 1 === a.length ? e.add(t.reshape([1,
  1, 1, a[0]]))  : e.add(t.reshape([1].concat(a))));
   else if (3 === e.rank) 'channelsFirst' === r ? n = 1 === a.length ? e.add(t.reshape([1,
  a[0], 1]))  : e.add(t.reshape([1,
  a[1], a[0]]))  : 'channelsLast' === r && (n = 1 === a.length ? e.add(t.reshape([1,
  1, a[0]]))  : e.add(t.reshape([1].concat(a))));
   else {
...
return a = mul(div(getScalar(1), sub(getScalar(1), t)), a),
mul(e, a)
})
}
...
function getUid(e) {
return void 0 === e && (e = ''),
e in _uidPrefixes || (_uidPrefixes[e] = 0),
_uidPrefixes[e] += 1,
e + _uidPrefixes[e].toString()
}
function hardSigmoid(e) {
return tidy(function () {
var t = scalarPlusArray(getScalar(0.5), scalarTimesArray(getScalar(0.2), e));
...
deserializeKerasObject(e, SerializationMap.getMap().classNameMap, t, 'constraint')
}
...
function deserialize(e, t) {
  ...
  deserializeKerasObject(e, SerializationMap.getMap().classNameMap, t, 'layer')
}
...
function convertPythonicToTs(e, t) {
  ...
  for (var i = {
  }, s = 0, u = Object.keys(e); s < u.length; s++) {
  var l = u[s],
  c = e[l];
...
for (var a = [
], o = 0; o < n.inboundLayers.length; o++) for (var i = 0, s = getSourceInputs(n.inputTensors[o], n.inboundLayers[o], n.nodeIndices[o]); i < s.length; i++) {
var u = s[i];
...
for (var r = {
}, n = 0, a = 0, o = t; a < o.length; a++) for (var i = 0, s = o[a].weights; i < s.length; i++) {
var u = s[i];
...
}, s = 0, u = t; s < u.length; s++) null != (b = u[s]).name && (null == i[b.name] && (i[b.name] = [
]), i[b.name].push(b));
for (var l = e.weights, c = [
], p = 0; p < o.length; ++p) {
var d = o[p],
h = l[d];
null == h && (h = [
...
for (var y = 0, v = i[d]; y < v.length; y++) {
  ...
  for (var w = 0; w < f.length; ++w) !r || arraysEqual(x[w].shape, f[w].shape) ? c.push([x[w],
  f[w].read()])  : console.warn('Skipping loading of weights for layer ' + b.name + ' due to mismatch in shape (' + x[w].shape + ' vs ' + f[w].shape + ')')
}
}
batchSetValue(c)
}
...
return null == e ? null : e instanceof Callback ? [
e
] : Array.isArray(e) && e[0] instanceof Callback ? e : toList(e).map(function (e) {
...
return t = clipByValue(t, epsilon$1(), 1 - epsilon$1()),
neg(sum(mul(e.toFloat(), log(t)), shape(t).length - 1))
})
}
...
return tidy(function () {
var r;
return r = clipByValue(t, epsilon$1(), 1 - epsilon$1()),
r = log(div(r, sub(onesLike(r), r))),
mean(sigmoidCrossEntropyWithLogits(e, r), - 1)
})
}
...
return tidy(function () {
var r = scalarTimesArray(getScalar(0.5), onesLike(t)),
...
RMSProp: function () {
  return train.rmsprop(0.001, 0.9, null, epsilon$1())
},
SGD: function () {
...
for (var r = 0; r < e.shape.length; ++r) if (null != e.shape[r] && e.shape[r] !== t.shape[r]) throw new ValueError('The ' + r + '-th dimension of the feed (' + t.shape[r] + ') is incompatible with that of the key (' + e.shape[r] + ').')
}
}
function execute(e, t, r) {
for (var n = Array.isArray(e), a = n ? e : [
e
], o = [
], i = new FeedDict(t), s = 0, u = a; s < u.length; s++) {
var l = u[s];
...
for (var u = getNodeOutputs(e), l = Array.isArray(u) ? u : [
u
], c = 0; c < l.length; ++c) t.add(l[c], s[c]);
...
for (var r = null, n = 0; n < e.sourceLayer.inboundNodes.length; ++n) for (var a = 0, o = e.sourceLayer.inboundNodes[n].outputTensors; a < o.length; a++) if (o[a].id === e.id) {
  r = n;
  break
}
...
if (null != r) for (var p = 0; p < t.length; ++p) if (null != r[p]) {
var d = s[p];
...
for (var h = 0; h < r[p].length; ++h) if (0 !== h || n) {
  var f = d.shape[h],
  m = r[p][h];
...
if (null != i) {
  ...
  if ( - 1 !== n.indexOf(i)) for (var u = o.shape.slice(1), l = s.slice(1), c = 0; c < u.length; ++c) {
    var p = u[c],
    d = l[c];
...
if (null != r) for (var i = 0; i < t.length; ++i) if (null != r[i]) {
var s = o[i];
...
for (var u = 0; u < r[i].length; ++u) if (0 !== u || n) {
  var l = s.shape[u],
  c = r[i][u];
...
var r,
n;
if (checkDataFormat(t), 2 === e.length) r = e[0],
n = e[1];
 else if ( - 1 !== [3,
4,
5].indexOf(e.length)) {
...
deserializeKerasObject(e, SerializationMap.getMap().classNameMap, t, 'initializer')
}
...
deserializeKerasObject(e, SerializationMap.getMap().classNameMap, t, 'activation')
}
...
deserializeKerasObject(e, SerializationMap.getMap().classNameMap, t, 'regularizer')
}
...
var o,
i = t + (t - 1) * (a - 1);
return o = 'same' === r ? e : e - i + 1,
Math.floor((o + n - 1) / n)
}
function deconvLength(e, t, r, n) {
if (null == e) return null;
if ('valid' === n) e = e * t + max$1([r - t,
0]);
 else {
...
return tidy(function () {
return checkDataFormat(t),
'channelsFirst' === t ? transpose(e, [
  0,
  2,
  3,
  1
...
tidy(function () {
  ...
  if ('channelsFirst' === o && (e = transpose(e, [0, 2, 1])), 'causal' === a) {
...
return s = conv2d(s, t, n, 'same' === a ? 'same' : 'valid', 'NHWC', i),
null != r && (s = biasAdd(s, r)),
'channelsFirst' === o && (s = transpose(s, [0, 3, 1, 2])),
s
})
}
...
return i = depthwiseConv2d(i, t, r, 'same' === n ? 'same' : 'valid', 'NHWC', o),
'channelsFirst' === a && (i = transpose(i, [
  0,
  3,
  1,
  2
...
return void 0 === a && (a = 0.001),
tidy(function () {
var o = moments(e, n),
i = o.mean,
s = o.variance;
return [batchNormalization$1(e, i, s, r, t, a),
i,
s]
})
}
...
return void 0 === a && (a = 0.001),
tidy(function () {
for (var o = moments(e, n), i = o.mean, s = o.variance, u = [
], l = 0, c = range$1(0, e.rank); l < c.length; l++) {
  var p = c[l];
  - 1 !== n.indexOf(p) ? u.push(1)  : u.push(e.shape[p])
}
var d = i.reshape(u),
h = s.reshape(u),
f = null == t ? null : t.reshape(u),
m = null == r ? null : r.reshape(u);
return [batchNormalization$1(e, d, h, m, f, a),
i,
s]
})
}
...
return void 0 === a && (a = 0.001),
arraysEqual(n.slice().sort(), range$1(0, e.rank - 1)) ? regularNormalizeBatchInTraining(e, t, r, n, a)  : broadcastNormalizeBatchInTraining(e, t, r, n, a)
}
...
null == a && (a = imageDataFormat()),
null == o && (o = 'max'),
e = preprocessConv2DInput(e, a);
var i,
s = 'same' === n ? 'same' : 'valid';
return i = 'max' === o ? maxPool(e, t, r, s)  : avgPool(e, t, r, s),
'channelsFirst' === a && (i = transpose(i, [
  0,
  3,
  1,
...
p = g[0],
c = 0 === f ? p.reshape([1].concat(p.shape))  : concatAlongFirstAxis(c, p.reshape([1].concat(p.shape))),
d = g[1]
}
return [p,
transpose(c, [
1,
0
].concat(range$1(2, c.shape.length))),
d]
}
...
function modelFromJSON(e, t) {
  ...
  var r, n, a, o, i, s, u, l, c, p;
  return __generator$16(this, function (d) {
    switch (d.label) {
      case 0:
        return null != (r = e.modelTopology).model_config && (r = r.model_config),
        n = convertPythonicToTs(r),
        a = deserialize(n, t),
        null == e.weightsManifest ? [
          ...
          4,
          loadWeights(e.weightsManifest, e.pathPrefix, a.weights.map(function (e) {
            return e.originalName
          }))
        ];
      case 1:
        for (o = d.sent(), i = {
        }, s = 0, u = a.weights; s < u.length; s++) l = u[s],
        i[l.originalName] = o[l.originalName];
        c = null,
        p = !0,
        a.loadWeights(i, c, p),
        d.label = 2;
...
return __generator$16(this, function (r) {
  if ('string' == typeof e) {
    if (0 === (t = getLoadHandlers(e)).length) return [2,
    loadModelFromPath(e)];
    if (t.length > 1) throw new ValueError('Found more than one (' + t.length + ') load handlers for URL \'' + e + '\'');
    e = t[0]
  }
  return [2,
  loadModelFromIOHandler(e)]
})
})
}
...
a,
o;
return __generator$16(this, function (i) {
  switch (i.label) {
    case 0:
      ...
      e.load()];
    case 1:
      if (r = i.sent(), n = deserialize(convertPythonicToTs(r.modelTopology), t), null != r.weightData) {
        ...
        a = !1,
        o = !0,
        n.loadWeights(decodeWeights(r.weightData, r.weightSpecs), a, o)
      }
      return [2,
      n]
  }
...
return __generator$16(this, function (n) {
  switch (n.label) {
    ...
    case 2:
      if (null == (r = n.sent()).modelTopology) throw new ValueError('Missing field "modelTopology" from model JSON at path' + e);
      if (null == r.weightsManifest) throw new ValueError('Missing field "weightsManifest" from model JSON at path' + e);
      return r.pathPrefix = e.substring(0, e.lastIndexOf('/')),
      [
        2,
        modelFromJSON(r)
      ]
...
return util$1.isString(e) && (e = urlParse(e)),
...
function t(e, t, r, n) {
  ...
  if (a && (t = - t), 0 === t) e(1 / t > 0 ? 0 : 2147483648, r, n);
   ...
   else if (t > 3.4028234663852886e+38) e((a << 31 | 2139095040) >>> 0, r, n);
...
e.readDoubleLE = s ? n : a,
e.readDoubleBE = s ? a : n
}()  : function () {
function t(e, t, r, n, a, o) {
  var i = n < 0 ? 1 : 0;
  if (i && (n = - n), 0 === n) e(0, a, o + t),
  e(1 / n > 0 ? 0 : 2147483648, a, o + r);
   else if (isNaN(n)) e(0, a, o + t),
  e(2146959360, a, o + r);
   else if (n > 1.7976931348623157e+308) e(0, a, o + t),
  e((i << 31 | 2146435072) >>> 0, a, o + r);
   else {
    var s;
    if (n < 2.2250738585072014e-308) e((s = n / 5e-324) >>> 0, a, o + t),
    e((i << 31 | s / 4294967296) >>> 0, a, o + r);
     else {
      var u = Math.floor(Math.log(n) / Math.LN2);
      1024 === u && (u = 1023),
      e(4503599627370496 * (s = n * Math.pow(2, - u)) >>> 0, a, o + t),
      e((i << 31 | u + 1023 << 20 | 1048576 * s & 1048575) >>> 0, a, o + r)
    }
  }
}
...
for (; e.hi; ) t[r++] = 127 & e.lo | 128,
e.lo = (e.lo >>> 7 | e.hi << 25) >>> 0,
e.hi >>>= 7;
for (; e.lo > 127; ) t[r++] = 127 & e.lo | 128,
e.lo = e.lo >>> 7;
t[r++] = e.lo
}
...
n = r[0],
a = r[1];
return [getNodeNameWithContextId(n, t && t.currentContextId),
a]
}
...
for (var r = [
], n = 0; n < e.length; n += t) r.push(e.slice(n, n + t));
return r
}
...
return __generator$17(this, function (p) {
  switch (p.label) {
    ...
    case 1:
      return [2,
      [
        getParamValue('pred', e, t, r)
      ]];
    case 2:
      return a = getParamValue('pred', e, t, r),
    ...
    case 5:
      return s = getParamValue('frameName', e, t, r),
      u = getParamValue('tensor', e, t, r),
      r.enterFrame(s),
      [
        2,
        [
    ...
    case 6:
      return l = getParamValue('tensor', e, t, r),
      r.exitFrame(),
      [
        2,
        [
    ...
    case 7:
      return c = getParamValue('tensor', e, t, r),
      r.nextIteration(),
      [
        2,
        [
...
return __generator$19(this, function (a) {
  switch (a.label) {
    case 0:
      return n = new FrozenModel(e, t, r),
      [
        4,
        n.load()
      ];
...
crypto = crypto && crypto.hasOwnProperty('default') ? crypto.default:
crypto;
...
void 0 === t && (t = 0),
assert(e.length >= 1, 'Pass at least one tensor to concat'),
...
function o(e, t) {
  ...
  i.quick = i,
  o && ('object' == typeof o && a(o, r), i.state = function () {
    return a(r, {
    })
  }),
  i
...
function n(e) {
  ...
  e === (0 | e) ? t.x = e : r += e;
  for (var n = 0; n < r.length + 64; n++) t.x ^= 0 | r.charCodeAt(n),
  t.next()
}
function a(e, t) {
  return t.x = e.x,
...
function n(e) {
  ...
  function (e, t) {
    ...
    u = 128;
    for (t === (0 | t) ? (n = t, t = null)  : (t += '\0', n = 0, u = Math.max(u, t.length)), a = 0, o = - 32; o < u; ++o) t && (n ^= t.charCodeAt((o + 32) % t.length)),
    0 === o && (i = n),
    n ^= n << 10,
    n ^= n >>> 15,
    n ^= n << 4,
    n ^= n >>> 13,
    o >= 0 && (i = i + 1640531527 | 0, a = 0 == (r = s[127 & o] ^= n + i) ? a + 1 : 0);
    for (a >= 128 && (s[127 & (t && t.length || 0)] = - 1), a = 127, o = 512; o > 0; --o) n = s[a + 34 & 127],
    r = s[a = a + 1 & 127],
    n ^= n << 13,
    r ^= r << 17,
    n ^= n >>> 15,
...
function n(e) {
  ...
  for (var n = 0; n < r.length + 20; n++) t.b ^= 0 | r.charCodeAt(n),
  t.next()
}
function a(e, t) {
  return t.a = e.a,
...
function n(e, n, c) {
  ...
  b = new a(p),
  x = function () {
    for (var e = b.g(h), t = m, r = 0; e < g; ) e = (e + r) * d,
    t *= d,
    r = b.g(1);
    for (; e >= y; ) e /= 2,
    t /= 2,
...
function a(e) {
  ...
  for (a = 0; a < d; a++) i[a] = i[o = v & o + e[a % r] + (t = i[a])],
  i[o] = t;
  (n.g = function (e) {
    for (var t, r = 0, a = n.i, o = n.j, i = n.S; e--; ) t = i[a = v & a + 1],
    r = r * d + i[v & (i[a] = i[o = v & o + t]) + (i[o] = t)];
    return n.i = a,
    n.j = o,
    r
  }) (d)
...
function u() {
  try {
    var e;
    return c && (e = c.randomBytes) ? e = e(d)  : (e = new Uint8Array(d), (p.crypto || p.msCrypto).getRandomValues(e)),
    l(e)
  } catch (e) {
    var r = p.navigator,
    n = r && r.plugins;
...
for (var t, r, n = !1; !n; ) {
  ...
  r = this.mean + this.stdDev * o * s,
  this.truncated && !this.isValidTruncated(t) || (n = !0)
}
return this.truncated && !this.isValidTruncated(r) || (this.nextVal = this.convertValue(r)),
this.convertValue(t)
},
...
return null != n && (e = e.transpose(n), r = getInnerMostAxes(r.length, e.rank)),
ENV.engine.runKernel(function (t) {
...
assert('int32' === t.dtype, 'Segment Ids must be of dtype `int32`'),
n = parseAxisParam(n, e.shape) [0];
for (var a = [
], o = t.shape[0], i = [
], s = 0; s < e.shape.length; s++) s === n ? i.push(o)  : i.push(1);
...
__decorate$1([doc(),
operation], e, 'logSumExp', null),
__decorate$1([doc(),
operation], e, 'sum', null),
__decorate$1([doc(),
operation], e, 'mean', null),
__decorate$1([doc(),
operation], e, 'min', null),
__decorate$1([doc(),
operation], e, 'max', null),
__decorate$1([doc(),
operation], e, 'argMin', null),
__decorate$1([doc(),
operation], e, 'argMax', null),
__decorate$1([doc(),
operation], e, 'moments', null),
__decorate$1([doc(),
operation], e, 'unsortedSegmentSum', null),
e
}(),
...
void 0 === r && (r = 'float32');
var n = inferShape(e);
return null != t && 1 !== n.length && assertShapesMatch(t, n, 'Error creating a new Tensor. Inferred shape (' + n + ') does not match the provided shape (' + t + '). '),
...
e.ones(t.shape, t.dtype)
},
e.zerosLike = function (t) {
return assertArgumentsAreTensors({
  x: t
}, 'zerosLike'),
e.zeros(t.shape, t.dtype)
},
e.clone = function (e) {
assertArgumentsAreTensors({
  x: e
...
void 0 === a && (a = 'float32'),
null == r && (r = t);
for (var o = e.buffer([t,
r], a), i = t <= r ? t : r, s = 0; s < i; ++s) o.set(1, s, s);
var u = o.toTensor().as2D(t, r);
if (null == n) return u;
if (1 === n.length) return e.tile(e.expandDims(u, 0), [
  n[0],
  1,
  1
]);
if (2 === n.length) return e.tile(e.expandDims(e.expandDims(u, 0), 0), [
  n[0],
  n[1],
  1,
  1
  ...
  return __generator(this, function (w) {
    switch (w.label) {
      ...
      case 2:
        ...
        e.data()];
      case 3:
        for (c = w.sent(), p = 'float32' === e.dtype ? 255 : 1, d = new Uint8ClampedArray(a * n * 4), h = 0; h < n * a; ++h) f = void 0,
        m = void 0,
        g = void 0,
        y = void 0,
        1 === o ? (f = c[h] * p, m = c[h] * p, g = c[h] * p, y = 255)  : 3 === o ? (f = c[3 * h] * p, m = c[3 * h + 1] * p, g = c[3 * h + 2] * p, y = 255)  : 4 === o && (f = c[4 * h] * p, m = c[4 * h + 1] * p, g = c[4 * h + 2] * p, y = c[4 * h + 3] * p),
        d[(v = 4 * h) + 0] = Math.round(f),
        d[v + 1] = Math.round(m),
        d[v + 2] = Math.round(g),
        d[v + 3] = Math.round(y);
        return null != t && (t.width = a, t.height = n, b = t.getContext('2d'), x = new ImageData(d, a, n), b.putImageData(x, 0, 0)),
        [
          2,
          d
        ]
...
t = inferFromImplicitShape(t, e.size),
assert(e.size === sizeFromShape(t), 'new shape and old shape must have the same number of elements.');
...
e.reshape(t, squeezeShape(t.shape, r).newShape)
},
e.cast = function (e, t) {
assertArgumentsAreTensors({
  x: e
...
assert(t.rank === r.length, 'Error in transpose: rank of input ' + t.rank + ' must match length of reps ' + r + '.');
return ENV.engine.runKernel(function (e) {
  return e.tile(t, r)
}, {
  x: t
  ...
  return {
    x: function () {
      var a = e.zerosLike(t);
      if (1 === t.rank) for (o = 0; o < r[0]; ++o) a = a.add(n.slice([o * t.shape[0]], [
        t.shape[0]
      ]));
       else if (2 === t.rank) for (o = 0; o < r[0]; ++o) for (i = 0; i < r[1]; ++i) a = a.add(n.slice([o * t.shape[0],
      i * t.shape[1]], [
        t.shape[0],
        t.shape[1]
      ]));
       else if (3 === t.rank) for (o = 0; o < r[0]; ++o) for (i = 0; i < r[1]; ++i) for (s = 0; s < r[2]; ++s) a = a.add(n.slice([o * t.shape[0],
      i * t.shape[1],
      s * t.shape[2]], [
        t.shape[0],
        t.shape[1],
        ...
        for (var o = 0; o < r[0]; ++o) for (var i = 0; i < r[1]; ++i) for (var s = 0; s < r[2]; ++s) for (var u = 0; u < r[3]; ++u) a = a.add(n.slice([o * t.shape[0],
        i * t.shape[1],
        s * t.shape[2],
        u * t.shape[3]], [
          t.shape[0],
...
assert('int32' === t.dtype, 'Indices must be of dtype `int32`'),
r = parseAxisParam(r, e.shape) [0];
...
return void 0 === n && (n = 0),
assert(2 === r.length, 'Invalid number of paddings. Must be length of 2.'),
e.pad(t, [
  r
], n)
},
...
return void 0 === n && (n = 0),
assert(2 === r.length && 2 === r[0].length && 2 === r[1].length, 'Invalid number of paddings. Must be length of 2 each.'),
e.pad(t, r, n)
},
e.pad3d = function (t, r, n) {
return void 0 === n && (n = 0),
assert(3 === r.length && 2 === r[0].length && 2 === r[1].length && 2 === r[2].length, 'Invalid number of paddings. Must be length of 2 each.'),
e.pad(t, r, n)
},
e.pad4d = function (t, r, n) {
return void 0 === n && (n = 0),
assert(4 === r.length && 2 === r[0].length && 2 === r[1].length && 2 === r[2].length && 2 === r[3].length, 'Invalid number of paddings. Must be length of 2 each.'),
e.pad(t, r, n)
},
...
n = e[0].shape,
a = e[0].dtype;
assert(t <= r, 'Axis must be <= rank of the tensor'),
e.forEach(function (e) {
...
assert(r <= t.rank, 'Axis must be <= rank of the tensor');
var n = t.shape.slice();
return n.splice(r, 0, 1),
e.reshape(t, n)
},
...
new TensorBuffer(e, t, r)
},
e.print = function (e, t) {
void 0 === t && (t = !1),
console.log(tensorToString(e, t))
},
__decorate$2([doc()], e, 'tensor', null),
__decorate$2([doc()], e, 'scalar', null),
__decorate$2([doc()], e, 'tensor1d', null),
__decorate$2([doc()], e, 'tensor2d', null),
__decorate$2([doc()], e, 'tensor3d', null),
__decorate$2([doc()], e, 'tensor4d', null),
__decorate$2([doc(),
operation], e, 'ones', null),
__decorate$2([doc(),
operation], e, 'zeros', null),
__decorate$2([doc(),
operation], e, 'fill', null),
__decorate$2([doc(),
operation], e, 'onesLike', null),
__decorate$2([doc(),
operation], e, 'zerosLike', null),
__decorate$2([doc(),
operation], e, 'clone', null),
__decorate$2([doc(),
operation], e, 'eye', null),
__decorate$2([doc(),
operation], e, 'randomNormal', null),
__decorate$2([doc(),
operation], e, 'truncatedNormal', null),
__decorate$2([doc(),
operation], e, 'randomUniform', null),
__decorate$2([operation], e, 'rand', null),
__decorate$2([operation], e, 'multinomial', null),
__decorate$2([doc(),
operation], e, 'oneHot', null),
__decorate$2([doc(),
operation], e, 'fromPixels', null),
__decorate$2([doc()], e, 'toPixels', null),
__decorate$2([doc(),
operation], e, 'reshape', null),
__decorate$2([doc()], e, 'squeeze', null),
__decorate$2([doc(),
operation], e, 'cast', null),
__decorate$2([doc(),
operation], e, 'tile', null),
__decorate$2([doc(),
operation], e, 'gather', null),
__decorate$2([doc(),
operation], e, 'pad', null),
__decorate$2([doc(),
operation], e, 'stack', null),
__decorate$2([doc(),
operation], e, 'unstack', null),
__decorate$2([doc(),
operation], e, 'split', null),
__decorate$2([doc()], e, 'cumsum', null),
__decorate$2([doc(),
operation], e, 'expandDims', null),
__decorate$2([operation,
doc()], e, 'linspace', null),
__decorate$2([operation,
doc()], e, 'range', null),
__decorate$2([doc()], e, 'buffer', null),
__decorate$2([doc()], e, 'print', null),
e
}(),
...
return void 0 === a && (a = 0.001),
assert(2 === t.rank, 'Error in batchNormalization3D: x must be rank 3 but got rank ' + t.rank + '.'),
assert(2 === r.rank || 1 === r.rank, 'Error in batchNormalization2D: mean must be rank 2 or rank 1 but got rank ' + r.rank + '.'),
assert(2 === n.rank || 1 === n.rank, 'Error in batchNormalization2D: variance must be rank 2 or rank 1 but got rank ' + n.rank + '.'),
null != o && assert(2 === o.rank || 1 === o.rank, 'Error in batchNormalization2D: scale must be rank 2 or rank 1 but got rank ' + o.rank + '.'),
null != i && assert(2 === i.rank || 1 === i.rank, 'Error in batchNormalization2D: offset must be rank 2 or rank 1 but got rank ' + i.rank + '.'),
e.batchNormalization(t, r, n, a, o, i)
},
e.batchNormalization3d = function (t, r, n, a, o, i) {
return void 0 === a && (a = 0.001),
assert(3 === t.rank, 'Error in batchNormalization3D: x must be rank 3 but got rank ' + t.rank + '.'),
assert(3 === r.rank || 1 === r.rank, 'Error in batchNormalization3D: mean must be rank 3 or rank 1 but got rank ' + r.rank + '.'),
assert(3 === n.rank || 1 === n.rank, 'Error in batchNormalization3D: variance must be rank 3 or rank 1 but got rank ' + n.rank + '.'),
null != o && assert(3 === o.rank || 1 === o.rank, 'Error in batchNormalization3D: scale must be rank 3 or rank 1 but got rank ' + o.rank + '.'),
null != i && assert(3 === i.rank || 1 === i.rank, 'Error in batchNormalization3D: offset must be rank 3 or rank 1 but got rank ' + i.rank + '.'),
e.batchNormalization(t, r, n, a, o, i)
},
e.batchNormalization4d = function (t, r, n, a, o, i) {
return void 0 === a && (a = 0.001),
assert(4 === t.rank, 'Error in batchNormalization4D: x must be rank 4 but got rank ' + t.rank + '.'),
assert(4 === r.rank || 1 === r.rank, 'Error in batchNormalization4D: mean must be rank 4 or rank 1 but got rank ' + r.rank + '.'),
assert(4 === n.rank || 1 === n.rank, 'Error in batchNormalization4D: variance must be rank 4 or rank 1 but got rank ' + n.rank + '.'),
null != o && assert(4 === o.rank || 1 === o.rank, 'Error in batchNormalization4D: scale must be rank 4 or rank 1 but got rank ' + o.rank + '.'),
null != i && assert(4 === i.rank || 1 === i.rank, 'Error in batchNormalization4D: offset must be rank 4 or rank 1 but got rank ' + i.rank + '.'),
e.batchNormalization(t, r, n, a, o, i)
},
...
null != o && assertArgumentsAreTensors({
  offset: o
}, 'batchNormalization'),
assert(t.rank === r.rank, 'Batch normalization gradient requires mean and variance to have equal ranks.'),
assert(null == o || t.rank === o.rank, 'Batch normalization gradient requires mean and offset to have equal ranks.'),
assert(null == a || t.rank === a.rank, 'Batch normalization gradient requires mean and scale to have equal ranks.');
var i;
...
return ENV.engine.runKernel(function (e) {
  ...
  f = h.mul(h).mul(h).mul(ArrayOps.scalar( - 0.5));
  return {
    x: function () {
...
__decorate$3([operation], e, 'batchNormalization2d', null),
__decorate$3([operation], e, 'batchNormalization3d', null),
__decorate$3([operation], e, 'batchNormalization4d', null),
__decorate$3([doc()], e, 'batchNormalization', null),
e
}(),
DType;
!function (e) {
...
return ENV.engine.runKernel(function (r) {
  ...
  return {
    a: function () {
      ...
      return a.length > 0 && (t = t.sum(a)),
      t.reshape(e.shape)
    },
    b: function () {
      var e = n,
      a = getReductionAxes(t.shape, r);
      return a.length > 0 && (e = e.sum(a)),
      e.reshape(t.shape)
    }
  }
})
...
return assertShapesMatch(e.shape, t.shape, 'Error in addStrict: '),
e.add(t)
},
e.sub = function (e, t) {
assertArgumentsAreTensors({
...
return ENV.engine.runKernel(function (r) {
  ...
  return {
    ...
    b: function () {
      ...
      a = getReductionAxes(t.shape, r);
      return a.length > 0 && (e = e.sum(a)),
      e.neg().reshape(t.shape)
    }
  }
})
},
e.subStrict = function (e, t) {
return assertShapesMatch(e.shape, t.shape, 'Error in subStrict: '),
e.sub(t)
},
e.pow = function (e, t) {
assertArgumentsAreTensors({
...
var r = assertAndGetBroadcastShape(e.shape, t.shape);
e = e.cast(upcastType(e.dtype, t.dtype)),
t = t.cast(upcastType(e.dtype, t.dtype));
...
return assertShapesMatch(e.shape, t.shape, 'Error in powStrict: '),
e.pow(t)
},
e.mul = function (e, t) {
assertArgumentsAreTensors({
...
return assertShapesMatch(e.shape, t.shape, 'Error in multiplyStrict: '),
e.mul(t)
},
e.div = function (e, t) {
assertArgumentsAreTensors({
...
return assertShapesMatch(e.shape, t.shape, 'Error in divideStrict: '),
e.div(t)
},
e.mod = function (e, t) {
assertArgumentsAreTensors({
...
return assertShapesMatch(e.shape, t.shape, 'Error in modStrict: '),
e.mod(t)
},
...
return assertShapesMatch(e.shape, t.shape, 'Error in minimumStrict: '),
e.minimum(t)
},
...
return assertShapesMatch(e.shape, t.shape, 'Error in squaredDifferenceStrict: '),
e.squaredDifference(t)
},
...
__decorate$4([doc(),
operation], e, 'add', null),
__decorate$4([operation], e, 'addStrict', null),
__decorate$4([doc(),
operation], e, 'sub', null),
__decorate$4([operation], e, 'subStrict', null),
__decorate$4([doc(),
operation], e, 'pow', null),
__decorate$4([operation], e, 'powStrict', null),
__decorate$4([doc(),
operation], e, 'mul', null),
__decorate$4([operation], e, 'mulStrict', null),
__decorate$4([doc(),
operation], e, 'div', null),
__decorate$4([operation], e, 'divStrict', null),
__decorate$4([doc(),
operation], e, 'mod', null),
__decorate$4([operation], e, 'modStrict', null),
__decorate$4([doc(),
operation], e, 'minimum', null),
__decorate$4([operation], e, 'minimumStrict', null),
__decorate$4([doc(),
operation], e, 'maximum', null),
__decorate$4([operation], e, 'maximumStrict', null),
__decorate$4([doc(),
operation], e, 'squaredDifference', null),
__decorate$4([operation], e, 'squaredDifferenceStrict', null),
__decorate$4([operation], e, 'atan2', null),
e
}(),
...
assertTypesMatch(e, t),
assertAndGetBroadcastShape(e.shape, t.shape),
ENV.engine.runKernel(function (r) {
...
return assertShapesMatch(e.shape, t.shape, 'Error in notEqualStrict: '),
e.notEqual(t)
},
e.less = function (e, t) {
return assertArgumentsAreTensors({
...
return assertShapesMatch(e.shape, t.shape, 'Error in lessStrict: '),
e.less(t)
},
...
return assertShapesMatch(e.shape, t.shape, 'Error in equalStrict: '),
e.equal(t)
},
...
return assertShapesMatch(e.shape, t.shape, 'Error in lessEqualStrict: '),
e.lessEqual(t)
},
...
return assertShapesMatch(e.shape, t.shape, 'Error in greaterStrict: '),
e.greater(t)
},
...
return assertShapesMatch(e.shape, t.shape, 'Error in greaterEqualStrict: '),
e.greaterEqual(t)
},
__decorate$5([doc(),
operation], e, 'notEqual', null),
__decorate$5([operation], e, 'notEqualStrict', null),
__decorate$5([doc(),
operation], e, 'less', null),
__decorate$5([operation], e, 'lessStrict', null),
__decorate$5([doc(),
operation], e, 'equal', null),
__decorate$5([operation], e, 'equalStrict', null),
__decorate$5([doc(),
operation], e, 'lessEqual', null),
__decorate$5([operation], e, 'lessEqualStrict', null),
__decorate$5([doc(),
operation], e, 'greater', null),
__decorate$5([operation], e, 'greaterStrict', null),
__decorate$5([doc(),
operation], e, 'greaterEqual', null),
__decorate$5([operation], e, 'greaterEqualStrict', null),
e
}(),
...
var u = t,
l = !1;
2 === t.rank && (l = !0, u = t.as3D(1, t.shape[0], t.shape[1])),
assert(3 === u.rank, 'Error in conv1d: input must be rank 3, but got rank ' + u.rank + '.'),
...
var u = t,
l = !1;
3 === t.rank && (l = !0, u = t.as4D(1, t.shape[0], t.shape[1], t.shape[2])),
assert(4 === u.rank, 'Error in conv2d: input must be rank 4, but got rank ' + u.rank + '.'),
...
var l = i[3],
c = s.shape[3];
assert(4 === i.length, 'Error in conv2dDerInput: inShape must be length 4, but got length ' + i.length + '.'),
assert(4 === s.rank, 'Error in conv2dDerInput: dy must be rank 4, but got rank ' + s.rank),
assert(4 === r.rank, 'Error in conv2dDerInput: filter must be rank 4, but got rank ' + r.rank),
assert(l === r.shape[2], 'Error in conv2dDerInput: depth of input (' + l + ') must match input depth for filter ' + r.shape[2] + '.'),
assert(c === r.shape[3], 'Error in conv2dDerInput: depth of output (' + c + ') must match output depth for filter ' + r.shape[3] + '.'),
null != o && assert(isInt(a), 'Error in conv2dDerInput: pad must be an integer when using, dimRoundingMode ' + o + ' but got pad ' + a + '.');
...
var s = t;
3 === s.rank && (s = t.as4D(1, t.shape[0], t.shape[1], t.shape[2])),
assert(4 === i.rank, 'Error in conv2dDerFilter: input must be rank 4, but got shape ' + i.shape + '.'),
assert(4 === s.rank, 'Error in conv2dDerFilter: dy must be rank 4, but got shape ' + s.shape + '.'),
assert(4 === r.length, 'Error in conv2dDerFilter: filterShape must be length 4, but got ' + r + '.'),
assert(i.shape[3] === r[2], 'Error in conv2dDerFilter: depth of input ' + i.shape[3] + ') must match input depth in filter (' + r[2] + '.'),
assert(s.shape[3] === r[3], 'Error in conv2dDerFilter: depth of dy (' + s.shape[3] + ') must match output depth for filter (' + r[3] + ').'),
null != o && assert(isInt(a), 'Error in conv2dDerFilter: pad must be an integer when using, dimRoundingMode ' + o + ' but got pad ' + a + '.');
...
assert(4 === s.rank, 'Error in depthwiseConv2D: input must be rank 4, but got rank ' + s.rank + '.'),
assert(4 === t.rank, 'Error in depthwiseConv2D: filter must be rank 4, but got rank ' + t.rank + '.'),
assert(s.shape[3] === t.shape[2], 'Error in depthwiseConv2D: number of input channels (' + s.shape[3] + ') must match the inChannels dimension in filter ' + t.shape[2] + '.'),
null == o && (o = [
  1,
  1
]),
assert(eitherStridesOrDilationsAreOne(r, o), 'Error in depthwiseConv2d: Either strides or dilations must be 1. Got strides ' + r + ' and dilations \'' + o + '\''),
null != i && assert(isInt(n), 'Error in depthwiseConv2D: pad must be an integer when using, dimRoundingMode ' + i + ' but got pad ' + n + '.');
...
assert(4 === u.rank, 'Error in separableConv2d: input must be rank 4, but got rank ' + u.rank + '.'),
assert(4 === r.rank, 'Error in separableConv2d: depthwise filter must be rank 4, but got rank ' + r.rank + '.'),
assert(4 === n.rank, 'Error in separableConv2d: pointwise filter must be rank 4, but got rank ' + r.rank + '.'),
assert(1 === n.shape[0], 'Error in separableConv2d: the first dimension of pointwise filter  must be 1, but got ' + n.shape[0] + '.'),
assert(1 === n.shape[1], 'Error in separableConv2d: the second dimension of pointwise filter  must be 1, but got ' + n.shape[1] + '.');
var c = r.shape[2],
p = r.shape[3];
...
__decorate$6([doc(),
operation], e, 'conv1d', null),
__decorate$6([doc(),
operation], e, 'conv2d', null),
__decorate$6([operation], e, 'conv2dDerInput', null),
__decorate$6([operation], e, 'conv2dDerFilter', null),
__decorate$6([doc(),
operation], e, 'conv2dTranspose', null),
__decorate$6([doc(),
operation], e, 'depthwiseConv2d', null),
__decorate$6([doc(),
operation], e, 'separableConv2d', null),
e
}(),
...
assert(3 === e.rank || 4 === e.rank, 'Error in resizeBilinear: x must be rank 3 or 4, but got rank ' + e.rank + '.'),
assert(2 === t.length, 'Error in resizeBilinear: new shape must 2D, but got shape ' + t + '.');
var n = e,
a = !1;
...
assert(3 === e.rank || 4 === e.rank, 'Error in resizeNearestNeighbor: x must be rank 3 or 4, but got rank ' + e.rank + '.'),
assert(2 === t.length, 'Error in resizeNearestNeighbor: new shape must 2D, but got shape ' + t + '.'),
assert('float32' === e.dtype || 'int32' === e.dtype, '`images` must have `int32` or `float32` as dtype');
var n = e,
a = !1;
3 === e.rank && (a = !0, n = e.as4D(1, e.shape[0], e.shape[1], e.shape[2]));
var o = t[0],
...
__decorate$7([doc(),
operation], e, 'resizeBilinear', null),
__decorate$7([doc(),
operation], e, 'resizeNearestNeighbor', null),
e
}(),
...
var a = t();
return a instanceof Promise && console.error('Cannot return a Promise inside of tidy.'),
ENV.engine.endScope(a, r),
a
},
e.dispose = function (e) {
extractTensorsFromAny(e).forEach(function (e) {
  return e.dispose()
})
},
e.keep = function (e) {
...
__decorate$8([doc()], e, 'tidy', null),
__decorate$8([doc()], e, 'keep', null),
__decorate$8([doc()], e, 'time', null),
e
}(),
...
if (Array.isArray(e)) {
  t = !1,
  assert(null != e && e.length > 0, 'Gram-Schmidt process: input must not be null, undefined, or empty');
...
e = split(e, e.shape[0], 0).map(function (e) {
  return squeeze(e, [
    0
  ])
});
...
for (var a = [
], o = e, n = 0; n < e.length; ++n) !function (e) {
...
assert('bool' === e.dtype, 'Error Array must be of type bool.'),
ENV.engine.runKernel(function (t) {
...
assert('bool' === e.dtype && 'bool' === t.dtype, 'Error Array must be of type bool.'),
assertAndGetBroadcastShape(e.shape, t.shape),
ENV.engine.runKernel(function (r) {
...
assert('bool' === t.dtype && 'bool' === r.dtype, 'Error Array must be of type bool.'),
assertAndGetBroadcastShape(t.shape, r.shape),
e.logicalOr(t, r).logicalAnd(e.logicalAnd(t, r).logicalNot())
},
...
assert('bool' === e.dtype || 'bool' === t.dtype || 'bool' === r.dtype, 'Error Array must be of type bool.'),
assertShapesMatch(t.shape, r.shape, 'Error in where: '),
1 === e.rank ? assert(e.shape[0] === t.shape[0], 'The first dimension of `a` must match the size of `condition`.')  : assertShapesMatch(e.shape, r.shape, 'Error in where: ');
...
__decorate$10([doc(),
operation], e, 'logicalNot', null),
__decorate$10([doc(),
operation], e, 'logicalAnd', null),
__decorate$10([doc(),
operation], e, 'logicalOr', null),
__decorate$10([doc(),
operation], e, 'logicalXor', null),
__decorate$10([doc(),
operation], e, 'where', null),
e
}(),
...
null != t && assertArgumentsAreTensors({
  weights: t
}, 'computeWeightedLoss');
...
null != n && assertArgumentsAreTensors({
  weights: n
}, 'absoluteDifference'),
assertShapesMatch(t.shape, r.shape, 'Error in absoluteDifference: ');
var o = t.sub(r).abs();
...
assertShapesMatch(t.shape, r.shape, 'Error in meanSquaredError: ');
var o = t.squaredDifference(r);
return e.computeWeightedLoss(o, n, a)
},
e.cosineDistance = function (t, r, n, a, o) {
void 0 === o && (o = exports.Reduction.SUM_BY_NONZERO_WEIGHTS),
assertArgumentsAreTensors({
  labels: t,
  predictions: r
}, 'cosineDistance'),
...
assertShapesMatch(t.shape, r.shape, 'Error in cosineDistance: ');
...
assertShapesMatch(t.shape, r.shape, 'Error in hingeLoss: ');
var o = scalar(1);
...
assertShapesMatch(t.shape, r.shape, 'Error in logLoss: ');
var i = scalar(1),
s = scalar(a),
...
__decorate$11([doc(),
operation], e, 'computeWeightedLoss', null),
__decorate$11([doc(),
operation], e, 'absoluteDifference', null),
__decorate$11([doc(),
operation], e, 'meanSquaredError', null),
__decorate$11([doc(),
operation], e, 'cosineDistance', null),
__decorate$11([doc(),
operation], e, 'hingeLoss', null),
__decorate$11([doc(),
operation], e, 'logLoss', null),
e
}(),
...
assert(isInt(t), 'Error in localResponseNormalization3D: radius must be an integer\n                     but got radius ' + t + '.');
var o = e,
i = !1;
...
__decorate$12([doc(),
operation], e, 'localResponseNormalization', null),
e
}(),
...
return [f,
f.tanh().mulStrict(h.sigmoid())]
},
__decorate$13([doc(),
operation], e, 'multiRNNCell', null),
__decorate$13([doc(),
operation], e, 'basicLSTMCell', null),
e
}(),
...
assert(2 === e.rank && 2 === t.rank, 'Error in matMul: inputs must be rank 2, got ranks ' + e.rank + ' and ' + t.rank + '.'),
assert(a === o, 'Error in matMul: inner shapes (' + a + ') and (' + o + ') of Tensors with shapes ' + e.shape + ' and ' + t.shape + ' and transposeA=' + r + ' and transposeB=' + n + ' must match.');
return ENV.engine.runKernel(function (a) {
...
return assert(1 === e.rank, 'Error in vectorTimesMatrix: first input must be rank 1, but got rank ' + e.rank + '.'),
assert(2 === t.rank, 'Error in vectorTimesMatrix: second input must be rank 2, but got rank ' + t.rank + '.'),
assert(e.size === t.shape[0], 'Error in vectorTimesMatrix: size of vector (' + e.size + ') must match first dimension of matrix (' + t.shape[0] + ')'),
e.as2D(1, - 1).matMul(t).as1D()
},
e.matrixTimesVector = function (e, t) {
return assert(1 === t.rank, 'Error in matrixTimesVector: second input must rank 1, but got rank ' + t.rank + '.'),
assert(2 === e.rank, 'Error in matrixTimesVector: first input must be a rank 2, but got rank ' + e.rank + '.'),
assert(t.size === e.shape[1], 'Error in matrixTimesVector: size of first rank 1 input ' + t.size + ' must match inner dimension of second rank 2 input, but got shape ' + e.shape + '.'),
e.matMul(t.as2D( - 1, 1)).as1D()
},
e.dotProduct = function (e, t) {
return assert(1 === e.rank && 1 === t.rank, 'Error in dotProduct: inputs must be rank 1, but got ranks ' + e.rank + ' and ' + t.rank + '.'),
assert(e.size === t.size, 'Error in dotProduct: size of inputs (' + e.size + ') and (' + t.size + ') must match.'),
e.as2D(1, - 1).matMul(t.as2D( - 1, 1)).asScalar()
},
e.outerProduct = function (e, t) {
return assert(1 === e.rank && 1 === t.rank, 'Error in outerProduct: inputs must be rank 1, but got ranks ' + e.rank + ' and ' + t.rank + '.'),
e.as2D( - 1, 1).matMul(t.as2D(1, - 1))
},
__decorate$14([doc(),
operation], e, 'matMul', null),
__decorate$14([operation], e, 'vectorTimesMatrix', null),
__decorate$14([operation], e, 'matrixTimesVector', null),
__decorate$14([operation], e, 'dotProduct', null),
__decorate$14([doc(),
operation], e, 'outerProduct', null),
e
}(),
...
assertTypesMatch(e, t),
assert(arraysEqual(e.shape, t.shape), 'Shape mismatch in v and x');
var o = ArrayOps.scalar(1);
r = 'number' == typeof r ? ArrayOps.scalar(r)  : r;
var i = o.sub(r),
s = t.sub(e).mul(i);
return a && (assert(null != n, 'When using zeroDebias: true, step is required.'), n = 'number' == typeof n ? ArrayOps.scalar(n)  : n, s = s.div(o.sub(BinaryOps.pow(r, n)))),
e.add(s)
},
__decorate$15([doc(),
operation], e, 'movingAverage', null),
e
}(),
...
var i = t,
s = !1;
3 === t.rank && (s = !0, i = t.as4D(1, t.shape[0], t.shape[1], t.shape[2])),
assert(4 === i.rank, 'Error in maxPool: input must be rank 4 but got rank ' + i.rank + '.'),
null != o && assert(isInt(a), 'Error in maxPool: pad must be an integer when using, dimRoundingMode ' + o + ' but got pad ' + a + '.');
...
assert(t.rank === e.rank, 'Rank of input (' + t.rank + ') does not match rank of dy (' + e.rank + ')'),
assert(4 === e.rank, 'Error in maxPoolBackprop: dy must be rank 4 but got rank ' + e.rank + '.'),
assert(4 === t.rank, 'Error in maxPoolBackprop: input must be rank 4 but got rank ' + t.rank + '.'),
null != i && assert(isInt(o), 'Error in maxPoolBackprop: pad must be an integer when using, dimRoundingMode ' + i + ' but got pad ' + o + '.');
...
assert('float32' === t.dtype, 'The input dtype to avgPool must be float32');
var i = t,
s = !1;
3 === t.rank && (s = !0, i = t.as4D(1, t.shape[0], t.shape[1], t.shape[2])),
assert(4 === i.rank, 'Error in avgPool: x must be rank 4 but got rank ' + i.rank + '.'),
null != o && assert(isInt(a), 'Error in avgPool: pad must be an integer when using, dimRoundingMode ' + o + ' but got pad ' + a + '.');
...
i = e,
s = !1;
3 === t.rank && (s = !0, o = t.as4D(1, t.shape[0], t.shape[1], t.shape[2]), i = e.as4D(1, e.shape[0], e.shape[1], e.shape[2])),
assert(4 === i.rank, 'Error in avgPoolBackprop: dy must be rank 4 but got rank ' + i.rank + '.'),
assert(4 === o.rank, 'Error in avgPoolBackprop: input must be rank 4 but got rank ' + o.rank + '.');
...
__decorate$17([doc(),
operation], e, 'maxPool', null),
__decorate$17([operation], e, 'maxPoolBackprop', null),
__decorate$17([doc(),
operation], e, 'avgPool', null),
__decorate$17([operation], e, 'avgPoolBackprop', null),
e
}(),
...
return assert(1 === t.rank, 'slice1d expects a rank-1 tensor, but got a rank-' + t.rank + ' tensor'),
e.slice(t, [
  r
], [
  n
...
return assert(2 === t.rank, 'slice1d expects a rank-2 tensor, but got a rank-' + t.rank + ' tensor'),
e.slice(t, r, n)
},
e.slice3d = function (t, r, n) {
return assert(3 === t.rank, 'slice1d expects a rank-3 tensor, but got a rank-' + t.rank + ' tensor'),
e.slice(t, r, n)
},
e.slice4d = function (t, r, n) {
return assert(4 === t.rank, 'slice1d expects a rank-4 tensor, but got a rank-' + t.rank + ' tensor'),
e.slice(t, r, n)
},
...
n = 'number' == typeof t ? [
  t
].concat(new Array(e.rank - 1).fill(0))  : t.length < e.rank ? t.concat(new Array(e.rank - t.length).fill(0))  : t;
var a;
a = null == r ? new Array(e.rank).fill( - 1)  : 'number' == typeof r ? [
  r
].concat(new Array(e.rank - 1).fill( - 1))  : r.length < e.rank ? r.concat(new Array(e.rank - r.length).fill( - 1))  : r,
...
return customGrad(function (e, t) {
  var n = t.softmax(r);
  return {
    value: scalar(0.00001).add(n).log().mul(e).neg().sum([r]),
    gradFunc: function (t) {
      var a = expandShapeToKeepDim(t.shape, [
        r
      ]);
      return [t.reshape(a).mul(e.toFloat().sub(n)),
      t.reshape(a).mul(n.sub(e.toFloat()))]
    }
  }
}) (e, t)
},
__decorate$20([doc(),
operation], e, 'softmax', null),
__decorate$20([doc(),
operation], e, 'softmaxCrossEntropy', null),
e
}(),
...
ENV.engine.runKernel(function (i) {
...
return ENV.engine.runKernel(function (n) {
  ...
  return {
    x: function () {
      return n.where(e.greater(scalar(t)).logicalAnd(e.less(scalar(r))), zerosLike(n))
    }
  }
})
},
...
e.erf = function (e) {
assert('int32' === e.dtype || 'float32' === e.dtype, 'Input dtype must be `int32` or `float32`.'),
...
__decorate$23([doc(),
operation], e, 'neg', null),
__decorate$23([doc(),
operation], e, 'ceil', null),
__decorate$23([doc(),
operation], e, 'floor', null),
__decorate$23([doc(),
operation], e, 'sign', null),
__decorate$23([doc(),
operation], e, 'round', null),
__decorate$23([doc(),
operation], e, 'exp', null),
__decorate$23([doc(),
operation], e, 'expm1', null),
__decorate$23([doc(),
operation], e, 'log', null),
__decorate$23([doc(),
operation], e, 'log1p', null),
__decorate$23([doc(),
operation], e, 'sqrt', null),
__decorate$23([doc(),
operation], e, 'rsqrt', null),
__decorate$23([doc(),
operation], e, 'square', null),
__decorate$23([doc(),
operation], e, 'reciprocal', null),
__decorate$23([doc(),
operation], e, 'abs', null),
__decorate$23([doc(),
operation], e, 'clipByValue', null),
__decorate$23([doc(),
operation], e, 'relu', null),
__decorate$23([doc(),
operation], e, 'elu', null),
__decorate$23([doc(),
operation], e, 'selu', null),
__decorate$23([doc(),
operation], e, 'leakyRelu', null),
__decorate$23([doc(),
operation], e, 'prelu', null),
__decorate$23([doc(),
operation], e, 'sigmoid', null),
__decorate$23([doc(),
operation], e, 'logSigmoid', null),
__decorate$23([doc(),
operation], e, 'softplus', null),
__decorate$23([doc(),
operation], e, 'sin', null),
__decorate$23([doc(),
operation], e, 'cos', null),
__decorate$23([doc(),
operation], e, 'tan', null),
__decorate$23([doc(),
operation], e, 'asin', null),
__decorate$23([doc(),
operation], e, 'acos', null),
__decorate$23([doc(),
operation], e, 'atan', null),
__decorate$23([doc(),
operation], e, 'sinh', null),
__decorate$23([doc(),
operation], e, 'cosh', null),
__decorate$23([doc(),
operation], e, 'tanh', null),
__decorate$23([doc(),
operation], e, 'asinh', null),
__decorate$23([doc(),
operation], e, 'acosh', null),
__decorate$23([doc(),
operation], e, 'atanh', null),
__decorate$23([doc(),
operation], e, 'erf', null),
__decorate$23([doc(),
operation], e, 'step', null),
e
}(),
...
this.shape = e.slice(),
this.values = r || getTypedArrayFromDType(t, sizeFromShape(e)),
this.strides = computeStrides(e),
this.size = sizeFromShape(e)
}
return e.prototype.set = function (e) {
for (var t = [
], r = 1; r < arguments.length; r++) t[r - 1] = arguments[r];
0 === t.length && (t = [
  0
]),
...
for (var t = new Array(this.shape.length), r = 0; r < t.length - 1; ++r) t[r] = Math.floor(e / this.strides[r]),
e -= t[r] * this.strides[r];
...
__decorate$24([doc()], e.prototype, 'set', null),
__decorate$24([doc()], e.prototype, 'get', null),
__decorate$24([doc()], e.prototype, 'toTensor', null),
e = __decorate$24([doc()], e)
}(),
Tensor = function () {
function e(e, r, n, a) {
this.isDisposed = !1,
this.size = sizeFromShape(e),
null != n && assert(this.size === n.length, 'Constructing tensor of shape (' + this.size + ') should match the length of values (' + n.length + ')'),
this.shape = e.slice(),
this.dtype = r || 'float32',
this.strides = computeStrides(e),
this.dataId = null != a ? a : {
},
this.id = t.nextId++,
this.rankType = this.rank < 5 ? this.rank.toString()  : 'higher',
ENV.engine.registerTensor(this),
null != n && ENV.engine.write(this.dataId, n)
}
return t = e,
e.make = function (e, r, n) {
...
return this.throwIfDisposed(),
assert(1 === this.size, 'The array must have only 1 element.'),
this.reshape([])
},
...
assert(e.length === this.rank, 'Number of coordinates in get() must match the rank of the tensor'),
...
return this.throwIfDisposed(),
ENV.engine.readSync(this.dataId)
},
e.prototype.dispose = function () {
this.isDisposed || (this.isDisposed = !0, ENV.engine.disposeTensor(this))
},
...
this.throwIfDisposed(),
batchNormalization(this, e, t, r, n, a)
},
...
return this.throwIfDisposed(),
squaredDifference(this, e)
},
e.prototype.squaredDifferenceStrict = function (e) {
return this.throwIfDisposed(),
squaredDifferenceStrict(this, e)
},
...
return void 0 === t && (t = !1),
this.throwIfDisposed(),
image.resizeBilinear(this, e, t)
},
e.prototype.resizeNearestNeighbor = function (e, t) {
return void 0 === t && (t = !1),
this.throwIfDisposed(),
image.resizeNearestNeighbor(this, e, t)
},
e.prototype.conv1d = function (e, t, r, n, a, o) {
return void 0 === n && (n = 'NWC'),
void 0 === a && (a = 1),
this.throwIfDisposed(),
conv1d(this, e, t, r, n, a, o)
},
e.prototype.conv2d = function (e, t, r, n, a, o) {
return void 0 === n && (n = 'NHWC'),
void 0 === a && (a = [
  1,
  1
]),
this.throwIfDisposed(),
conv2d(this, e, t, r, n, a, o)
},
e.prototype.conv2dTranspose = function (e, t, r, n, a) {
return this.throwIfDisposed(),
conv2dTranspose(this, e, t, r, n, a)
},
...
this.throwIfDisposed(),
depthwiseConv2d(this, e, t, r, n, a, o)
},
e.prototype.avgPool = function (e, t, r, n) {
return this.throwIfDisposed(),
avgPool(this, e, t, r, n)
},
e.prototype.maxPool = function (e, t, r, n) {
return this.throwIfDisposed(),
maxPool(this, e, t, r, n)
},
...
void 0 === r && (r = 1),
void 0 === n && (n = 0.5),
localResponseNormalization(this, e, t, r, n)
},
e.prototype.variable = function (e, t, r) {
return void 0 === e && (e = !0),
this.throwIfDisposed(),
Variable.variable(this, e, t, r)
},
e.prototype.unsortedSegmentSum = function (e, t, r) {
return void 0 === r && (r = 0),
this.throwIfDisposed(),
unsortedSegmentSum(this, e, t, r)
},
e.nextId = 0,
__decorate$24([doc()], e.prototype, 'flatten', null),
__decorate$24([doc()], e.prototype, 'asScalar', null),
__decorate$24([doc()], e.prototype, 'as1D', null),
__decorate$24([doc()], e.prototype, 'as2D', null),
__decorate$24([doc()], e.prototype, 'as3D', null),
__decorate$24([doc()], e.prototype, 'as4D', null),
__decorate$24([doc()], e.prototype, 'asType', null),
__decorate$24([doc()], e.prototype, 'buffer', null),
__decorate$24([doc()], e.prototype, 'data', null),
__decorate$24([doc()], e.prototype, 'dataSync', null),
__decorate$24([doc()], e.prototype, 'dispose', null),
__decorate$24([doc()], e.prototype, 'toFloat', null),
__decorate$24([doc()], e.prototype, 'toInt', null),
__decorate$24([doc()], e.prototype, 'toBool', null),
__decorate$24([doc()], e.prototype, 'print', null),
__decorate$24([doc()], e.prototype, 'reshape', null),
__decorate$24([doc()], e.prototype, 'reshapeAs', null),
__decorate$24([doc()], e.prototype, 'expandDims', null),
__decorate$24([doc()], e.prototype, 'cumsum', null),
__decorate$24([doc()], e.prototype, 'squeeze', null),
__decorate$24([doc()], e.prototype, 'clone', null),
__decorate$24([doc()], e.prototype, 'toString', null),
e = t = __decorate$24([doc()], e);
var t
}(),
Variable = function (e) {
function t(t, n, a) {
...
return o.trainable = n,
o.name = a,
null == o.name && (o.name = r.nextVarId.toString(), r.nextVarId++),
ENV.engine.registerVariable(o),
o
}
return __extends(t, e),
r = t,
t.variable = function (e, t, n, a) {
return void 0 === t && (t = !0),
null != a && a !== e.dtype && (e = e.asType(a)),
new r(e, t, n)
},
...
t.nextVarId = 0,
__decorate$24([doc()], t.prototype, 'assign', null),
__decorate$24([doc()], t, 'variable', null),
t = r = __decorate$24([doc()], t);
var r
}(Tensor),
...
function (t, r) {
  return assert(t instanceof Tensor, 'The x passed in grad(f)(x) must be a tensor'),
  assert(null == r || r instanceof Tensor, 'The dy passed in grad(f)(x, dy) must be a tensor'),
  tidy(function () {
    ...
    a = n.value,
    o = n.grads;
    return null != r && assertShapesMatch(a.shape, r.shape, 'The shape of dy passed in grad(f)(x, dy) must match the shape returned by f(x)'),
    checkGrads(o),
    o[0]
  })
}
...
function (t, r) {
  ...
  assert(null == r || r instanceof Tensor, 'The dy passed in grads(f)(args, dy) must be a tensor'),
  tidy(function () {
    var n = ENV.engine.gradients(function () {
    ...
    a = n.value,
    o = n.grads;
    return null != r && assertShapesMatch(a.shape, r.shape, 'The shape of dy passed in grads(f)([x1,...], dy) must match the shape returned by f([x1,...])'),
    checkGrads(o),
    o
  })
}
...
function (t, r) {
  assert(t instanceof Tensor, 'The x passed in valueAndGrad(f)(x) must be a tensor'),
  assert(null == r || r instanceof Tensor, 'The dy passed in valueAndGrad(f)(x, dy) must be a tensor');
  var n = ENV.engine.gradients(function () {
    return e(t)
  }, [
    t
...
function (t, r) {
  ...
  assert(null == r || r instanceof Tensor, 'The dy passed in valueAndGrads(f)(args, dy) must be a tensor');
  var n = ENV.engine.gradients(function () {
    return e.apply(void 0, t)
  }, t, r);
  return null != r && assertShapesMatch(n.value.shape, r.shape, 'The shape of dy passed in valueAndGrads(f)([x1,...], dy) must match the shape returned by f([x1,...])'),
  checkGrads(n.grads),
  n
}
},
...
assert(0 === o.rank, 'The f passed in variableGrads(f) must return a scalar, but it returned a rank-' + o.rank + ' tensor');
var s = {
};
...
__decorate$25([doc()], e, 'grad', null),
__decorate$25([doc()], e, 'grads', null),
__decorate$25([doc()], e, 'valueAndGrad', null),
__decorate$25([doc()], e, 'valueAndGrads', null),
__decorate$25([doc()], e, 'variableGrads', null),
__decorate$25([doc()], e, 'customGrad', null),
e
}(),
tidy = Tracking.tidy,
keep = Tracking.keep,
...
o = r.dataSync();
return checkForNaN(o, r.dtype, e),
a.then(function (t) {
...
this.numTensors++,
0 === t && (this.numDataBuffers++, this.numBytes += sizeFromShape(e.shape) * bytesPerElement(e.dtype), this.backend.register(e.dataId, e.shape, e.dtype)),
this.refCounter.set(e.dataId, t + 1),
...
for (var e in this.registeredVariables) {
  ...
  delete this.registeredVariables[e]
}
},
e.prototype.memory = function () {
var e = this.backend.memory();
return e.numTensors = this.numTensors,
e.numDataBuffers = this.numDataBuffers,
e.numBytes = this.numBytes,
e
},
...
return this.activeScope.keep.push(e),
e
},
e.prototype.startScope = function (e, t) {
void 0 === t && (t = !1),
t && 0 === this.gradientScopeCount && (this.activeTape = [
]),
t && this.gradientScopeCount++;
var r = {
  keep: [
  ],
  track: [
...
var r = this;
void 0 === t && (t = !1),
t && 0 === --this.gradientScopeCount && (this.activeTape = null);
var n = this.activeScope.keep,
a = extractTensorsFromContainer(e);
n = n.concat(a);
for (var o = 0; o < this.activeScope.track.length; o++) {
  var i = this.activeScope.track[o];
  isTensorInList(i, n) || (null != this.activeTape ? a.push(i)  : i.dispose())
}
this.scopeStack.pop(),
...
a.forEach(function (e) {
  isTensorInList(e, r.activeScope.keep) || r.track(e)
})
},
e.prototype.dispose = function () {
},
...
var a = this;
return void 0 === n && (n = !1),
assert(t.length > 0, 'gradients() received an empty list of xs.'),
tidy('gradients', function () {
  var o = e();
  ...
  return s[o.id] = null == r ? ones(o.shape)  : r,
  backpropagateGradients(s, i),
  {
    value: o,
...
function () {
  for (var r = [
  ], n = 0; n < arguments.length; n++) r[n] = arguments[n];
  assert(r.every(function (e) {
    return e instanceof Tensor
  }), 'The args passed in customGrad(f)(x1, x2,...) must all be tensors'),
  t.customGradientDepth++;
  var a,
  o = tidy(e.name, function () {
    var t = e.apply(void 0, r),
    n = t.value,
    o = t.gradFunc;
    return assert(n instanceof Tensor, 'The function f passed in customGrad(f) must return an object where `obj.value` is a tensor'),
    assert(isFunction(o), 'The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function.'),
    a = o,
    n
  }, !0);
  if (t.customGradientDepth--, t.shouldRecord()) {
    t.addTapeNode(r, o, function (e) {
      ...
      return assert(n.length === r.length, 'The function f passed in customGrad(f) must return an object where `obj.gradFunc` is a function that returns the same number of tensors as inputs passed to f(...).'),
...
return this.activeScope.track.push(e),
e
},
e
}(),
...
null != this.globalEngine && (this.globalEngine.dispose(), this.globalEngine = null)
},
e.prototype.initBackend = function (e, t) {
void 0 === t && (t = !1),
this.currentBackend = e,
null != this.globalEngine && this.globalEngine.dispose();
...
void 0 === r && (r = 1),
e in this.registry && console.warn(e + ' backend was already registered');
try {
  var n = t();
...
__decorate$26([doc()], e, 'setBackend', null),
__decorate$26([doc()], e, 'getBackend', null),
__decorate$26([doc()], e, 'disposeVariables', null),
__decorate$26([doc()], e, 'memory', null),
e
}(),
...
assertAndGetBroadcastShape(e, t),
assertAndGetBroadcastShape(e, r);
var i = '0.0';
null != n && (assertAndGetBroadcastShape(e, n), this.variableNames.push('offset'), i = 'getOffsetAtOutCoords()');
var s = '1.0';
null != a && (assertAndGetBroadcastShape(e, a), this.variableNames.push('scale'), s = 'getScaleAtOutCoords()'),
this.outputShape = e,
...
this.supportsBroadcasting = !0,
this.outputShape = assertAndGetBroadcastShape(t, r),
...
this.outputShape = computeOutShape(e, t, 1),
this.userCode = '\n      void main() {\n        ivec2 coords = getOutputCoords();\n        int yR = coords.x;\n        int yC = coords.y;\n\n        float value = 0.0;\n        if (yC < ' + e[1] + ') {\n          value = getA(yR, yC);\n        } else {\n          yC -= ' + e[1] + ';\n          value = getB(yR, yC);\n        }\n\n        setOutput(value);\n      }\n    '
}
}(),
...
!function (e) {
e[e.FLOAT = 0] = 'FLOAT',
e[e.UNSIGNED_BYTE = 1] = 'UNSIGNED_BYTE'
...
this.gl = null != e ? e : createWebGLContext(),
1 === ENV.get('WEBGL_VERSION') ? (this.textureFloatExtension = getExtensionOrThrow(this.gl, 'OES_texture_float'), this.colorBufferFloatExtension = this.gl.getExtension('WEBGL_color_buffer_float'))  : this.colorBufferFloatExtension = getExtensionOrThrow(this.gl, 'EXT_color_buffer_float'),
this.loseContextExtension = getExtensionOrThrow(this.gl, 'WEBGL_lose_context'),
ENV.get('WEBGL_GET_BUFFER_SUB_DATA_ASYNC_EXTENSION_ENABLED') && (this.getBufferSubDataAsyncExtension = this.gl.getExtension('WEBGL_get_buffer_sub_data_async')),
...
this.autoDebugValidate = e,
enableDebugWebGLErrorChecking(e)
},
e.prototype.createMatrixTexture = function (e, t) {
return this.throwIfDisposed(),
createMatrixTexture(this.gl, e, t)
},
e.prototype.uploadPixelDataToTexture = function (e, t) {
this.throwIfDisposed(),
uploadPixelDataToTexture(this.gl, e, t)
},
e.prototype.createPackedMatrixTexture = function (e, t) {
return this.throwIfDisposed(),
createPackedMatrixTexture(this.gl, e, t)
},
e.prototype.deleteMatrixTexture = function (e) {
var t = this;
this.throwIfDisposed(),
this.outputTexture === e && (unbindColorTextureFromFramebuffer(this.gl, this.framebuffer), this.outputTexture = null),
...
return this.throwIfDisposed(),
uploadMatrixToPackedTexture(this.gl, e, t, r, n)
},
...
return __awaiter$4(this, void 0, void 0, function () {
  ...
  return __generator$4(this, function (a) {
    ...
    return [2,
    this.downloadMatrixDriverAsync(e, function () {
...
linkProgram(t, a),
this.autoDebugValidate && validateProgram(t, a),
this.vertexAttrsAreBound || (this.setProgram(a), this.vertexAttrsAreBound = bindVertexProgramAttributeStreams(t, this.program, this.vertexBuffer)),
a
},
...
null != e && callAndCheck(this.gl, function () {
...
this.throwIfDisposed(),
this.program = e,
null != this.program && this.autoDebugValidate && validateProgram(this.gl, this.program),
callAndCheck(this.gl, function () {
...
return void 0 === r && (r = !0),
this.throwIfDisposed(),
r ? getProgramUniformLocationOrThrow(this.gl, e, t)  : getProgramUniformLocation(this.gl, e, t)
},
...
bindTextureToProgramUniformSampler(this.gl, this.program, e, t, r)
},
...
null != this.program && validateProgram(this.gl, this.program),
...
return null == this.disjointQueryTimerExtension && (this.disjointQueryTimerExtension = getExtensionOrThrow(this.gl, 2 === ENV.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION') ? 'EXT_disjoint_timer_query_webgl2' : 'EXT_disjoint_timer_query')),
...
a = n.createQueryEXT();
return n.beginQueryEXT(n.TIME_ELAPSED_EXT, a),
a
},
...
if (2 === t) {
  ...
  o = this.gl.getParameter(n.GPU_DISJOINT_EXT);
  return a && !o
}
var a = (n = this.getQueryTimerExtensionWebGL1()).getQueryObjectEXT(e, n.QUERY_RESULT_AVAILABLE_EXT),
o = this.gl.getParameter(n.GPU_DISJOINT_EXT);
return a && !o
},
...
return new Promise(function (r, n) {
  var a = ENV.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION');
  repeatedTry(function () {
    return t.isQueryAvailable(e, a)
  }).then(function () {
    return r(t.getQueryTime(e, a))
  }).catch (function () {
...
if (2 === t) {
  var r = this.gl;
  return (a = r.getQueryParameter(e, r.QUERY_RESULT)) / 1000000
}
var n = this.getQueryTimerExtensionWebGL1(),
...
this.throwIfDisposed(),
bindColorTextureToFramebuffer(this.gl, e, this.framebuffer),
this.autoDebugValidate && validateFramebuffer(this.gl)
},
...
var r = t();
return this.downloadMatrixDriverTeardown(),
r
},
...
return __awaiter$4(this, void 0, void 0, function () {
  ...
  return __generator$4(this, function (n) {
    switch (n.label) {
      case 0:
        return this.downloadMatrixDriverSetup(e),
        [
          4,
          t()
        ];
...
this.throwIfDisposed();
var n = this.gl;
bindColorTextureToFramebuffer(n, e, this.framebuffer),
this.autoDebugValidate && validateFramebuffer(n),
...
this.outputShape = e;
var s,
u = 'float(' + r + ') + float(' + n + ') * sum';
s = 0.5 === a ? 'inversesqrt(' + u + ')' : 1 === a ? '1.0/(' + u + ')' : 'exp(log(' + u + ') * float(-' + a + '));',
...
var t = this;
return function (r, n) {
  null == t.seedLoc && (t.seedLoc = r.getUniformLocation(n, 'seed')),
  r.gl.uniform1f(t.seedLoc, e)
}
},
e
}(),
...
this.outputShape = t.map(function (t, r) {
  return t[0] + e[r] + t[1]
});
var n = e.length,
...
if (this.variableNames = [
  'x'
], 'avg' === t && r) throw new Error('Cannot compute positions for average pool.');
...
return function (r, n) {
  if (null != t.startLoc || (t.startLoc = r.getUniformLocationNoThrow(n, 'start'), null != t.startLoc)) if (1 === t.rank) r.gl.uniform1i(t.startLoc, e[0]);
...
if (r in this.freeTextures || (this.freeTextures[r] = [
]), r in this.usedTextureCount || (this.usedTextureCount[r] = 0), this.usedTextureCount[r]++, this.freeTextures[r].length > 0) return this.numFreeTextures--,
this.numUsedTextures++,
this.log(),
this.freeTextures[r].shift();
this.numUsedTextures++,
this.log();
var n = this.gpgpu.createMatrixTexture(e[0], e[1]);
return this.allocatedTextures.push(n),
n
},
e.prototype.releaseTexture = function (e, t, r) {
void 0 === r && (r = TextureType.FLOAT);
var n = getKeyFromTextureShape(t, r);
n in this.freeTextures || (this.freeTextures[n] = [
]),
this.freeTextures[n].push(e),
this.numFreeTextures++,
this.numUsedTextures--,
this.usedTextureCount[n]--,
this.log()
},
e.prototype.log = function () {
if (this.logEnabled) {
...
function e(e, t) {
if (void 0 === t && (t = !0), this.gpgpu = e, this.delayedStorage = t, this.texData = new WeakMap, this.uploadWaitMs = 0, this.downloadWaitMs = 0, this.binaryCache = {
}, this.disposed = !1, ENV.get('WEBGL_VERSION') < 1) throw new Error('WebGL is not supported on this device');
'undefined' != typeof document && (this.canvas = document.createElement('canvas')),
null == e ? (this.gpgpu = new GPGPUContext(createWebGLContext(this.canvas)), this.gpgpuCreatedLocally = !0)  : this.gpgpuCreatedLocally = !1,
...
this.texData.get(a.dataId).texType = TextureType.UNSIGNED_BYTE,
...
a = r.texShape,
o = r.texType;
null != n && (this.textureManager.releaseTexture(n, a, o), r.texture = null, r.texShape = null),
r.values = t,
this.delayedStorage || this.uploadToGPU(e)
},
e.prototype.readSync = function (e) {
this.throwIfNoData(e);
...
n = t.values,
a = t.texShape;
if (null != n) return this.cacheOnCPU(e),
n;
var o,
i = null != this.activeTimers;
i && (o = performance.now());
var s = this.gpgpu.downloadMatrixFromTexture(r, a[0], a[1]);
return i && (this.downloadWaitMs += performance.now() - o),
this.cacheOnCPU(e, s),
t.values
},
e.prototype.read = function (e) {
return __awaiter$5(this, void 0, void 0, function () {
  ...
  return __generator$5(this, function (i) {
    switch (i.label) {
      case 0:
        return this.throwIfNoData(e),
        t = this.texData.get(e),
        r = t.texture,
        n = t.values,
        a = t.texShape,
        null != n ? (this.cacheOnCPU(e), [
          2,
          n
        ])  : ENV.get('WEBGL_GET_BUFFER_SUB_DATA_ASYNC_EXTENSION_ENABLED') ? [
          4,
          this.gpgpu.downloadMatrixFromTextureAsync(r, a[0], a[1])
        ] : [
          3,
          2
        ];
      ...
      case 2:
        return 0 === ENV.get('WEBGL_DISJOINT_QUERY_TIMER_EXTENSION_VERSION') ? [
          2,
          this.readSync(e)
        ] : [
          4,
          this.gpgpu.runQuery(function () {
          })
        ];
      case 3:
        return i.sent(),
...
return __awaiter$5(this, void 0, void 0, function () {
  ...
  return __generator$5(this, function (s) {
    switch (s.label) {
      case 0:
        return t = this.activeTimers,
        r = [
        ],
        n = !1,
        null == this.programTimersStack ? (this.programTimersStack = r, n = !0)  : this.activeTimers.push(r),
        this.activeTimers = r,
        e(),
        a = flatten(this.activeTimers),
        this.activeTimers = t,
        n && (this.programTimersStack = null),
        [
          4,
...
if (this.texData.has(e)) {
  ...
  n = t.texShape,
  a = t.texType;
  null != r && this.textureManager.releaseTexture(r, n, a),
...
u = s[0],
l = s[1],
c = this.makeOutputArray([u,
l], r);
return this.compileAndRun(i, [
  e
], c),
1 === c.shape[1] ? c : this.reduce(c, t, r)
},
...
return null != r && p.push(r),
this.compileAndRun(i, p, c),
1 === c.shape[1] ? c : this.argReduce(e, t, c)
},
e.prototype.sum = function (e, t) {
...
var r,
n;
'int32' === e.dtype && 'int32' === t.dtype ? (r = INT_DIV, n = 'int32')  : (r = DIV, n = 'float32');
var a = new BinaryOpProgram(r, e.shape, t.shape),
o = this.makeOutputArray(a.outputShape, n);
return this.compileAndRun(a, [
  e,
  t
...
return c && (i = this.startTimer()),
runProgram(l, o, s, n),
c && (i = this.endTimer(i), this.activeTimers.push(this.getQueryTime(i))),
r
},
...
if (null == a) {
  ...
  t.texShape = u;
  var l = this.textureManager.acquireTexture(u, o);
  t.texture = l,
  null != n && (this.gpgpu.uploadMatrixToTexture(l, u[0], u[1], typedArrayToFloat32(n)), t.values = null, s && (this.uploadWaitMs += performance.now() - i))
}
},
...
i = n.dtype,
s = n.texType;
r && null != a && (this.textureManager.releaseTexture(a, o, s), n.texture = null, n.texShape = null),
null != t && (n.values = float32ToTypedArray(t, i))
},
e
}();
ENV.registerBackend('webgl', function () {
...
if (4 === t) n = new Int32Array(r);
  ...
  for (var o = 0; o < a; o++) for (var i = 0; i < t; ++i) n[o * t + i] = r[4 * o + i]
}
var s = [
  e.height,
  e.width,
...
e.prototype.matMul = function (e, t, r, n) {
for (var a = r ? e.shape[0] : e.shape[1], o = r ? e.shape[1] : e.shape[0], i = n ? t.shape[0] : t.shape[1], s = e.dataSync(), u = t.dataSync(), l = r ? [
  1,
  e.strides[0]
] : [
  e.strides[0],
  ...
  1,
  t.strides[0]
], h = d[0], f = d[1], m = o * c, g = i * h, y = new Float32Array(o * i), v = 0, b = 0; b < m; b += c) for (var x = 0; x < g; x += h) {
  for (var w = b, _ = x, S = 0, A = 0; A < a; ++A) S += s[w] * u[_],
  w += p,
  _ += f;
  y[v++] = S
}
...
var r,
n;
return 'int32' === e.dtype && 'int32' === t.dtype ? (n = 'int32', r = function (e, t) {
  return Math.floor(e / t)
})  : (n = 'float32', r = function (e, t) {
  return e / t
}),
this.broadcastedBinaryOp(e, t, n, r)
},
e.prototype.sum = function (e, t) {
assertAxesAreInnerMostDims('sum', t, e.rank);
...
e.prototype.where = function (e, t, r, n) {
for (var a = e.dataSync(), o = t.dataSync(), i = r.dataSync(), s = zeros(t.shape, n), u = s.dataSync(), l = 0, c = 0 === e.rank || e.rank > 1 || 1 === t.rank ? 1 : t.shape[1], p = 0; p < a.length; p++) for (var d = 0; d < c; d++) 1 === a[p] ? u[l++] = o[p] : u[l++] = i[p];
return s
},
e.prototype.topKValues = function (e, t) {
...
for (var r = e.dataSync(), n = [
], a = 0; a < r.length; a++) n.push({
  value: r[a],
  index: a
});
n.sort(function (e, t) {
...
for (var o = getTypedArrayFromDType(e.dtype, t), i = new Int32Array(t), a = 0; a < t; a++) o[a] = n[a].value,
i[a] = n[a].index;
return {
...
for (var t = e.dataSync(), r = new Float32Array(t.length), n = 0; n < t.length; ++n) {
  ...
  t[n] - a < 0.5 ? r[n] = Math.floor(t[n])  : t[n] - a > 0.5 ? r[n] = Math.ceil(t[n])  : r[n] = a % 2 == 0 ? a : a + 1
}
return Tensor.make(e.shape, {
  values: r
})
...
e.prototype.conv2d = function (e, t, r) {
for (var n = r.filterHeight, a = r.filterWidth, o = r.dilationHeight, i = r.dilationWidth, s = r.padInfo.left, u = r.padInfo.top, l = buffer(r.outShape, e.dtype), c = 0; c < r.batchSize; ++c) for (var p = 0; p < r.outChannels; ++p) for (var d = 0; d < r.outHeight; ++d) for (var h = d * r.strideHeight - s, f = 0; f < r.outWidth; ++f) {
  for (var m = f * r.strideWidth - u, g = 0, y = 0; y < n; y++) {
    var v = h + y * o;
    if (!(v < 0 || v >= r.inHeight)) for (var b = 0; b < a; b++) {
      var x = m + b * i;
      if (!(x < 0 || x >= r.inWidth)) for (var w = 0; w < r.inChannels; ++w) g += e.get(c, v, x, w) * t.get(y, b, w, p)
    }
  }
  l.set(g, c, d, f, p)
}
...
e.prototype.conv2dDerInput = function (e, t, r) {
for (var n = buffer(r.inShape, 'float32'), a = n.values, o = n.strides, i = o[0], s = o[1], u = o[2], l = e.dataSync(), c = e.strides, p = c[0], d = c[1], h = c[2], f = t.dataSync(), m = t.strides, g = m[0], y = m[1], v = m[2], b = r.batchSize, x = r.filterHeight, w = r.filterWidth, _ = r.inChannels, S = r.inHeight, A = r.inWidth, N = r.outChannels, E = r.outHeight, T = r.outWidth, I = r.strideHeight, O = r.strideWidth, P = x - 1 - r.padInfo.top, R = w - 1 - r.padInfo.left, k = 0; k < b; ++k) for (var C = 0; C < _; ++C) for (var D = 0; D < S; ++D) for (var M = D - P, L = Math.max(0, Math.ceil(M / I)), z = Math.min(E, (x + M) / I), V = 0; V < A; ++V) {
  for (var F = V - R, $ = Math.max(0, Math.ceil(F / O)), B = Math.min(T, (w + F) / O), U = 0, j = L; j < z; ++j) for (var G = j * I - M, W = $; W < B; ++W) for (var q = p * k + d * j + h * W, H = g * (x - 1 - G) + y * (w - 1 - (W * O - F)) + v * C, X = 0; X < N; ++X) U += l[q + X] * f[H + X];
  a[i * k + s * D + u * V + C] = U
}
return n.toTensor()
},
...
for (var n = r.strideHeight, a = r.strideWidth, o = r.filterHeight, i = r.filterWidth, s = buffer(r.filterShape, 'float32'), u = r.padInfo.left, l = r.padInfo.top, c = 0; c < o; ++c) for (var p = Math.max(0, Math.ceil((l - c) / n)), d = Math.min(r.outHeight, (r.inHeight + l - c) / n), h = 0; h < i; ++h) for (var f = Math.max(0, Math.ceil((u - h) / a)), m = Math.min(r.outWidth, (r.inWidth + u - h) / a), g = 0; g < r.inChannels; ++g) for (var y = 0; y < r.outChannels; ++y) {
  for (var v = 0, b = 0; b < r.batchSize; ++b) for (var x = p; x < d; ++x) for (var w = c + x * n - l, _ = f; _ < m; ++_) {
    var S = h + _ * a - u;
...
for (var n = t.strideHeight, a = t.strideWidth, o = t.filterHeight, i = t.filterWidth, s = buffer(t.outShape, 'float32'), u = t.padInfo.top, l = t.padInfo.left, c = 0; c < t.batchSize; ++c) for (var p = 0; p < t.inChannels; ++p) for (var d = 0; d < t.outHeight; ++d) for (var h = d * n - u, f = Math.max(0, h), m = Math.min(t.inHeight, o + h), g = 0; g < t.outWidth; ++g) {
...
for (var r = buffer(t.outShape, 'int32'), n = t.strideHeight, a = t.strideWidth, o = t.filterHeight, i = t.filterWidth, s = t.padInfo.top, u = t.padInfo.left, l = 0; l < t.batchSize; ++l) for (var c = 0; c < t.inChannels; ++c) for (var p = 0; p < t.outHeight; ++p) for (var d = p * n - s, h = Math.max(0, d), f = Math.min(t.inHeight, o + d), m = 0; m < t.outWidth; ++m) {
  for (var g = m * a - u, y = Math.max(0, g), v = Math.min(t.inWidth, i + g), b = Number.NEGATIVE_INFINITY, x = - 1, w = h; w < f; ++w) for (var _ = w - d, S = y; S < v; ++S) {
    var A = S - g,
    N = e.get(l, w, S, c);
    N > b && (b = N, x = _ * i + A)
  }
...
e.prototype.maxPoolBackprop = function (e, t, r, n) {
for (var a = this.maxPoolPositions(t, n), o = n.strideHeight, i = n.strideWidth, s = n.filterHeight, u = n.filterWidth, l = u - 1 - n.padInfo.left, c = s - 1 - n.padInfo.top, p = buffer(t.shape, 'float32'), d = 0; d < n.batchSize; ++d) for (var h = 0; h < n.inChannels; ++h) for (var f = 0; f < n.inHeight; ++f) for (var m = 0; m < n.inWidth; ++m) {
  for (var g = f - c, y = m - l, v = 0, b = 0; b < s; ++b) {
    var x = (g + b) / o;
    if (!(x < 0 || x >= n.outHeight || Math.floor(x) !== x)) for (var w = 0; w < u; ++w) {
      var _ = (y + w) / i;
...
e.prototype.avgPoolBackprop = function (e, t, r) {
for (var n = r.strideHeight, a = r.strideWidth, o = r.filterHeight, i = r.filterWidth, s = i - 1 - r.padInfo.left, u = o - 1 - r.padInfo.top, l = buffer(t.shape, 'float32'), c = 1 / (o * i), p = 0; p < r.batchSize; ++p) for (var d = 0; d < r.inChannels; ++d) for (var h = 0; h < r.inHeight; ++h) for (var f = 0; f < r.inWidth; ++f) {
  for (var m = h - u, g = f - s, y = 0, v = 0; v < o; ++v) {
    var b = (m + v) / n;
    if (!(b < 0 || b >= r.outHeight || Math.floor(b) !== b)) for (var x = 0; x < i; ++x) {
      var w = (g + x) / a;
...
e.prototype.resizeBilinear = function (e, t, r, n) {
for (var a = e.shape, o = a[0], i = a[1], s = a[2], u = a[3], l = buffer([o,
t,
r,
u], e.dtype), c = [
  n && t > 1 ? i - 1 : i,
  ...
  n && t > 1 ? t - 1 : t,
  n && r > 1 ? r - 1 : r
], d = 0; d < o; d++) for (var h = 0; h < t; h++) for (var f = 0; f < r; f++) for (var m = 0; m < u; m++) {
  var g = c[0] * h / p[0],
  y = c[1] * f / p[1],
  v = Math.floor(g),
  ...
  S = e.get(d, b, x, m),
  A = y - x,
  N = _ + (e.get(d, v, w, m) - _) * A,
  E = N + (S + (e.get(d, b, w, m) - S) * A - N) * (g - v);
  l.set(E, d, h, f, m)
}
return l.toTensor()
},
e.prototype.resizeBilinearBackprop = function (e, t, r) {
for (var n = t.shape, a = n[0], o = n[1], i = n[2], s = n[3], u = e.shape, l = u[1], c = u[2], p = buffer([a,
o,
i,
s], t.dtype), d = [
  r && l > 1 ? o - 1 : o,
  ...
  r && l > 1 ? l - 1 : l,
  r && c > 1 ? c - 1 : c
], f = d[0] / h[0], m = d[1] / h[1], g = 0; g < a; g++) for (var y = 0; y < l; y++) for (var v = y * f, b = Math.floor(v), x = Math.min(Math.ceil(v), o - 1), w = v - b, _ = 1 - w, S = 0; S < c; S++) for (var A = S * m, N = Math.floor(A), E = Math.min(Math.ceil(A), i - 1), T = A - N, I = 1 - T, O = 0; O < s; O++) {
  var P = e.get(g, y, S, O),
  R = p.get(g, b, N, O);
  R += P * _ * I,
  p.set(R, g, b, N, O);
...
e.prototype.localResponseNormalization4D = function (e, t, r, n, a) {
for (var o = buffer(e.shape, 'float32'), i = t, s = o.shape[3] - 1, u = 0; u < o.shape[0]; u++) for (var l = 0; l <= o.shape[1]; l++) for (var c = 0; c < o.shape[2]; c++) for (var p = 0; p < o.shape[3]; p++) {
...
e.prototype.multinomial = function (e, t, r, n) {
for (var a = t ? e : softmax(e), o = a.shape[0], i = a.shape[1], s = zeros([o,
r], 'int32'), u = s.dataSync(), l = a.dataSync(), c = 0; c < o; ++c) {
  var p = c * i,
  ...
  for (var f = seedrandom_1(n.toString()), m = c * r, g = 0; g < r; ++g) {
    var y = f();
    u[m + g] = d.length;
    for (var v = 0; v < d.length; v++) if (y < d[v]) {
      u[m + g] = v;
      break
    }
  }
...
__decorate$27([doc()], e, 'nextFrame', null),
e
}(),
...
assert(null != t, 'scheme must not be undefined or null.'),
t.endsWith(URL_SCHEME_SUFFIX) && (t = t.slice(0, t.indexOf(URL_SCHEME_SUFFIX))),
assert(t.length > 0, 'scheme must not be an empty string.');
var n = e.getInstance();
assert(null == n.managers[t], 'A model store manager is already registered for scheme \'' + t + '\'.'),
n.managers[t] = r
},
...
return __awaiter$8(this, void 0, void 0, function () {
  ...
  return __generator$8(this, function (u) {
    switch (u.label) {
      case 0:
        e = ModelStoreManagerRegistry.getSchemes(),
        t = {
        },
        r = 0,
        n = e,
        u.label = 1;
      case 1:
        return r < n.length ? (a = n[r], [
          4,
          ModelStoreManagerRegistry.getManager(a).listModels()
        ])  : [
          3,
          4
        ];
...
return __awaiter$8(this, void 0, void 0, function () {
  ...
  return __generator$8(this, function (n) {
    switch (n.label) {
      case 0:
        return t = parseURL(e),
        r = ModelStoreManagerRegistry.getManager(t.scheme),
        [
          4,
          r.removeModel(t.path)
        ];
      case 1:
        return [2,
        n.sent()]
...
__decorate$28([doc()], e, 'listModels', null),
__decorate$28([doc()], e, 'removeModel', null),
__decorate$28([doc()], e, 'copyModel', null),
__decorate$28([doc()], e, 'moveModel', null),
e
}(),
  ...
  a.onsuccess = function () {
    ...
    if (null == t) {
      ...
      s.onsuccess = function () {
        if (null == s.result) return o.close(),
        n(new Error('Cannot find model with path \'' + r.modelPath + '\' in IndexedDB.'));
      ...
      new Promise(function (r, n) {
        ...
        a.onsuccess = function () {
          ...
          u.onsuccess = function () {
            if (null == u.result) return o.close(),
...
return __awaiter$10(this, void 0, void 0, function () {
  ...
  return __generator$10(this, function (o) {
    ...
    r = JSON.stringify(e.weightSpecs),
    n = getModelArtifactsInfoForJSON(e);
    try {
      return this.LS.setItem(this.keys.info, JSON.stringify(n)),
      this.LS.setItem(this.keys.topology, t),
      this.LS.setItem(this.keys.weightSpecs, r),
      this.LS.setItem(this.keys.weightData, arrayBufferToBase64String(e.weightData)),
      [
        2,
        {
...
return __awaiter$10(this, void 0, void 0, function () {
  ...
  return __generator$10(this, function (o) {
    ...
    return t.weightData = base64StringToArrayBuffer(a),
    [
      2,
      t
    ]
...
assert(void 0 !== window.localStorage, 'Current browser does not appear to support localStorage'),
...
return __awaiter$10(this, void 0, void 0, function () {
  ...
  return __generator$10(this, function (i) {
    for (e = {
    }, t = PATH_PREFIX + PATH_SEPARATOR, r = PATH_SEPARATOR + INFO_SUFFIX, n = 0; n < this.LS.length; ++n) (a = this.LS.key(n)).startsWith(t) && a.endsWith(r) && (o = getModelPathFromKey(a), e[o] = JSON.parse(this.LS.getItem(a)));
    return [2,
    e]
  })
})
...
return __awaiter$10(this, void 0, void 0, function () {
  ...
  return __generator$10(this, function (n) {
    ...
    return r = JSON.parse(this.LS.getItem(t.info)),
    this.LS.removeItem(t.info),
    this.LS.removeItem(t.topology),
    this.LS.removeItem(t.weightSpecs),
    this.LS.removeItem(t.weightData),
    [
      2,
      r
    ]
...
null != t && 0 !== t.length || (t = DEFAULT_FILE_NAME_PREFIX),
this.modelTopologyFileName = t + DEFAULT_JSON_EXTENSION_NAME,
this.weightDataFileName = t + DEFAULT_WEIGHT_DATA_EXTENSION_NAME
}
return e.prototype.save = function (e) {
return __awaiter$11(this, void 0, void 0, function () {
  ...
  return __generator$11(this, function (s) {
    ...
    o = null == this.jsonAnchor ? document.createElement('a')  : this.jsonAnchor,
    o.download = this.modelTopologyFileName,
    o.href = a,
    o.click(),
    null != e.weightData && ((i = null == this.weightDataAnchor ? document.createElement('a')  : this.weightDataAnchor).download = this.weightDataFileName, i.href = t, i.click()),
    [
      2,
      {
...
return __awaiter$11(this, void 0, void 0, function () {
  ...
  return __generator$11(this, function (n) {
    return e = this.files[0],
    t = this.files.slice(1),
    [
      2,
      new Promise(function (n, a) {
...
}, o = 0, i = e; o < i.length; o++) i[o].paths.forEach(function (e) {
  var o = basename(e);
...
var __awaiter$13 = function (e, t, r, n) {
return new (r || (r = Promise)) (function (a, o) {
function i(e) {
  try {
    u(n.next(e))
...
registerSaveRouter = IORouterRegistry.registerSaveRouter,
...
this.getMap().classNameMap[e.className] = [
  e,
  e.fromConfig
]
},
...
return __extends$1(t, e),
t.prototype.minimize = function (e, t, r) {
void 0 === t && (t = !1);
var n = this.computeGradients(e, r),
a = n.value,
o = n.grads;
return this.applyGradients(o),
...
__decorate$29([doc()], t.prototype, 'minimize', null),
t = __decorate$29([doc()], t)
}(Serializable),
...
a.c = keep(scalar( - t)),
a.epsilonScalar = keep(scalar(n)),
a.rhoScalar = keep(scalar(r)),
a.oneMinusRho = keep(scalar(1 - r)),
a
}
...
for (var n in e) !function (n) {
  ...
  tidy(function () {
    ...
    t.accumulatedUpdates[n].assign(u);
...
n.initialAccumulatorValue = r,
n.accumulatedGrads = {
},
n.c = keep(scalar( - t)),
n.epsilon = keep(scalar(1e-8)),
n
}
return __extends$3(t, e),
t.prototype.applyGradients = function (e) {
var t = this,
r = this;
for (var n in e) !function (n) {
...
o.c = keep(scalar( - t)),
o.epsScalar = keep(scalar(a)),
o.beta1Scalar = keep(scalar(r)),
o.beta2Scalar = keep(scalar(n)),
tidy(function () {
  o.accBeta1 = scalar(r).variable(),
  o.accBeta2 = scalar(n).variable()
}),
o.oneMinusBeta1 = keep(scalar(1 - r)),
o.oneMinusBeta2 = keep(scalar(1 - n)),
o.one = keep(scalar(1)),
o
}
...
tidy(function () {
  ...
  for (var a in e) {
    ...
    d = c.div(r),
    h = p.div(n);
    t.accumulatedFirstMoment[a].assign(c),
    t.accumulatedSecondMoment[a].assign(p);
    var f = t.c.mul(d.div(t.epsScalar.add(h.sqrt()))).add(o);
    o.assign(f)
  }
  t.accBeta1.assign(t.accBeta1.mul(t.beta1Scalar)),
  t.accBeta2.assign(t.accBeta2.mul(t.beta2Scalar))
})
},
t.prototype.dispose = function () {
var e = this;
...
i.c = keep(scalar( - t)),
i.epsScalar = keep(scalar(a)),
i.beta1Scalar = keep(scalar(r)),
i.beta2Scalar = keep(scalar(n)),
i.decayScalar = keep(scalar(o)),
tidy(function () {
  i.iteration = scalar(0).variable(),
  i.accBeta1 = scalar(r).variable()
}),
i.oneMinusBeta1 = keep(scalar(1 - r)),
i.one = keep(scalar(1)),
i
}
return __extends$5(t, e),
t.prototype.applyGradients = function (e) {
var t = this;
tidy(function () {
  var r = t.one.sub(t.accBeta1),
  ...
  for (var a in e) {
    ...
    h = p.maximum(d);
    t.accumulatedFirstMoment[a].assign(c),
    t.accumulatedWeightedInfNorm[a].assign(h);
    var f = n.div(r).mul(c.div(t.epsScalar.add(h))).add(o);
    o.assign(f)
  }
  t.iteration.assign(t.iteration.add(t.one)),
  t.accBeta1.assign(t.accBeta1.mul(t.beta1Scalar))
})
},
t.prototype.dispose = function () {
...
for (var n in e) !function (n) {
  ...
  tidy(function () {
    var e,
    r = t.m.mul(o).add(i);
    e = t.useNesterov ? t.c.mul(i.add(r.mul(t.m))).add(a)  : t.c.mul(r).add(a),
    t.accumulations[n].assign(r),
    a.assign(e)
  })
}(n)
},
...
i.c = keep(scalar(t)),
i.epsilonScalar = keep(scalar(a)),
i.decayScalar = keep(scalar(r)),
i.momentumScalar = keep(scalar(n)),
i.oneMinusDecay = keep(scalar(1 - r)),
i.centered = o,
i
}
...
for (var n in e) !function (n) {
  ...
  tidy(function () {
    ...
    if (t.centered) {
      ...
      t.accumulatedMeanSquares[n].assign(e),
      t.accumulatedMeanGrads[n].assign(r),
      t.accumulatedMoments[n].assign(l),
      p = a.sub(l),
      a.assign(p)
    } else {
      ...
      t.accumulatedMeanSquares[n].assign(c),
      t.accumulatedMoments[n].assign(l);
      var p = a.sub(l);
      a.assign(p)
    }
...
return void 0 === r && (r = !1),
new MomentumOptimizer(e, t, r)
},
e.rmsprop = function (e, t, r, n, a) {
return void 0 === t && (t = 0.9),
void 0 === r && (r = 0),
void 0 === n && (n = 1e-8),
void 0 === a && (a = !1),
new RMSPropOptimizer(e, t, r, n, a)
},
e.adam = function (e, t, r, n) {
return void 0 === e && (e = 0.001),
void 0 === t && (t = 0.9),
void 0 === r && (r = 0.999),
void 0 === n && (n = 1e-8),
new AdamOptimizer(e, t, r, n)
},
e.adadelta = function (e, t, r) {
return void 0 === e && (e = 0.001),
void 0 === t && (t = 0.95),
void 0 === r && (r = 1e-8),
new AdadeltaOptimizer(e, t, r)
},
e.adamax = function (e, t, r, n, a) {
return void 0 === e && (e = 0.002),
void 0 === t && (t = 0.9),
void 0 === r && (r = 0.999),
void 0 === n && (n = 1e-8),
void 0 === a && (a = 0),
new AdamaxOptimizer(e, t, r, n, a)
},
e.adagrad = function (e, t) {
return void 0 === t && (t = 0.1),
new AdagradOptimizer(e, t)
},
__decorate$30([doc()], e, 'sgd', null),
__decorate$30([doc()], e, 'momentum', null),
__decorate$30([doc()], e, 'rmsprop', null),
__decorate$30([doc()], e, 'adam', null),
__decorate$30([doc()], e, 'adadelta', null),
__decorate$30([doc()], e, 'adamax', null),
__decorate$30([doc()], e, 'adagrad', null),
e
}(),
train = {
...
null != o && (this.originalName = getScopedTensorName(o), this.name = getUniqueTensorName(this.originalName)),
this.rank = t.length
}
...
function e(e, t, r, n, a) {
void 0 === t && (t = 'float32'),
void 0 === r && (r = DEFAULT_VARIABLE_NAME_PREFIX),
void 0 === n && (n = !0),
void 0 === a && (a = null),
this.dtype = null == t ? 'float32' : t,
this.shape = e.shape,
this.id = getNextUniqueTensorId(),
r = null == r ? DEFAULT_VARIABLE_NAME_PREFIX : r,
this.originalName = getScopedTensorName(r),
this.name = getUniqueTensorName(this.originalName),
this.trainable = n,
this.constraint = a,
this.val = variable(e, this.trainable, this.name, this.dtype)
}
return e.prototype.read = function () {
return this.val
},
e.prototype.write = function (e) {
return checkShapesMatch(this.val, e),
this.val.assign(e),
...
function t(t) {
var r = e.call(this) || this;
return r.defaultMaxValue = 2,
r.defaultAxis = 0,
r.maxValue = null != t.maxValue ? t.maxValue : r.defaultMaxValue,
r.axis = null != t.axis ? t.axis : r.defaultAxis,
r
}
return __extends$10(t, e),
...
function t(t) {
var r = e.call(this) || this;
return r.defaultMinValue = 0,
r.defaultMaxValue = 1,
r.defaultRate = 1,
r.defaultAxis = 0,
r.minValue = null != t.minValue ? t.minValue : r.defaultMinValue,
r.maxValue = null != t.maxValue ? t.maxValue : r.defaultMaxValue,
r.rate = null != t.rate ? t.rate : r.defaultRate,
r.axis = null != t.axis ? t.axis : r.defaultAxis,
r
}
return __extends$10(t, e),
...
for (var e = [
], t = 0, r = this.inboundLayers; t < r.length; t++) {
  var n = r[t];
...
r._stateful = !1,
r.id = _nextLayerID++,
r.activityRegularizer = null,
r.inputSpec = null,
r.supportsMasking = !1,
r._trainableWeights = [
],
r._nonTrainableWeights = [
],
r._losses = [
],
r._updates = [
...
if (r.name = n, r.trainable = null == t.trainable || t.trainable, r.updatable = null == t.updatable || t.updatable, null != t.inputShape || null != t.batchInputShape) {
  ...
  if (null != t.batchInputShape) o = t.batchInputShape;
    ...
    var i = null;
    null != t.batchSize && (i = t.batchSize),
    o = [
      i
    ].concat(t.inputShape)
  }
  r.batchInputShape = o;
  var s = t.dtype;
  null == s && (s = t.inputDType),
  null == s && (s = floatx()),
  r.dtype = s
}
return null != t.weights ? r.initialWeights = t.weights : r.initialWeights = null,
r
}
return __extends$11(t, e),
    ...
    if (null != a) {
      ...
      if (a.axes) {
        ...
        for (var s in a.axes) {
          ...
          if (null != l && - 1 === [l,
          null].indexOf(c)) throw new ValueError('Input ' + r + ' is incompatible with layer ' + this.name + ': expected axis ' + u + ' of input shape to have value ' + l + ' but got shape ' + p + '.')
        }
      }
      if (null != a.shape) for (var p = intShape(n), d = 0; d < a.shape.length; ++d) {
        var h = a.shape[d],
        f = p[d];
...
for (var n = toList(e), a = !0, o = 0, i = n; o < i.length; o++) if (!((c = i[o]) instanceof SymbolicTensor)) {
  a = !1;
  break
}
...
return nameScope$1(this.name, function () {
  if (!r.built) {
    ...
    for (var a = [
    ], o = 0, i = toList(e); o < i.length; o++) {
      var u = i[o];
      a.push(intShape(u))
    }
    r.build(singletonOrArray(a)),
    r.built = !0,
    r.initialWeights && r.setWeights(r.initialWeights)
  }
  if (r.assertInputCompatibility(e), s) {
    for (var l = [
    ], c = 0, p = toList(m = r.call(e, t)); c < p.length; c++) {
      var d = p[c];
      - 1 !== n.indexOf(d) && (d = identity(d)),
      l.push(d)
    }
...
return void 0 === e && (e = !1),
batchGetValue(e ? this.trainableWeights : this.weights)
},
...
tidy(function () {
  ...
  if (0 !== r.length) {
    for (var n = [
    ], a = batchGetValue(r), o = 0; o < a.length; ++o) {
      var i = a[o],
      s = r[o],
      u = e[o];
...
null == o && (o = !0),
o ? this._trainableWeights.push(s)  : this._nonTrainableWeights.push(s),
s
},
...
r = toList(r),
n = toList(n),
a = normalizeShapeList(a),
o = normalizeShapeList(o);
for (var u = [
], l = [
], c = [
], p = 0, d = s; p < d.length; p++) {
  var h = d[p];
  u.push(h.sourceLayer),
  l.push(h.nodeIndex),
  c.push(h.tensorIndex)
}
new Node({
  outboundLayer: this,
  inboundLayers: u,
...
for (var f = 0; f < t.length; f++) t[f].sourceLayer = this,
t[f].nodeIndex = this.inboundNodes.length - 1,
t[f].tensorIndex = f
},
t.prototype.getConfig = function () {
var e = {
...
__decorate$33([doc()], t.prototype, 'apply', null),
t = __decorate$33([doc()], t)
}(Serializable),
...
var o = new SymbolicTensor(r.dtype, r.batchInputShape, r, [
], {
}, r.name);
return o.nodeIndex = 0,
o.tensorIndex = 0,
new Node({
  outboundLayer: r,
  inboundLayers: [
...
if (n.supportsMasking = !1, n.trainable = !0, n.updatable = !0, Array.isArray(r.inputs) ? n.inputs = r.inputs.slice()  : n.inputs = [
  r.inputs
], Array.isArray(r.outputs) ? n.outputs = r.outputs.slice()  : n.outputs = [
  r.outputs
], unique(n.inputs).length !== n.inputs.length) throw new ValueError('The list of inputs passed to the model is redundant. All inputs should only appear once. Found: ' + n.inputs.map(function (e) {
  return e.name
}));
...
n.inputLayersNodeIndices = [
],
n.inputLayersTensorIndices = [
],
n.outputLayers = [
],
n.outputLayersNodeIndices = [
],
n.outputLayersTensorIndices = [
],
n.layers = [
];
for (var o = 0, i = n.outputs; o < i.length; o++) {
  ...
  u = ee.nodeIndex,
  l = ee.tensorIndex;
  n.outputLayers.push(s),
  n.outputLayersNodeIndices.push(u),
  n.outputLayersTensorIndices.push(l)
}
for (var c = 0, p = n.inputs; c < p.length; c++) {
  var s = (ee = p[c]).sourceLayer,
  u = ee.nodeIndex,
  l = ee.tensorIndex;
  assert$1(0 === u, 'input layer has >1 nodes'),
  assert$1(0 === l, 'input layer has >1 tensors'),
  n.inputLayers.push(s),
  n.inputLayersNodeIndices.push(u),
  n.inputLayersTensorIndices.push(l)
}
n.inputNames = [
],
n.outputNames = [
...
for (O = 0; O < n.inputLayers.length; O++) {
  ...
  n.inputNames.push(s.name),
  n.feedInputShapes.push(s.batchInputShape),
  n.feedInputNames.push(s.name)
}
...
for (var f = {
  ...
  if ( - 1 === r.indexOf(u)) {
    n.containerNodes.add(t.nodeKey(o, i)),
    o.id in v || (v[o.id] = Object.keys(v).length),
    - 1 === a.indexOf(u) && a.push(u);
...
], S = 0, A = n.outputs; S < A.length; S++) {
  ee = A[S];
  x(ee, w, _)
}
for (var N = 0, E = b.slice().reverse(); N < E.length; N++) {
  m[(K = E[N]).id] = K,
  K.id in f || (f[K.id] = 0);
  var T = f[K.id],
  I = null == g[K.outboundLayer.id] ? 0 : g[K.outboundLayer.id];
  T = Math.max(T, I),
  g[K.outboundLayer.id] = T,
  y[K.outboundLayer.id] = K.outboundLayer,
  f[K.id] = T;
  for (var O = 0; O < K.inboundLayers.length; O++) {
    var P = K.inboundLayers[O],
    u = K.nodeIndices[O],
    R = P.inboundNodes[u],
    k = null == f[R.id] ? 0 : f[R.id];
    f[R.id] = Math.max(T + 1, k),
    m[R.id] = R
  }
}
var C = {
};
for (var D in f) (T = f[D]) in C || (C[T] = [
]),
C[T].push(m[D]);
var M = {
};
for (var L in g) (T = g[L]) in M || (M[T] = [
]),
M[T].push(y[L]);
...
n.layersByDepth = M,
z = Object.keys(C).map(function (e) {
  return parseInt(e, 10)
}).sort(reverseNumberCompare);
for (var j = n.inputs.slice(), G = [
], W = 0, q = z; W < q.length; W++) for (var H = 0, X = C[T = q[W]]; H < X.length; H++) {
  var K = X[H];
  if (null != (s = K.outboundLayer)) {
    for (var J = 0, Y = K.inputTensors; J < Y.length; J++) {
      ee = Y[J];
    ...
    for (var Q = 0, Z = K.outputTensors; Q < Z.length; Q++) {
      var ee = Z[Q];
      j.push(ee)
    }
    G.push(s.name)
...
get: function () {
  ...
  for (var e = [
  ], t = 0, r = this.layers; t < r.length; t++) {
    var n = r[t];
...
get: function () {
  ...
  if (!this.trainable) {
    for (var n = [
    ], a = 0, o = this.layers; a < o.length; a++) {
      var i = o[a];
...
void 0 === t && (t = !1),
void 0 === r && (r = !1),
r ? loadWeightsFromNamedTensorMap(e, this.layers)  : loadWeightsFromJson(e, this.layers, t)
},
...
return tidy(function () {
  e = toList(e);
  var n;
  return n = 'mask' in t ? toList(t.mask)  : pyListRepeat(null, e.length),
  r.runInternalGraph(e, n) [0]
})
},
t.prototype.computeMask = function (e, t) {
var r = this;
return tidy(function () {
  e = toList(e);
  var n;
  return n = null == t ? pyListRepeat(null, e.length)  : toList(t),
  r.runInternalGraph(e, n) [1]
})
},
t.prototype.computeOutputShape = function (e) {
...
if (i.length > 1) for (var s = 0, u = i; s < u.length; s++) for (var l = u[s], c = 0, p = this.nodesByDepth[l]; c < p.length; c++) {
  var d = p[c],
  a = d.outboundLayer;
  if ( - 1 === this.inputLayers.map(function (e) {
    ...
    for (var h = [
    ], f = 0; f < d.inboundLayers.length; f++) {
...
], n = 0; n < this.outputLayers.length; n++) {
...
for (var s = 0, u = Object.keys(this.nodesByDepth).map(function (e) {
  return parseInt(e, 10)
}).sort(reverseNumberCompare); s < u.length; s++) for (var l = u[s], c = 0, p = this.nodesByDepth[l]; c < p.length; c++) {
  ...
  if (g.length === f.length) {
    ...
    if (null != d.callArgs && (b = d.callArgs), 1 === g.length) {
      ...
      N = A[0],
      E = A[1];
      null == b.mask && (b.mask = E),
      _ = toList(h.call(N, b)),
      S = toList(h.computeMask(N, E)),
      x = [
        N
      ],
      w = [
    ...
    null == b.mask && (b.mask = w),
    _ = toList(h.call(x, b)),
    S = toList(h.computeMask(x, w));
...
], P = 0, R = this.outputs; P < R.length; P++) {
...
return tidy(function () {
  for (var r = [
  ], n = 0, a = e.layers; n < a.length; n++) for (var o = a[n], i = 0; i < o.inboundNodes.length; ++i) {
    var s = t.nodeKey(o, i);
...
for (var e = {
  name: this.name
}, r = this.buildNodeConversionMap(this.layers), n = [
], a = 0, o = this.layers; a < o.length; a++) {
  for (var i = (b = o[a]).getClassName(), s = b.getConfig(), u = [
  ], l = 0; l < b.inboundNodes.length; l++) {
    var c = b.inboundNodes[l],
    p = t.nodeKey(b, l),
    d = {
    };
    if (this.containerNodes.has(p) && (c.callArgs && ( - 1 === JSON.stringify(c.callArgs).indexOf('undefined') ? d = c.callArgs : (console.warn('Layer ' + b.name + ' was passed non-serializable keyword arguments: ' + c.callArgs + '. They will not be included in the serialized model (and thus will be missing at deserialization time).'), d = {
    })), c.inboundLayers.length > 0)) {
      for (var h = [
      ], f = 0; f < c.inboundLayers.length; f++) {
        var m = c.inboundLayers[f],
        g = c.nodeIndices[f],
        y = c.tensorIndices[f];
        null !== (w = r[t.nodeKey(m, g)]) && void 0 !== w || (w = 0),
        h.push([m.name,
        w,
        y,
        d])
...
e.layers = n;
for (var v = [
], f = 0; f < this.inputLayers.length; f++) {
...
e.inputLayers = v;
for (var x = [
], f = 0; f < this.outputLayers.length; f++) {
...
return e.outputLayers = x,
e
},
t.fromConfig = function (e, t) {
function r(e, t) {
  e.name in a ? a[e.name].push(t)  : a[e.name] = [
    t
  ]
}
for (var n = {
}, a = {
}, o = t.name, i = t.layers, s = 0, u = i; s < u.length; s++) !function (e) {
  var a = e.name,
...
for (; !isObjectEmpty(a); ) for (var l = 0, c = i; l < c.length; l++) {
  var p = c[l];
...
], g = 0, y = t.inputLayers; g < y.length; g++) {
  var v = (p = y[g]) [0],
  b = p[1],
  x = p[2];
  assert$1(v in n);
  A = (S = n[v]).inboundNodes[b].outputTensors;
  f.push(A[x])
}
for (var w = 0, _ = t.outputLayers; w < _.length; w++) {
  ...
  assert$1(v in n);
  var S = n[v],
  A = S.inboundNodes[b].outputTensors;
  m.push(A[x])
}
return new e({
  inputs: f,
...
__decorate$33([doc()], t.prototype, 'getLayer', null),
t
}(Layer),
...
return __awaiter$14(this, void 0, void 0, function () {
  ...
  return __generator$14(this, function (i) {
    ...
    e = null == t.size ? 0 : t.size,
    this.seen += e,
    r = function (r) {
      var a = t[r];
      'number' == typeof a ? (n.totals.hasOwnProperty(r) || (n.totals[r] = 0), n.totals[r] = n.totals[r] + a * e)  : (n.totals.hasOwnProperty(r) || (n.totals[r] = getScalar(0)), tidy(function () {
        o.totals[r] = scalarPlusArray(o.totals[r], mul(a, getScalar(e))),
        keep(o.totals[r])
      }))
    },
    n = this;
  ...
  return __generator$14(this, function (s) {
    if (null != t) for (e = function (e) {
      ...
      'number' == typeof r.totals[e] ? t[e] = r.totals[e] / r.seen : tidy(function () {
        t[e] = scalarTimesArray(div(getScalar(1), getScalar(i.seen)), i.totals[e]),
        keep(t[e])
      })
    }, r = this, n = 0, a = this.params.metrics; n < a.length; n++) o = a[n],
    e(o);
    return [2]
  })
})
...
return __awaiter$14(this, void 0, void 0, function () {
  ...
  return __generator$14(this, function (n) {
    ...
    this.epoch.push(e);
    for (r in t) null == this.history[r] && (this.history[r] = [
    ]),
    this.history[r].push(t[r]);
    return [2]
  })
})
},
  ...
  return __generator$14(this, function (l) {
    switch (l.label) {
      case 0:
        ...
        for (n in this.history) for (a = this.history[n], o = 0; o < a.length; ++o) 'number' != typeof a[o] && (i = a[o], e.push(i.data()), t.push(n), r.push(o));
        return [4,
        Promise.all(e)];
      case 1:
        for (s = l.sent(), u = 0; u < s.length; ++u) this.history[t[u]][r[u]].dispose(),
        this.history[t[u]][r[u]] = s[u][0];
        return [2]
    }
  })
})
...
function t(t) {
var r = e.call(this) || this;
return r.trainBegin = t.onTrainBegin,
...
function e(t) {
if (this.id2Value = {
}, t instanceof e) for (var r in t.id2Value) this.id2Value[r] = t.id2Value[r];
 else {
  if (null == t) return;
...
return __extends$13(t, e),
t.prototype.compile = function (e) {
var t = this;
if (null == e.loss && (e.loss = [
]), this.loss = e.loss, 'string' == typeof e.optimizer) this.optimizer = getOptimizer(e.optimizer);
 else {
...
if (Array.isArray(e.loss) || 'string' == typeof e.loss || 'function' == typeof e.loss) if (Array.isArray(e.loss)) {
  ...
  e.loss = e.loss;
  for (var o in e.loss) if ( - 1 === this.outputNames.indexOf(o)) throw new ValueError('Unknown entry in loss dictionary: "' + o + '". Only expect the following keys: ' + this.outputNames);
  for (var i in this.outputNames) null == e.loss[i] && console.warn('Output "' + i + '" is missing from loss dictionary. We assume this was done on purpose, and we will not be expecting data to be passed to ' + i + ' during training'),
  r.push(get(e.loss[i]))
}
this.lossFunctions = r,
...
for (var s = 0; s < this.outputs.length; ++s) {
  ...
  this.feedOutputShapes.push(u),
  this.feedLossFns.push(this.lossFunctions[s])
}
var c = [
];
...
nameScope$1('loss', function () {
  for (var e = 0; e < t.outputs.length; ++e) if ( - 1 === c.indexOf(e)) {
    ...
    t.outputs.length > 1 && (t.metricsTensors.push([r,
    e]), t.metricsNames.push(t.outputNames[e] + '_loss'))
  }
});
var p = collectMetrics(e.metrics, this.outputNames),
d = function (e, r, n) {
  t.outputNames.length > 1 && (r = t.outputNames[e] + '_' + r),
  t.metricsNames.push(r),
  t.metricsTensors.push([n,
  e])
};
    ...
    !function (r) {
      for (var n, a, o, i = 0, s = p[e]; i < s.length; i++) !function (r) {
        ...
        'ce'].indexOf(r)) {
          ...
          1 === i[i.length - 1] || t.lossFunctions[e] === binaryCrossentropy ? - 1 !== ['accuracy',
          'acc'].indexOf(r) ? a = binaryAccuracy : - 1 !== ['crossentropy',
          'ce'].indexOf(r) && (a = binaryCrossentropy$1)  : t.lossFunctions[e] === sparseCategoricalCrossentropy ? - 1 !== ['accuracy',
          'acc'].indexOf(r) ? a = sparseCategoricalAccuracy : - 1 !== ['crossentropy',
          'ce'].indexOf(r) && (a = sparseCategoricalCrossentropy$1)  : - 1 !== ['accuracy',
          'acc'].indexOf(r) ? a = categoricalAccuracy : - 1 !== ['crossentropy',
          'ce'].indexOf(r) && (a = categoricalCrossentropy$1);
          var s = void 0;
          - 1 !== ['accuracy',
          'acc'].indexOf(r) ? s = 'acc' : - 1 !== ['crossentropy',
          'ce'].indexOf(r) && (s = 'ce'),
          o = a,
          n = '' + s
        } else {
...
for (var o = makeBatches(a, t), i = [
], s = 0; s < o.length; ++s) !function (t) {
  var r = tidy(function () {
    var r = o[t][0],
    a = o[t][1],
    i = sliceArrays(e, r, a),
    ...
    if (Array.isArray(i)) for (var u = 0; u < i.length; ++u) s.push({
      key: n.inputs[u],
      value: i[u]
    });
     else s.push({
  ...
  if (0 === t) for (var a = 0, s = r; a < s.length; a++) {
    var u = s[a];
    i.push(u)
  } else for (var l = 0; l < r.length; ++l) i[l] = concatAlongFirstAxis(i[l], r[l])
}(s);
...
checkInputData(e, this.inputNames, this.feedInputShapes, !1);
var r = null == t.batchSize ? 32 : t.batchSize;
return this.predictLoop(e, r)
},
t.prototype.predictOnBatch = function (e) {
return checkInputData(e, this.inputNames, this.feedInputShapes, !0),
this.predictLoop(e, e.shape[0])
},
...
for (var a = [
], o = 0; o < this.feedOutputShapes.length; ++o) {
...
__awaiter$15(this, void 0, void 0, function () {
  ...
  b,
  x = this;
  return __generator$15(this, function (w) {
    switch (w.label) {
      case 0:
        ...
        if (null != (m = this.checkNumSamples(t, n, d, 'steps_per_epoch')) && (g = range$1(0, m)), this.history = new History, i = null == i ? [
          new BaseLogger
        ] : [
          new BaseLogger
        ].concat(i), i = i.concat([this.history]), o > 0) throw new NotImplementedError('Verbose mode is not implemented yet.');
        return (y = new CallbackList(i)).setModel(this),
        y.setParams({
          epochs: a,
          steps: d,
          verbose: o,
      ...
      case 1:
        ...
        v = function (a) {
          ...
          p,
          h;
          return __generator$15(this, function (v) {
            switch (v.label) {
              case 0:
                return [4,
                y.onEpochBegin(a)];
                    ...
                    switch (p.label) {
                      ...
                      case 1:
                        ...
                        tidy(function () {
                          ...
                          if (a === c.length - 1 && f) for (var w = x.testLoop(s, u, n), y = 0; y < r.length; ++y) {
                            var v = r[y],
                            b = w[y];
                            keep(b),
                            o['val_' + v] = b
...
t.prototype.testLoop = function (e, t, r, n, a) {
  ...
  for (var s = makeBatches(o, r), u = tensor1d(range$1(0, o)), l = 0; l < s.length; ++l) {
    ...
    if (0 === l) for (f = 0; f < d.length; ++f) i.push(getScalar(0));
...
t.prototype.getDedupedMetricsNames = function () {
  for (var e = this.metricsNames, t = [
  ], r = 0; r < e.length; ++r) {
    var n = e[r],
    a = n;
    count(e, n) > 1 && (a += '_' + count(e.slice(0, r), n)),
    t.push(a)
  }
  return t
},
t.prototype.makeTestFunction = function () {
  ...
  this.testFunction = function (t) {
    return tidy(function () {
      for (var r, n = [
      ], a = t.slice(0, e.inputs.length), o = t.slice(e.inputs.length, e.inputs.length + e.outputs.length), i = [
      ], s = 0; s < e.inputs.length; ++s) i.push({
        key: e.inputs[s],
        value: a[s]
      });
...
t.prototype.fit = function (e, t, r) {
  ...
  __awaiter$15(this, void 0, void 0, function () {
    ...
    x = this;
    return __generator$15(this, function (w) {
      if (n = null == r.batchSize ? 32 : r.batchSize, a = this.standardizeUserData(e, t, !1, n), o = a[0], i = a[1], s = !1, null != r.validationData && r.validationData.length > 0) {
        ...
        u = r.validationData[0],
        l = r.validationData[1],
        p = this.standardizeUserData(u, l, !0, n),
        u = p[0],
        l = p[1],
        c = u.concat(l)
      } else null != r.validationSplit && r.validationSplit > 0 && r.validationSplit < 1 ? (s = !0, d = Math.floor(o[0].shape[0] * (1 - r.validationSplit)), h = o[0].shape[0], u = sliceArrays(o, d, h), o = sliceArrays(o, 0, d), l = sliceArrays(i, d, h), i = sliceArrays(i, 0, d), c = u.concat(l))  : null != r.validationSteps && (s = !0);
      return f = o.concat(i),
      this.checkTrainableWeightsConsistency(),
      m = function (e) {
        var t = e.slice(0, x.inputs.length),
        r = e.slice(x.inputs.length, x.inputs.length + x.outputs.length),
        n = [
        ],
        a = x.collectedTrainableWeights.map(function (e) {
          return e.read()
        });
        return [x.optimizer.minimize(function () {
          for (var e = [
          ], a = 0; a < x.inputs.length; ++a) e.push({
            key: x.inputs[a],
            value: t[a]
          });
          for (var o, i = new FeedDict(e), s = execute(x.outputs, i, {
            training: !0
          }), a = 0; a < x.lossFunctions.length; ++a) {
            var u = (0, x.lossFunctions[a]) (r[a], s[a]);
            mean(u),
            o = 0 === a ? u : add(o, u)
          }
          for (a = 0; a < x.metricsTensors.length; ++a) {
            var l = x.metricsTensors[a][0],
            c = x.metricsTensors[a][1],
            p = mean(l(r[c], s[c]));
            keep(p),
            n.push(p)
          }
          return o = mean(o),
          x.calculateLosses().forEach(function (e) {
            o = add(o, e)
          }),
          o
        }, !0, a)].concat(n)
      },
      g = this.getDedupedMetricsNames(),
      s ? (this.makeTestFunction(), y = this.testFunction, v = g.slice().concat(g.map(function (e) {
        return 'val_' + e
      })))  : (y = null, c = [
      ], v = g.slice()),
      b = standardizeCallbacks(r.callbacks),
      [
        2,
        this.fitLoop(m, f, g, n, r.epochs, r.verbose, b, y, c, r.shuffle, v, null, null, null)
      ]
    })
  })
},
t.prototype.getNamedWeights = function (e) {
  for (var t = {
  }, r = null != e && e.trainableOnly, n = r ? this.trainableWeights : this.weights, a = this.getWeights(r), o = 0; o < n.length; ++o) r && !n[o].trainable || (t[n[o].originalName] = a[o]);
  return t
},
    ...
    return __generator$15(this, function (s) {
      switch (s.label) {
        case 0:
          ...
          return [4,
          encodeWeights(this.getNamedWeights(t))];
        case 1:
          return n = s.sent(),
          a = !1,
          o = null,
...
t.className = 'Model',
__decorate$34([doc()], t.prototype, 'compile', null),
__decorate$34([doc()], t.prototype, 'evaluate', null),
__decorate$34([doc()], t.prototype, 'predict', null),
__decorate$34([doc()], t.prototype, 'predictOnBatch', null),
__decorate$34([doc()], t.prototype, 'fit', null),
t = __decorate$34([doc()], t)
}(Container);
...
function t(t) {
  var r = e.call(this) || this;
  return r.DEFAULT_MINVAL = - 0.05,
  r.DEFAULT_MAXVAL = 0.05,
  r.minval = t.minval || r.DEFAULT_MINVAL,
  r.maxval = t.maxval || r.DEFAULT_MAXVAL,
  r.seed = t.seed,
  r
}
return __extends$14(t, e),
...
function t(t) {
  var r = e.call(this) || this;
  return r.DEFAULT_MEAN = 0,
  r.DEFAULT_STDDEV = 0.05,
  r.mean = t.mean || r.DEFAULT_MEAN,
  r.stddev = t.stddev || r.DEFAULT_STDDEV,
  r.seed = t.seed,
  r
}
return __extends$14(t, e),
...
function t(t) {
  var r = e.call(this) || this;
  return r.gain = null != t.gain ? scalar(t.gain)  : getScalar(1),
  r
}
return __extends$14(t, e),
t.prototype.apply = function (e, t) {
...
function t(t) {
  ...
  return r.scale = null == t.scale ? 1 : t.scale,
  r.mode = t.mode,
  checkFanMode(r.mode),
  r.distribution = t.distribution,
  checkDistribution(r.distribution),
  r.seed = t.seed,
  r
}
return __extends$14(t, e),
...
t.prototype.apply = function (e, t) {
  ...
  return tidy(function () {
    ...
    return e[0] > e[1] && (n = n.transpose()),
    scalarTimesArray(getScalar(r.gain), n)
  })
},
t.prototype.getConfig = function () {
  return {
...
function t(t) {
  var r = e.call(this, null == t ? {
  }
   : t) || this;
  return r.DEFAULT_ALPHA = 0.3,
  null == t && (t = {
  }),
  r.alpha = null == t.alpha ? r.DEFAULT_ALPHA : t.alpha,
  r
}
return __extends$16(t, e),
t.prototype.call = function (e, t) {
...
function t(t) {
  var r = e.call(this, null == t ? {
   ...
   : t) || this;
  if (r.DEFAULT_ALPHA = 1, null == t && (t = {
  }), null != t.alpha && t.alpha !== r.DEFAULT_ALPHA) throw new NotImplementedError('Non-default alpha value (' + t.alpha + ') is not supported by the ELU layer yet.');
  return r.alpha = null == t.alpha ? r.DEFAULT_ALPHA : t.alpha,
  r
}
return __extends$16(t, e),
t.prototype.call = function (e, t) {
...
function t(t) {
  var r = e.call(this, null == t ? {
   ...
   : t) || this;
  return r.DEFAULT_THETA = 1,
  null == t && (t = {
  }),
  r.theta = null == t.theta ? r.DEFAULT_THETA : t.theta,
  r.thetaTensor = getScalar(r.theta),
  r
}
return __extends$16(t, e),
t.prototype.call = function (e, t) {
...
function t(t) {
  var r = e.call(this, null == t ? {
   ...
   : t) || this;
  return r.DEFAULT_AXIS = 1,
  null == t && (t = {
  }),
  r.softmax = (new Softmax).apply,
  r.axis = null == t.axis ? r.DEFAULT_AXIS : t.axis,
  r
}
return __extends$16(t, e),
t.prototype.call = function (e, t) {
...
return __extends$17(t, e),
t
}(Serializable),
L1L2 = function (e) {
function t(t) {
  var r = e.call(this) || this,
  n = null == t || null == t.l1 ? 0.01 : t.l1,
  a = null == t || null == t.l2 ? 0.01 : t.l2;
  return r.hasL1 = 0 !== n,
  r.hasL2 = 0 !== a,
  r.l1 = getScalar(n),
  r.l2 = getScalar(a),
...
t.prototype.apply = function (e) {
  ...
  return tidy(function () {
    var r = zeros([1]);
    return t.hasL1 && (r = add(r, sum(scalarTimesArray(t.l1, abs(e))))),
    t.hasL2 && (r = add(r, sum(scalarTimesArray(t.l2, square$1(e))))),
    r.asScalar()
  })
},
t.prototype.getConfig = function () {
...
Conv = function (e) {
  function t(t, r) {
    ...
    if (2 === n.rank) if ('number' == typeof n.dilationRate) {
      n.dilationRate = [n.dilationRate, n.dilationRate];
    } else if (2 !== n.dilationRate.length) {
      throw new ValueError('dilationRate must be a number or array of two numbers for 2D convolution, but received ' + JSON.stringify(n.dilationRate));
    }
    return n.activation = getActivation(r.activation),
    n.useBias = null == r.useBias || r.useBias,
    n.kernelInitializer = getInitializer(r.kernelInitializer || n.DEFAULT_KERNEL_INITIALIZER),
    n.biasInitializer = getInitializer(r.biasInitializer || n.DEFAULT_BIAS_INITIALIZER),
    n.kernelConstraint = getConstraint(r.kernelConstraint),
    n.biasConstraint = getConstraint(r.biasConstraint),
    n.kernelRegularizer = getRegularizer(r.kernelRegularizer),
    n.biasRegularizer = getRegularizer(r.biasRegularizer),
    n.activityRegularizer = getRegularizer(r.activityRegularizer),
    n
  }
  return __extends$18(t, e),
  t.prototype.build = function (e) {
    ...
    this.kernel = this.addWeight('kernel', n, null, this.kernelInitializer, this.kernelRegularizer, !0, this.kernelConstraint),
    this.useBias && (this.bias = this.addWeight('bias', [this.filters],
      null, this.biasInitializer, this.biasRegularizer, !0, this.biasConstraint)),
    this.inputSpec = [{ndim: this.rank + 2, axes: (a = {}, a[t] = r, a)}],
    this.built = !0;
    var a
  },
  t.prototype.call = function (e, t) {
    ...
    return tidy(function () {
      ...
      if (r.dataFormat == "channelsFirst") t = transpose(t, [0, 2, 1]);
      return null != r.activation && (t = r.activation.apply(t)),
      t
    })
  },
  t.prototype.computeOutputShape = function (e) {
    e = getExactlyOneShape(e);
    for (var t = [
    ], r = 'channelsLast' === this.dataFormat ? e.slice(1, e.length - 1)  : e.slice(2), n = 0; n < r.length; ++n) {
    ...
    var o = [e[0]];
    return 'channelsLast' === this.dataFormat ? (o = o.concat(t)).push(this.filters)  : (o.push(this.filters), o = o.concat(t)),
    o
  },
  t.prototype.getConfig = function () {
    var t = {
...
t.prototype.build = function (e) {
  ...
  var r = e[t],
  n = this.kernelSize.concat([this.filters,
  r]);
  this.kernel = this.addWeight('kernel', n, 'float32', this.kernelInitializer, this.kernelRegularizer, !0, this.kernelConstraint),
  this.useBias && (this.bias = this.addWeight('bias', [
    this.filters
  ], 'float32', this.biasInitializer, this.biasRegularizer, !0, this.biasConstraint)),
  this.inputSpec = [
    new InputSpec({
      ndim: 4,
      axes: (a = {
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    ...
    h = [
      i,
      deconvLength(s, p, l, r.padding),
      deconvLength(u, d, c, r.padding),
      r.filters
    ];
    'channelsLast' !== r.dataFormat && (t = transpose(t, [
      0,
      2,
      3,
      1
    ...
    return 'channelsLast' !== r.dataFormat && (f = transpose(f, [
      0,
      3,
      1,
      2
    ])),
    null != r.bias && (f = biasAdd(f, r.bias.read(), r.dataFormat)),
    null != r.activation && (f = r.activation.apply(f)),
    f
  })
},
t.prototype.computeOutputShape = function (e) {
  ...
  a[r] = deconvLength(a[r], s, o, this.padding),
  a[n] = deconvLength(a[n], u, i, this.padding),
  a
},
t.prototype.getConfig = function () {
  var t = e.prototype.getConfig.call(this);
...
function t(t, r) {
  ...
  return n.depthMultiplier = null == r.depthMultiplier ? 1 : r.depthMultiplier,
  n.depthwiseInitializer = getInitializer(r.depthwiseInitializer || n.DEFAULT_DEPTHWISE_INITIALIZER),
  n.depthwiseRegularizer = getRegularizer(r.depthwiseRegularizer),
  n.depthwiseConstraint = getConstraint(r.depthwiseConstraint),
  n.pointwiseInitializer = getInitializer(r.depthwiseInitializer || n.DEFAULT_POINTWISE_INITIALIZER),
  n.pointwiseRegularizer = getRegularizer(r.pointwiseRegularizer),
  n.pointwiseConstraint = getConstraint(r.pointwiseConstraint),
  n
}
return __extends$18(t, e),
t.prototype.build = function (e) {
  ...
  for (var r = e[t], n = this.kernelSize.concat([r,
  this.depthMultiplier]), a = [
  ], o = 0; o < this.rank; ++o) a.push(1);
  ...
  this.pointwiseKernel = this.addWeight('pointwise_kernel', a, 'float32', this.pointwiseInitializer, this.pointwiseRegularizer, !0, this.pointwiseConstraint),
  this.useBias ? this.bias = this.addWeight('bias', [
    this.filters
  ], 'float32', this.biasInitializer, this.biasRegularizer, !0, this.biasConstraint)  : this.bias = null,
  this.inputSpec = [
    new InputSpec({
      ndim: this.rank + 2,
      axes: (i = {
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    ...
    return 2 === r.rank && ('channelsFirst' === r.dataFormat && (e = transpose(e, [
      0,
      2,
      3,
      1
    ])), t = separableConv2d(e, r.depthwiseKernel.read(), r.pointwiseKernel.read(), r.strides, r.padding, r.dilationRate, 'NHWC')),
    r.useBias && (t = biasAdd(t, r.bias.read(), r.dataFormat)),
    null != r.activation && (t = r.activation.apply(t)),
    'channelsFirst' === r.dataFormat && (t = transpose(t, [
      0,
      3,
      1,
      2
...
t.prototype.getConfig = function () {
  ...
  t.depthwiseInitializer = serializeInitializer(this.depthwiseInitializer),
  t.pointwiseInitializer = serializeInitializer(this.pointwiseInitializer),
  t.depthwiseRegularizer = serializeRegularizer(this.depthwiseRegularizer),
  t.pointwiseRegularizer = serializeRegularizer(this.pointwiseRegularizer),
  t.depthwiseConstraint = serializeConstraint(this.depthwiseConstraint),
  t.pointwiseConstraint = serializeConstraint(this.pointwiseConstraint),
  t
},
t.className = 'SeparableConv',
t
}(Conv),
...
function t(t) {
  ...
  ] : r.cropping = t.cropping,
  r.dataFormat = void 0 === t.dataFormat ? 'channelsLast' : t.dataFormat,
  r.inputSpec = [
    {
      ndim: 4
    }
...
function t(t) {
  var r = e.call(this, t) || this;
  return r.depthwiseKernel = null,
  r.depthMultiplier = null == t.depthMultiplier ? 1 : t.depthMultiplier,
  r.depthwiseInitializer = getInitializer(t.depthwiseInitializer || r.DEFAULT_KERNEL_INITIALIZER),
  r.depthwiseConstraint = getConstraint(t.depthwiseConstraint),
  r.depthwiseRegularizer = getRegularizer(t.depthwiseRegularizer),
  r
}
return __extends$19(t, e),
t.prototype.build = function (e) {
  ...
  ], null, this.biasInitializer, this.biasRegularizer, !0, this.biasConstraint)  : this.bias = null,
  this.built = !0
},
t.prototype.call = function (e, t) {
  var r = this;
  return tidy(function () {
    ...
    return r.useBias && (t = biasAdd(t, r.bias.read(), r.dataFormat)),
    null != r.activation && (t = r.activation.apply(t)),
    t
  })
},
...
function t(t) {
  ...
  return r.supportsMasking = !0,
  r
}
return __extends$20(t, e),
t.prototype.getNoiseShape = function (e) {
  if (null == this.noiseShape) return this.noiseShape;
  for (var t = e.shape, r = [
  ], n = 0; n < this.noiseShape.length; ++n) r.push(null == this.noiseShape[n] ? t[n] : this.noiseShape[n]);
  return r
},
t.prototype.call = function (e, t) {
  var r = this;
...
function t(t) {
  ...
  return r.units = t.units,
  r.activation = getActivation(t.activation),
  null != t.useBias && (r.useBias = t.useBias),
  r.kernelInitializer = getInitializer(t.kernelInitializer || r.DEFAULT_KERNEL_INITIALIZER),
  r.biasInitializer = getInitializer(t.biasInitializer || r.DEFAULT_BIAS_INITIALIZER),
  r.kernelConstraint = getConstraint(t.kernelConstraint),
  r.biasConstraint = getConstraint(t.biasConstraint),
  r.kernelRegularizer = getRegularizer(t.kernelRegularizer),
  r.biasRegularizer = getRegularizer(t.biasRegularizer),
  r.activityRegularizer = getRegularizer(t.activityRegularizer),
  r.inputSpec = [
    {
      minNDim: 2
    }
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    r.invokeCallHook(e, t);
    var n = dot(getExactlyOneTensor(e), r.kernel.read());
    return null != r.bias && (n = biasAdd(n, r.bias.read())),
...
var Flatten = function (e) {
  function t(t) {
    var r = e.call(this, t || {}) || this;
    return r.inputSpec = [{minNDim: 3}], r
  }
  return __extends$20(t, e),
  t.prototype.computeOutputShape = function (e) {
  ...
  t.prototype.call = function (e, t) {
    var r = this;
    return tidy(function () {
      console.log("Warning: const tensor = transpose(getExactlyOneTensor(e), [0, 2, 1])");
      const tensor = transpose(getExactlyOneTensor(e), [0, 2, 1]);
      return r.invokeCallHook(e, t), batchFlatten(tensor)
    })
  },
  t.className = 'Flatten',
  t
...
t.prototype.call = function (e, t) {
  var r = this;
  return tidy(function () {
    return e = getExactlyOneTensor(e),
    repeat(e, r.n)
  })
},
t.prototype.getConfig = function () {
...
return __extends$20(t, e),
t.prototype.isUnknown = function (e) {
  return e < 0 || null == e
},
...
t.prototype.computeOutputShape = function (e) {
  for (var t = !1, r = 0; r < e.length; ++r) if (this.isUnknown(e[r])) {
    t = !0;
    break
  }
...
function t(t) {
  ...
  if (r.embeddings = null, r.DEFAULT_EMBEDDINGS_INITIALIZER = 'randomUniform', null == t.batchInputShape && null == t.inputShape) {
    var n = null;
    null != t.batchSize && (n = t.batchSize),
    null == t.inputLength ? r.batchInputShape = [
      n,
      null
    ] : r.batchInputShape = [
      n
  ...
  return r.inputDim = t.inputDim,
  r.outputDim = t.outputDim,
  r.embeddingsInitializer = getInitializer(t.embeddingsInitializer || r.DEFAULT_EMBEDDINGS_INITIALIZER),
  r.embeddingsRegularizer = getRegularizer(t.embeddingsRegularizer),
  r.activityRegularizer = getRegularizer(t.activityRegularizer),
  r.embeddingsConstraint = getConstraint(t.embeddingsConstraint),
  r.maskZero = t.maskZero,
  r.inputLength = t.inputLength,
  r
}
return __extends$21(t, e),
t.prototype.build = function (e) {
  this.embeddings = this.addWeight('embeddings', [
    this.inputDim,
    this.outputDim
  ], this.dtype, this.embeddingsInitializer, this.embeddingsRegularizer, !0, this.embeddingsConstraint),
  this.built = !0
},
t.prototype.computeMask = function (e, t) {
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    r.invokeCallHook(e, t);
    var n = getExactlyOneTensor(e);
    return 'int32' !== dtype(n) && (n = cast$1(n, 'int32')),
    gather$1(r.embeddings.read(), n.as1D()).reshape(getExactlyOneShape(r.computeOutputShape(n.shape)))
  })
},
t.prototype.getConfig = function () {
  var t = {
...
t.prototype.build = function (e) {
  if (Array.isArray(e) && !Array.isArray(e[0]) && (e = [
    getExactlyOneShape(e)
  ]), (e = e).length < 2) throw new ValueError('A merge layer should be called on an Array of at least 2 inputs. Got ' + e.length + ' input(s).');
  for (var t = [
  ], r = 0, n = e; r < n.length; r++) null != (i = n[r]) && null !== i[0] && t.push(i[0]);
  ...
  return tidy(function () {
    if (e = e, r.reshapeRequired) {
      ...
      if (l) if (null == v) {
        ...
        m = [
          f = b[b.length - 1]
        ].concat(b.slice(0, b.length - 1));
        y = transpose(y.reshape([ - 1,
        f]), [
          1,
          0
        ]).reshape(m)
...
t.prototype.computeOutputShape = function (e) {
  ...
  for (var a = [
  ], o = 0, i = e; o < i.length; o++) null != (n = i[o]) && null !== n[0] && a.push(n[0]);
  return a = unique(a),
  t = 1 === a.length ? a.concat(t)  : [
    null
  ].concat(t)
},
t
...
t.prototype.build = function (e) {
  ...
  for (var t = !0, r = 0, n = e = e; r < n.length; r++) if (null != (c = n[r])) {
    t = !1;
    break
  }
  if (!t) {
...
function t(t) {
  var r = e.call(this, t) || this;
  return r.supportsMasking = !0,
  r.axis = null == t.axis ? - 1 : t.axis,
  r.momentum = null == t.momentum ? 0.99 : t.momentum,
  r.epsilon = null == t.epsilon ? 0.001 : t.epsilon,
  r.center = null == t.center || t.center,
  r.scale = null == t.scale || t.scale,
  r.betaInitializer = getInitializer(t.betaInitializer || 'zeros'),
  r.gammaInitializer = getInitializer(t.gammaInitializer || 'ones'),
  r.movingMeanInitializer = getInitializer(t.movingMeanInitializer || 'zeros'),
  r.movingVarianceInitializer = getInitializer(t.movingVarianceInitializer || 'ones'),
  r.betaConstraint = getConstraint(t.betaConstraint),
  r.gammaConstraint = getConstraint(t.gammaConstraint),
  r.betaRegularizer = getRegularizer(t.betaRegularizer),
  r.gammaRegularizer = getRegularizer(t.gammaRegularizer),
  r.stepCount = 0,
  r
}
return __extends$23(t, e),
t.prototype.build = function (e) {
  e = getExactlyOneShape(e);
  ...
  this.scale && (this.gamma = this.addWeight('gamma', n, null, this.gammaInitializer, this.gammaRegularizer, !0, this.gammaConstraint)),
  this.center && (this.beta = this.addWeight('beta', n, null, this.betaInitializer, this.betaRegularizer, !0, this.betaConstraint)),
  this.movingMean = this.addWeight('moving_mean', n, null, this.movingMeanInitializer, null, !1),
  this.movingVariance = this.addWeight('moving_variance', n, null, this.movingVarianceInitializer, null, !1),
  this.built = !0;
  var a
},
t.prototype.call = function (e, t) {
...
t.className = 'BatchNormalization',
t
}(Layer);
...
function t(t) {
  var r = this;
  if (null == t && (t = {
  }), r = e.call(this, t) || this, r.dataFormat = null == t.dataFormat ? imageDataFormat()  : t.dataFormat, null == t.padding) r.padding = [
    [1,
    1],
    [
      1,
    ...
    var n = void 0,
    a = void 0;
    if ('number' == typeof t.padding[0]) n = [
      t.padding[0],
      t.padding[0]
    ],
    a = [
...
return __extends$24(t, e),
t.prototype.computeOutputShape = function (e) {
  e = getExactlyOneShape(e);
  var t,
  r;
  return 'channelsFirst' === this.dataFormat ? (t = null != e[2] && e[2] >= 0 ? e[2] + this.padding[0][0] + this.padding[0][1] : null, r = null != e[3] && e[3] >= 0 ? e[3] + this.padding[1][0] + this.padding[1][1] : null, [
    e[0],
    e[1],
    t,
    r
  ])  : (t = null != e[1] && e[1] >= 0 ? e[1] + this.padding[0][0] + this.padding[0][1] : null, r = null != e[2] && e[2] >= 0 ? e[2] + this.padding[1][0] + this.padding[1][1] : null, [
    e[0],
    t,
    r,
    e[3]
...
function t(t) {
  var r = this;
  if (null == t.poolSize && (t.poolSize = 2), r = e.call(this, t) || this, 'number' == typeof t.poolSize) r.poolSize = [
    t.poolSize
  ];
   else {
  ...
  if (null == t.strides) r.strides = r.poolSize;
   else if ('number' == typeof t.strides) r.strides = [
    t.strides
  ];
   else {
  ...
  return r.padding = null == t.padding ? 'valid' : t.padding,
  checkPaddingMode(r.padding),
  r.inputSpec = [
    new InputSpec({
      ndim: 3
    })
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    r.invokeCallHook(e, t),
    e = expandDims$1(getExactlyOneTensor(e), 2);
    var n = r.poolingFunction(getExactlyOneTensor(e), [
      r.poolSize[0],
      1
    ], [
      r.strides[0],
      1
    ], r.padding, 'channelsLast');
    return squeeze(n, [
      2
    ])
  })
...
return __extends$25(t, e),
t.prototype.poolingFunction = function (e, t, r, n, a) {
  return checkDataFormat(a),
  checkPaddingMode(n),
  pool2d(e, t, r, n, a, 'max')
},
t.className = 'MaxPooling1D',
t
}(Pooling1D);
...
t.prototype.poolingFunction = function (e, t, r, n, a) {
  return checkDataFormat(a),
  checkPaddingMode(n),
  pool2d(e, t, r, n, a, 'avg')
},
t.className = 'AveragePooling1D',
t
}(Pooling1D);
...
function t(t) {
  var r = this;
  return null == t.poolSize && (t.poolSize = [
    2,
    2
  ]),
  r = e.call(this, t) || this,
  r.poolSize = Array.isArray(t.poolSize) ? t.poolSize : [
    t.poolSize,
    t.poolSize
  ],
  r.strides = null == t.strides ? r.poolSize : t.strides,
  r.padding = null == t.padding ? 'valid' : t.padding,
  r.dataFormat = null == t.dataFormat ? 'channelsLast' : t.dataFormat,
  checkDataFormat(r.dataFormat),
  checkPaddingMode(r.padding),
  r.inputSpec = [
    new InputSpec({
      ndim: 4
...
t.prototype.computeOutputShape = function (e) {
  ...
  var t = 'channelsFirst' === this.dataFormat ? e[2] : e[1],
  r = 'channelsFirst' === this.dataFormat ? e[3] : e[2];
  return t = convOutputLength(t, this.poolSize[0], this.padding, this.strides[0]),
  r = convOutputLength(r, this.poolSize[1], this.padding, this.strides[1]),
...
t.prototype.call = function (e, t) {
  var r = this;
  return tidy(function () {
    return r.invokeCallHook(e, t),
    r.poolingFunction(getExactlyOneTensor(e), r.poolSize, r.strides, r.padding, r.dataFormat)
  })
},
t.prototype.getConfig = function () {
  var t = {
...
t.className = 'GlobalAveragePooling1D',
t
}(GlobalPooling1D);
...
t.className = 'GlobalMaxPooling1D',
t
}(GlobalPooling1D);
...
function t(t) {
  var r = e.call(this, t) || this;
  return r.dataFormat = null == t.dataFormat ? 'channelsLast' : t.dataFormat,
  checkDataFormat(r.dataFormat),
  r.inputSpec = [
    new InputSpec({
      ndim: 4
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    var t = getExactlyOneTensor(e);
    return 'channelsLast' === r.dataFormat ? mean(t, [
      1,
      2
    ])  : mean(t, [
      2,
...
t.className = 'GlobalAveragePooling2D',
t
}(GlobalPooling2D);
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    var t = getExactlyOneTensor(e);
    return 'channelsLast' === r.dataFormat ? max(t, [
      1,
      2
    ])  : max(t, [
      2,
...
t.className = 'GlobalMaxPooling2D',
t
}(GlobalPooling2D);
...
t.prototype.build = function (e) {
  ...
  this.cell.build(n);
  var a;
  if (a = Array.isArray(this.cell.stateSize) ? this.cell.stateSize : [
    this.cell.stateSize
  ], null != this.stateSpec) {
  ...
  tidy(function () {
    ...
    t.cell.stateSize]);
      ...
      if (Array.isArray(e) || (e = [
        e
      ]), e.length !== t.states.length) throw new ValueError('Layer ' + t.name + ' expects ' + t.states.length + ' state(s), but it received ' + e.length + ' state value(s). Input received: ' + e);
...
t.prototype.standardizeArgs = function (e, t, r) {
  ...
  if (Array.isArray(e)) {
    ...
    null != this.numConstants && (r = e.slice(e.length - this.numConstants, e.length), e = e.slice(0, e.length - this.numConstants)),
...
return __extends$26(t, e),
t = __decorate$37([doc()], t)
}(Layer),
SimpleRNNCell = function (e) {
function t(t) {
  var r = e.call(this, t) || this;
  return r.DEFAULT_ACTIVATION = 'tanh',
  r.DEFAULT_KERNEL_INITIALIZER = 'glorotNormal',
  r.DEFAULT_RECURRENT_INITIALIZER = 'orthogonal',
  r.DEFAULT_BIAS_INITIALIZER = 'zeros',
  r.units = t.units,
  r.activation = getActivation(null == t.activation ? r.DEFAULT_ACTIVATION : t.activation),
  r.useBias = null == t.useBias || t.useBias,
  r.kernelInitializer = getInitializer(t.kernelInitializer || r.DEFAULT_KERNEL_INITIALIZER),
  r.recurrentInitializer = getInitializer(t.recurrentInitializer || r.DEFAULT_RECURRENT_INITIALIZER),
  r.biasInitializer = getInitializer(t.biasInitializer || r.DEFAULT_BIAS_INITIALIZER),
  r.kernelRegularizer = getRegularizer(t.kernelRegularizer),
  r.recurrentRegularizer = getRegularizer(t.recurrentRegularizer),
  r.biasRegularizer = getRegularizer(t.biasRegularizer),
  r.kernelConstraint = getConstraint(t.kernelConstraint),
  r.recurrentConstraint = getConstraint(t.recurrentConstraint),
  r.biasConstraint = getConstraint(t.biasConstraint),
  r.dropout = min$1([1,
  max$1([0,
  null == t.dropout ? 0 : t.dropout])]),
  r.recurrentDropout = min$1([1,
  max$1([0,
...
t.prototype.build = function (e) {
  ...
  this.kernel = this.addWeight('kernel', [
    e[e.length - 1],
    this.units
  ], null, this.kernelInitializer, this.kernelRegularizer, !0, this.kernelConstraint),
  this.recurrentKernel = this.addWeight('recurrent_kernel', [
    this.units,
    this.units
  ], null, this.recurrentInitializer, this.recurrentRegularizer, !0, this.recurrentConstraint),
  this.useBias ? this.bias = this.addWeight('bias', [
    this.units
  ], null, this.biasInitializer, this.biasRegularizer, !0, this.biasConstraint)  : this.bias = null,
  this.built = !0
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    ...
    var n = dot(e, r.kernel.read());
    null != r.bias && (n = biasAdd(n, r.bias.read()));
    var a = add(n, dot(t, r.recurrentKernel.read()));
    return null != r.activation && (a = r.activation.apply(a)),
    [
      a,
      a
    ]
...
t.prototype.getConfig = function () {
  ...
  r = e.prototype.getConfig.call(this);
  return delete r.cell,
  Object.assign(t, r),
  t
},
t.className = 'SimpleRNN',
t
}(RNN);
...
function t(t) {
  ...
  r.DEFAULT_BIAS_INITIALIZER = 'zeros',
  r.units = t.units,
  r.activation = getActivation(void 0 === t.activation ? r.DEFAULT_ACTIVATION : t.activation),
  r.recurrentActivation = getActivation(void 0 === t.activation ? r.DEFAULT_RECURRENT_ACTIVATION : t.recurrentActivation),
  r.useBias = null == t.useBias || t.useBias,
  r.kernelInitializer = getInitializer(t.kernelInitializer || r.DEFAULT_KERNEL_INITIALIZER),
  r.recurrentInitializer = getInitializer(t.recurrentInitializer || r.DEFAULT_RECURRENT_INITIALIZER),
  r.biasInitializer = getInitializer(t.biasInitializer || r.DEFAULT_BIAS_INITIALIZER),
  ...
  max$1([0,
  null == t.recurrentDropout ? 0 : t.recurrentDropout])]),
  r.implementation = t.implementation,
  r.stateSize = r.units,
  r
}
return __extends$26(t, e),
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    ...
    if (1 === r.implementation) {
      ...
      w = t,
      _ = t;
      n = r.recurrentActivation.apply(add(f, dot(x, l))),
      a = r.recurrentActivation.apply(add(m, dot(w, c))),
      o = r.activation.apply(add(g, dot(mul(a, _), p)))
    } else {
      var S = dot(e, r.kernel.read());
      r.useBias && (S = biasAdd(S, r.bias.read()));
      var A = dot(t, sliceAlongLastAxis(r.recurrentKernel.read(), 0, 2 * r.units)),
      f = sliceAlongLastAxis(S, 0, r.units),
      m = sliceAlongLastAxis(S, r.units, r.units),
      N = sliceAlongLastAxis(A, 0, r.units),
      E = sliceAlongLastAxis(A, r.units, r.units);
      n = r.recurrentActivation.apply(add(f, N)),
      a = r.recurrentActivation.apply(add(m, E));
      var g = sliceAlongLastAxis(S, 2 * r.units, r.units),
      T = dot(mul(a, t), sliceAlongLastAxis(r.recurrentKernel.read(), 2 * r.units, r.units));
...
var GRU = function (e) {
function t(t) {
  return 0 === t.implementation && console.warn('`implementation=0` has been deprecated, and now defaults to `implementation=1`. Please update your layer call.'),
  t.cell = new GRUCell(t),
  e.call(this, t) || this
}
return __extends$26(t, e),
t.prototype.call = function (t, r) {
...
function t(t) {
  ...
  r.recurrentInitializer = getInitializer(t.recurrentInitializer || r.DEFAULT_RECURRENT_INITIALIZER),
  r.biasInitializer = getInitializer(t.biasInitializer || r.DEFAULT_BIAS_INITIALIZER),
  r.unitForgetBias = t.unitForgetBias,
  r.kernelRegularizer = getRegularizer(t.kernelRegularizer),
  r.recurrentRegularizer = getRegularizer(t.recurrentRegularizer),
  r.biasRegularizer = getRegularizer(t.biasRegularizer),
  r.kernelConstraint = getConstraint(t.kernelConstraint),
...
t.prototype.build = function (e) {
  ...
  if (this.useBias) {
    ...
    this.bias = this.addWeight('bias', [
      4 * this.units
    ], null, r, this.biasRegularizer, !0, this.biasConstraint)
  } else this.bias = null;
  this.built = !0;
  var o
},
  ...
  return tidy(function () {
    ...
    if (1 === r.implementation) {
      ...
      if (r.useBias) {
        ...
        A = sliceAlongFirstAxis(r.bias.read(), r.units, r.units),
        N = sliceAlongFirstAxis(r.bias.read(), 2 * r.units, r.units),
      ...
      O = t,
      P = t;
      a = r.recurrentActivation.apply(add(b, dot(T, d))),
      o = r.recurrentActivation.apply(add(x, dot(I, h))),
      i = add(mul(o, n), mul(a, r.activation.apply(add(w, dot(O, f))))),
      s = r.recurrentActivation.apply(add(_, dot(P, m)))
    } else {
      var R = dot(e, r.kernel.read());
      R = add(R, dot(t, r.recurrentKernel.read())),
      r.useBias && (R = biasAdd(R, r.bias.read()));
      var k = sliceAlongLastAxis(R, 0, r.units),
      C = sliceAlongLastAxis(R, r.units, r.units),
      D = sliceAlongLastAxis(R, 2 * r.units, r.units),
      M = sliceAlongLastAxis(R, 3 * r.units, r.units);
      a = r.recurrentActivation.apply(k),
      o = r.recurrentActivation.apply(C),
      i = add(mul(o, n), mul(a, r.activation.apply(D))),
      s = r.recurrentActivation.apply(M)
    }
...
function t(t) {
  var r = e.call(this, t) || this;
  return r.cells = t.cells,
  r
}
return __extends$26(t, e),
Object.defineProperty(t.prototype, 'stateSize', {
  get: function () {
    for (var e = [
    ], t = 0, r = this.cells.slice().reverse(); t < r.length; t++) {
      var n = r[t];
...
t.prototype.call = function (e, t) {
  var r = this;
  return tidy(function () {
    for (var n = (e = e).slice(1), a = [
    ], o = 0, i = r.cells.slice().reverse(); o < i.length; o++) {
      c = i[o];
      Array.isArray(c.stateSize) ? a.push(n.splice(0, c.stateSize.length))  : a.push(n.splice(0, 1))
    }
    a.reverse();
    for (var s, u = [
    ], l = 0; l < r.cells.length; ++l) {
      var c = r.cells[l];
      n = a[l],
      s = 0 === l ? [
        e[0]
...
t.prototype.build = function (e) {
  ...
  for (var t, r = 0, n = this.cells; r < n.length; r++) {
    var a = n[r];
    a.build(e),
    t = Array.isArray(a.stateSize) ? a.stateSize[0] : a.stateSize,
    e = [
      e[0],
      t
    ]
...
t.prototype.setWeights = function (e) {
  for (var t = [
  ], r = 0, n = this.cells; r < n.length; r++) for (var a = n[r], o = a.weights.length, i = e.splice(o), s = 0; s < a.weights.length; ++s) t.push([a.weights[s],
  i[s]]);
  batchSetValue(t)
},
t.className = 'StackedRNNCells',
t
}(RNNCell);
...
function t(t) {
  var r = e.call(this, t) || this;
  return r.layer = t.layer,
  r
}
return __extends$27(t, e),
t.prototype.build = function (e) {
  this.built = !0
},
...
t.prototype.build = function (t) {
  ...
  this.layer.built || (this.layer.build(r), this.layer.built = !0),
  e.prototype.build.call(this, t)
},
t.prototype.computeOutputShape = function (e) {
  var t = [
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    ...
    ], !1, null, null, !1, e.shape[1]) [1]
  })
},
t.className = 'TimeDistributed',
t
}(Wrapper);
...
function t(t) {
  var r = e.call(this, t) || this;
  r.forwardLayer = t.layer;
  var n = t.layer.getConfig();
  if (n.goBackwards = !0 !== n.goBackwards, r.backwardLayer = deserialize({
  ...
  return r._stateful = t.layer.stateful,
  r.returnSequences = t.layer.returnSequences,
  r.returnState = t.layer.returnState,
  r.supportsMasking = !0,
  r._trainable = !0,
  r.inputSpec = t.layer.inputSpec,
  r
}
return __extends$27(t, e),
Object.defineProperty(t.prototype, 'trainable', {
...
t.prototype.setWeights = function (e) {
  var t = e.length,
  r = Math.floor(t / 2);
  this.forwardLayer.setWeights(e.slice(0, r)),
  this.backwardLayer.setWeights(e.slice(r))
},
t.prototype.computeOutputShape = function (e) {
  ...
  n,
  a;
  return this.returnState ? (a = t.slice(1), r = t[0])  : r = t[0],
  r = r,
  'concat' === this.mergeMode ? (r[r.length - 1] *= 2, n = [
    r
  ...
  this.returnState ? null == this.mergeMode ? n.concat(a).concat(a.slice())  : [
    r
  ].concat(a).concat(a.slice())  : singletonOrArray(n)
},
t.prototype.apply = function (t, r) {
  var n = null;
...
t.prototype.call = function (e, t) {
  ...
  return tidy(function () {
    ...
    var n,
    a = r.forwardLayer.call(e, t),
    o = r.backwardLayer.call(e, t);
    r.returnState && (Array.isArray(a) && (n = a.slice(1).concat(o.slice(1))), a = a[0], o = o[0]),
    r.returnSequences && (o = reverse(o, 1));
    var i;
    return 'concat' === r.mergeMode ? i = concatenate([a,
    o])  : 'sum' === r.mergeMode ? i = add(a, o)  : 'ave' === r.mergeMode ? i = scalarTimesArray(getScalar(0.5), add(a, o))  : 'mul' === r.mergeMode ? i = mul(a, o)  : null == r.mergeMode && (i = [
      a,
      o
    ]),
    r.returnState ? null == r.mergeMode ? i.concat(n)  : [
      i
    ].concat(n)  : i
  })
},
...
function t(t) {
  ...
  if (t = t || {
  }, r.trainable = !0, r._updatable = !0, r.built = !1, r.name = null != t.name ? t.name : getUid('sequential_'), null != t.layers) for (var n = 0, a = t.layers; n < a.length; n++) {
    var o = a[n];
    r.add(o)
  }
  return r
}
return __extends$28(t, e),
r = t,
...
t.prototype.pop = function () {
  ...
  if (this.layers.pop(), 0 === this.layers.length) this.outputs = [
  ],
  this.inboundNodes = [
  ],
  this.outboundNodes = [
...
Object.defineProperty(t.prototype, 'updatable', {
  ...
  set: function (e) {
    this.built && (this.model.updatable = e),
    this._updatable = e
  },
  enumerable: !0,
  configurable: !0
...
t.className = 'Sequential',
__decorate$38([doc()], t.prototype, 'add', null),
__decorate$38([doc()], t.prototype, 'evaluate', null),
__decorate$38([doc()], t.prototype, 'predict', null),
__decorate$38([doc()], t.prototype, 'fit', null),
t = r = __decorate$38([doc()], t);
var r
}(Model);
...
__decorate$39([doc()], e, 'model', null),
__decorate$39([doc()], e, 'sequential', null),
__decorate$39([doc()], e, 'loadModel', null),
__decorate$39([doc()], e, 'input', null),
e
}(),
...
e.RNN = RNN,
e.RNNCell = RNNCell,
e.input = ModelExports.input,
__decorate$39([doc()], e, 'inputLayer', null),
__decorate$39([doc()], e, 'elu', null),
__decorate$39([doc()], e, 'leakyReLU', null),
__decorate$39([doc()], e, 'softmax', null),
__decorate$39([doc()], e, 'thresholdedReLU', null),
__decorate$39([doc()], e, 'conv1d', null),
__decorate$39([doc()], e, 'conv2d', null),
__decorate$39([doc()], e, 'conv2dTranspose', null),
__decorate$39([doc()], e, 'separableConv2d', null),
__decorate$39([doc()], e, 'cropping2D', null),
__decorate$39([doc()], e, 'depthwiseConv2d', null),
__decorate$39([doc()], e, 'activation', null),
__decorate$39([doc()], e, 'dense', null),
__decorate$39([doc()], e, 'dropout', null),
__decorate$39([doc()], e, 'flatten', null),
__decorate$39([doc()], e, 'repeatVector', null),
__decorate$39([doc()], e, 'reshape', null),
__decorate$39([doc()], e, 'embedding', null),
__decorate$39([doc()], e, 'add', null),
__decorate$39([doc()], e, 'average', null),
__decorate$39([doc()], e, 'concatenate', null),
__decorate$39([doc()], e, 'maximum', null),
__decorate$39([doc()], e, 'minimum', null),
__decorate$39([doc()], e, 'multiply', null),
__decorate$39([doc()], e, 'batchNormalization', null),
__decorate$39([doc()], e, 'zeroPadding2d', null),
__decorate$39([doc()], e, 'averagePooling1d', null),
__decorate$39([doc()], e, 'averagePooling2d', null),
__decorate$39([doc()], e, 'globalAveragePooling1d', null),
__decorate$39([doc()], e, 'globalAveragePooling2d', null),
__decorate$39([doc()], e, 'globalMaxPooling1d', null),
__decorate$39([doc()], e, 'globalMaxPooling2d', null),
__decorate$39([doc()], e, 'maxPooling1d', null),
__decorate$39([doc()], e, 'maxPooling2d', null),
__decorate$39([doc()], e, 'gru', null),
__decorate$39([doc()], e, 'gruCell', null),
__decorate$39([doc()], e, 'lstm', null),
__decorate$39([doc()], e, 'lstmCell', null),
__decorate$39([doc()], e, 'simpleRNN', null),
__decorate$39([doc()], e, 'simpleRNNCell', null),
__decorate$39([doc()], e, 'rnn', null),
__decorate$39([doc()], e, 'stackedRNNCells', null),
__decorate$39([doc()], e, 'bidirectional', null),
__decorate$39([doc()], e, 'timeDistributed', null),
e
}(),
...
__decorate$39([doc()], e, 'maxNorm', null),
__decorate$39([doc()], e, 'unitNorm', null),
__decorate$39([doc()], e, 'nonNeg', null),
__decorate$39([doc()], e, 'minMaxNorm', null),
e
}(),
...
__decorate$39([doc()], e, 'zeros', null),
__decorate$39([doc()], e, 'ones', null),
__decorate$39([doc()], e, 'constant', null),
__decorate$39([doc()], e, 'randomUniform', null),
__decorate$39([doc()], e, 'randomNormal', null),
__decorate$39([doc()], e, 'truncatedNormal', null),
__decorate$39([doc()], e, 'identity', null),
__decorate$39([doc()], e, 'varianceScaling', null),
__decorate$39([doc()], e, 'glorotUniform', null),
__decorate$39([doc()], e, 'glorotNormal', null),
__decorate$39([doc()], e, 'heNormal', null),
__decorate$39([doc()], e, 'leCunNormal', null),
__decorate$39([doc()], e, 'orthogonal', null),
e
}(),
...
__decorate$39([doc()], e.prototype, 'meanAbsoluteError', null),
__decorate$39([doc()], e.prototype, 'meanAbsolutePercentageError', null),
__decorate$39([doc()], e, 'binaryAccuracy', null),
__decorate$39([doc()], e, 'binaryCrossentropy', null),
__decorate$39([doc()], e, 'categoricalAccuracy', null),
__decorate$39([doc()], e, 'categoricalCrossentropy', null),
__decorate$39([doc()], e, 'cosineProximity', null),
__decorate$39([doc()], e, 'meanSquaredError', null),
e
}(),
...
__decorate$39([doc()], e, 'l1l2', null),
__decorate$39([doc()], e, 'l1', null),
__decorate$39([doc()], e, 'l2', null),
e
}(),
...
!function (r) {
  ...
  function o(e, t) {
    ...
    n + a((e = e.replace(O, '.')).split('.'), t).join('.')
  }
  function i(e) {
    for (var t, r, n = [
    ], a = 0, o = e.length; a < o; ) (t = e.charCodeAt(a++)) >= 55296 && t <= 56319 && a < o ? 56320 == (64512 & (r = e.charCodeAt(a++))) ? n.push(((1023 & t) << 10) + (1023 & r) + 65536)  : (n.push(t), a--)  : n.push(t);
    return n
  }
  function s(e) {
  ...
  function c(e, t, r) {
    var n = 0;
    for (e = r ? k(e / S)  : e >> 1, e += k(e / t); e > R * w >> 1; n += b) e = k(e / R);
    return k(n + (R + 1) * e / (e + _))
  }
  function p(e) {
    var t,
    r,
    ...
    _ = N,
    S = A;
    for ((r = e.lastIndexOf(E)) < 0 && (r = 0), a = 0; a < r; ++a) e.charCodeAt(a) >= 128 && n('not-basic'),
    m.push(e.charCodeAt(a));
    for (o = r > 0 ? r + 1 : 0; o < g; ) {
      for (i = y, l = 1, p = b; o >= g && n('invalid-input'), ((d = u(e.charCodeAt(o++))) >= b || d > k((v - y) / l)) && n('overflow'), y += d * l, h = p <= S ? x : p >= S + w ? w : p - S, !(d < h); p += b) l > k(v / (f = b - h)) && n('overflow'),
      l *= f;
      S = c(y - i, t = m.length + 1, 0 == i),
      k(y / t) > v - _ && n('overflow'),
      _ += k(y / t),
      y %= t,
      m.splice(y++, 0, _)
    }
  ...
  function d(e) {
    ...
    for (g = (e = i(e)).length, t = N, r = 0, s = A, u = 0; u < g; ++u) (m = e[u]) < 128 && T.push(C(m));
    for (a = o = T.length, o && T.push(E); a < g; ) {
      for (p = v, u = 0; u < g; ++u) (m = e[u]) >= t && m < p && (p = m);
      for (p - t > k((v - r) / (y = a + 1)) && n('overflow'), r += (p - t) * y, t = p, u = 0; u < g; ++u) if ((m = e[u]) < t && ++r > v && n('overflow'), m == t) {
        for (d = r, h = b; f = h <= s ? x : h >= s + w ? w : h - s, !(d < f); h += b) S = d - f,
        _ = b - f,
        T.push(C(l(f + S % _, 0))),
        d = k(S / _);
        T.push(C(l(d, 0))),
  ...
  }, h && f) if (e.exports == h) f.exports = g;
   else for (y in g) g.hasOwnProperty(y) && (h[y] = g[y]);
   else r.punycode = g
}(commonjsGlobal)
}),
util$1 = {
...
for (var u = 0; u < s; ++u) {
  ...
  h = e[u].replace(o, '%20'),
  f = h.indexOf(r);
  f >= 0 ? (l = h.substr(0, f), c = h.substr(f + 1))  : (l = h, c = ''),
  p = decodeURIComponent(l),
  d = decodeURIComponent(c),
  hasOwnProperty(a, p) ? Array.isArray(a[p]) ? a[p].push(d)  : a[p] = [
    a[p],
    d
  ] : a[p] = d
}
...
t.decode = t.parse = decode,
t.encode = t.stringify = encode
}),
...
if (s = s.trim(), !r && 1 === e.split('#').length) {
  ...
  if (u) return this.path = s,
  this.href = s,
  this.pathname = u[1],
  u[2] ? (this.search = u[2], this.query = t ? querystring.parse(this.search.substr(1))  : this.search.substr(1))  : t && (this.search = '', this.query = {
  }),
  this
}
...
if (!hostlessProtocol[l] && (p || l && !slashedProtocol[l])) {
  ...
  var f,
  m;
  - 1 !== (m = - 1 === d ? s.lastIndexOf('@')  : s.lastIndexOf('@', d)) && (f = s.slice(0, m), s = s.slice(m + 1), this.auth = decodeURIComponent(f)),
  d = - 1;
  for (h = 0; h < nonHostChars.length; h++) {
    var g = s.indexOf(nonHostChars[h]);
    - 1 !== g && ( - 1 === d || g < d) && (d = g)
  }
  - 1 === d && (d = s.length),
  ...
  if (!y) for (var v = this.hostname.split(/\./), h = 0, b = v.length; h < b; h++) {
    var x = v[h];
  ...
  this.host = I + T,
  this.href += this.host,
  y && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), '/' !== s[0] && (s = '/' + s))
}
if (!unsafeProtocol[c]) for (var h = 0, b = autoEscape.length; h < b; h++) {
  var O = autoEscape[h];
  if ( - 1 !== s.indexOf(O)) {
...
var k = s.indexOf('?');
if ( - 1 !== k ? (this.search = s.substr(k), this.query = s.substr(k + 1), t && (this.query = querystring.parse(this.query)), s = s.slice(0, k))  : t && (this.search = '', this.query = {
}), s && (this.pathname = s), slashedProtocol[c] && this.hostname && !this.pathname && (this.pathname = '/'), this.pathname || this.search) {
  var T = this.pathname || '',
  C = this.search || '';
  this.path = T + C
}
...
this.query && util$1.isObject(this.query) && Object.keys(this.query).length && (o = querystring.stringify(this.query));
var i = this.search || o && '?' + o || '';
return t && ':' !== t.substr( - 1) && (t += ':'),
this.slashes || (!t || slashedProtocol[t]) && !1 !== a ? (a = '//' + (a || ''), r && '/' !== r.charAt(0) && (r = '/' + r))  : a || (a = ''),
n && '#' !== n.charAt(0) && (n = '#' + n),
i && '?' !== i.charAt(0) && (i = '?' + i),
...
if (e.slashes && !e.protocol) {
  ...
  return slashedProtocol[r.protocol] && r.hostname && !r.pathname && (r.path = r.pathname = '/'),
  r.href = r.format(),
  r
}
...
if (x && (r.hostname = '', r.port = null, r.host && ('' === v[0] ? v[0] = r.host : v.unshift(r.host)), r.host = '', e.protocol && (e.hostname = null, e.port = null, e.host && ('' === b[0] ? b[0] = e.host : b.unshift(e.host)), e.host = null), g = g && ('' === b[0] || '' === v[0])), m) r.host = e.host || '' === e.host ? e.host : r.host,
r.hostname = e.hostname || '' === e.hostname ? e.hostname : r.hostname,
r.search = e.search,
r.query = e.query,
v = b;
 else if (b.length) v || (v = [
]),
v.pop(),
v = v.concat(b),
r.search = e.search,
r.query = e.query;
 else if (!util$1.isNullOrUndefined(e.search)) return x && (r.hostname = r.host = v.shift(), (E = !!(r.host && r.host.indexOf('@') > 0) && r.host.split('@')) && (r.auth = E.shift(), r.host = r.hostname = E.shift())),
r.search = e.search,
r.query = e.query,
util$1.isNull(r.pathname) && util$1.isNull(r.search) || (r.path = (r.pathname ? r.pathname : '') + (r.search ? r.search : '')),
r.href = r.format(),
r;
if (!v.length) return r.pathname = null,
r.search ? r.path = '/' + r.search : r.path = null,
r.href = r.format(),
r;
for (var w = v.slice( - 1) [0], _ = (r.host || e.host || v.length > 1) && ('.' === w || '..' === w) || '' === w, S = 0, A = v.length; A >= 0; A--) '.' === (w = v[A]) ? v.splice(A, 1)  : '..' === w ? (v.splice(A, 1), S++)  : S && (v.splice(A, 1), S--);
if (!g && !y) for (; S--; S) v.unshift('..');
!g || '' === v[0] || v[0] && '/' === v[0].charAt(0) || v.unshift(''),
_ && '/' !== v.join('/').substr( - 1) && v.push('');
var N = '' === v[0] || v[0] && '/' === v[0].charAt(0);
if (x) {
  r.hostname = r.host = N ? '' : v.length ? v.shift()  : '';
  var E = !!(r.host && r.host.indexOf('@') > 0) && r.host.split('@');
  E && (r.auth = E.shift(), r.host = r.hostname = E.shift())
}
return (g = g || r.host && v.length) && !N && v.unshift(''),
v.length ? r.pathname = v.join('/')  : (r.pathname = null, r.path = null),
util$1.isNull(r.pathname) && util$1.isNull(r.search) || (r.path = (r.pathname ? r.pathname : '') + (r.search ? r.search : '')),
...
r.encode = function (e, t, r) {
  ...
  return u && (i[s++] = n[a], i[s++] = 61, 1 === u && (i[s++] = 61)),
  o ? (s && o.push(String.fromCharCode.apply(String, i.slice(0, s))), o.join(''))  : String.fromCharCode.apply(String, i.slice(0, s))
};
...
if (t) {
  for (var r = [
  ], n = 1; n < arguments.length; ) r.push(arguments[n++]);
...
r.read = function (e, t, r) {
  if (r - t < 1) return '';
  for (var n, a = null, o = [
  ], i = 0; t < r; ) (n = e[t++]) < 128 ? o[i++] = n : n > 191 && n < 224 ? o[i++] = (31 & n) << 6 | 63 & e[t++] : n > 239 && n < 365 ? (n = ((7 & n) << 18 | (63 & e[t++]) << 12 | (63 & e[t++]) << 6 | 63 & e[t++]) - 65536, o[i++] = 55296 + (n >> 10), o[i++] = 56320 + (1023 & n))  : o[i++] = (15 & n) << 12 | (63 & e[t++]) << 6 | 63 & e[t++],
  i > 8191 && ((a || (a = [
  ])).push(String.fromCharCode.apply(String, o)), i = 0);
...
a.isNode = Boolean(commonjsGlobal.process && commonjsGlobal.process.versions && commonjsGlobal.process.versions.node),
...
a.Long = commonjsGlobal.dcodeIO && commonjsGlobal.dcodeIO.Long || a.inquire('long'),
...
a.merge = r,
a.lcFirst = function (e) {
  return e.charAt(0).toLowerCase() + e.substring(1)
},
a.newError = n,
a.ProtocolError = n('ProtocolError'),
a.oneOfGetter = function (e) {
  for (var t = {
  }, r = 0; r < e.length; ++r) t[e[r]] = 1;
  return function () {
...
minimal.Array !== Array && (Writer.alloc = minimal.pool(Writer.alloc, minimal.Array.prototype.subarray)),
...
return this.states ? (this.head = this.states.head, this.tail = this.states.tail, this.len = this.states.len, this.states = this.states.next)  : (this.head = this.tail = new Op(noop, 0, 0), this.len = 0),
this
},
...
t && this._push(writeBytesBuffer, t, e),
this
},
...
Service.prototype.rpcCall = function e(t, r, n, a, o) {
    ...
    o(e);
    {
      if (null !== r) {
        if (!(r instanceof n)) try {
          ...
          return i.emit('error', e, t),
          o(e)
        }
        return i.emit('data', r, t),
        o(null, r)
      }
      i.end(!0)
    }
...
e.DataType = function () {
  ...
  t[e[6] = 'DT_INT8'] = 6,
  t[e[7] = 'DT_STRING'] = 7,
  t[e[8] = 'DT_COMPLEX64'] = 8,
  t[e[9] = 'DT_INT64'] = 9,
  t[e[10] = 'DT_BOOL'] = 10,
  t[e[11] = 'DT_QINT8'] = 11,
  t[e[12] = 'DT_QUINT8'] = 12,
  t[e[13] = 'DT_QINT32'] = 13,
  t[e[14] = 'DT_BFLOAT16'] = 14,
  t[e[101] = 'DT_FLOAT_REF'] = 101,
  t[e[102] = 'DT_DOUBLE_REF'] = 102,
  t[e[103] = 'DT_INT32_REF'] = 103,
  t[e[104] = 'DT_UINT8_REF'] = 104,
  t[e[105] = 'DT_INT16_REF'] = 105,
  t[e[106] = 'DT_INT8_REF'] = 106,
  t[e[107] = 'DT_STRING_REF'] = 107,
  t[e[108] = 'DT_COMPLEX64_REF'] = 108,
  t[e[109] = 'DT_INT64_REF'] = 109,
  t[e[110] = 'DT_BOOL_REF'] = 110,
  t[e[111] = 'DT_QINT8_REF'] = 111,
  t[e[112] = 'DT_QUINT8_REF'] = 112,
  t[e[113] = 'DT_QINT32_REF'] = 113,
  t[e[114] = 'DT_BFLOAT16_REF'] = 114,
  t
}(),
e.TensorShape = function () {
  function e(e) {
    if (this.dim = [
    ], e) for (var t = Object.keys(e), r = 0; r < t.length; ++r) null != e[t[r]] && (this[t[r]] = e[t[r]])
  }
  return e.prototype.dim = $util.emptyArray,
  e.prototype.unknownRank = !1,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.TensorShape; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        case 2:
          n.dim && n.dim.length || (n.dim = [
          ]),
          n.dim.push($root.tensorflow.TensorShape.Dim.decode(e, e.uint32()));
          break;
        case 3:
  ...
  e.Dim = function () {
    ...
    return e.prototype.size = $util.Long ? $util.Long.fromBits(0, 0, !1)  : 0,
    e.prototype.name = '',
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
...
e.Tensor = function () {
  ...
  return e.prototype.dtype = 0,
  e.prototype.tensorShape = null,
  e.prototype.versionNumber = 0,
  e.prototype.tensorContent = $util.newBuffer([]),
  e.prototype.floatVal = $util.emptyArray,
  e.prototype.doubleVal = $util.emptyArray,
  e.prototype.intVal = $util.emptyArray,
  e.prototype.stringVal = $util.emptyArray,
  e.prototype.scomplexVal = $util.emptyArray,
  e.prototype.int64Val = $util.emptyArray,
  e.prototype.boolVal = $util.emptyArray,
  e.prototype.uint32Val = $util.emptyArray,
  e.prototype.uint64Val = $util.emptyArray,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.Tensor; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        ...
        case 4:
          ...
          break;
        case 5:
          if (n.floatVal && n.floatVal.length || (n.floatVal = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.floatVal.push(e.float());
           else n.floatVal.push(e.float());
          break;
        case 6:
          if (n.doubleVal && n.doubleVal.length || (n.doubleVal = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.doubleVal.push(e.double());
           else n.doubleVal.push(e.double());
          break;
        case 7:
          if (n.intVal && n.intVal.length || (n.intVal = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.intVal.push(e.int32());
           else n.intVal.push(e.int32());
          break;
        case 8:
          n.stringVal && n.stringVal.length || (n.stringVal = [
          ]),
          n.stringVal.push(e.bytes());
          break;
        case 9:
          if (n.scomplexVal && n.scomplexVal.length || (n.scomplexVal = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.scomplexVal.push(e.float());
           else n.scomplexVal.push(e.float());
          break;
        case 10:
          if (n.int64Val && n.int64Val.length || (n.int64Val = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.int64Val.push(e.int64());
           else n.int64Val.push(e.int64());
          break;
        case 11:
          if (n.boolVal && n.boolVal.length || (n.boolVal = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.boolVal.push(e.bool());
           else n.boolVal.push(e.bool());
          break;
        case 16:
          if (n.uint32Val && n.uint32Val.length || (n.uint32Val = [
          ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.uint32Val.push(e.uint32());
           else n.uint32Val.push(e.uint32());
          break;
        case 17:
          if (n.uint64Val && n.uint64Val.length || (n.uint64Val = [
          ]), 2 == (7 & a)) for (var o = e.uint32() + e.pos; e.pos < o; ) n.uint64Val.push(e.uint64());
...
e.AttrValue = function () {
  ...
  e.prototype.s = $util.newBuffer([]),
  e.prototype.i = $util.Long ? $util.Long.fromBits(0, 0, !1)  : 0,
  e.prototype.f = 0,
  e.prototype.b = !1,
  e.prototype.type = 0,
  e.prototype.shape = null,
  e.prototype.tensor = null,
  e.prototype.placeholder = '',
  e.prototype.func = null;
  var t = void 0;
  return Object.defineProperty(e.prototype, 'value', {
    get: $util.oneOfGetter(t = [
      'list',
      's',
      'i',
      'f',
  ...
  e.ListValue = function () {
    ...
    return e.prototype.s = $util.emptyArray,
    e.prototype.i = $util.emptyArray,
    e.prototype.f = $util.emptyArray,
    e.prototype.b = $util.emptyArray,
    e.prototype.type = $util.emptyArray,
    e.prototype.shape = $util.emptyArray,
    e.prototype.tensor = $util.emptyArray,
    e.prototype.func = $util.emptyArray,
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
      for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.AttrValue.ListValue; e.pos < r; ) {
        ...
        switch (a >>> 3) {
          case 2:
            ...
            break;
          case 3:
            if (n.i && n.i.length || (n.i = [
            ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.i.push(e.int64());
             else n.i.push(e.int64());
            break;
          case 4:
            if (n.f && n.f.length || (n.f = [
            ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.f.push(e.float());
             else n.f.push(e.float());
            break;
          case 5:
            if (n.b && n.b.length || (n.b = [
            ]), 2 == (7 & a)) for (o = e.uint32() + e.pos; e.pos < o; ) n.b.push(e.bool());
             else n.b.push(e.bool());
            break;
          case 6:
            if (n.type && n.type.length || (n.type = [
            ]), 2 == (7 & a)) for (var o = e.uint32() + e.pos; e.pos < o; ) n.type.push(e.int32());
             else n.type.push(e.int32());
            break;
          case 7:
            n.shape && n.shape.length || (n.shape = [
            ]),
            n.shape.push($root.tensorflow.TensorShape.decode(e, e.uint32()));
            break;
          case 8:
            n.tensor && n.tensor.length || (n.tensor = [
            ]),
            n.tensor.push($root.tensorflow.Tensor.decode(e, e.uint32()));
            break;
          case 9:
            n.func && n.func.length || (n.func = [
            ]),
            n.func.push($root.tensorflow.NameAttrList.decode(e, e.uint32()));
            break;
          default:
            e.skipType(7 & a)
        }
...
e.NameAttrList = function () {
  ...
  e.prototype.attr = $util.emptyObject,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r, n = void 0 === t ? e.len : e.pos + t, a = new $root.tensorflow.NameAttrList; e.pos < n; ) {
      ...
      switch (o >>> 3) {
        ...
        case 2:
          e.skip().pos++,
          a.attr === $util.emptyObject && (a.attr = {
          }),
          r = e.string(),
          e.pos++,
          a.attr[r] = $root.tensorflow.AttrValue.decode(e, e.uint32());
          break;
        default:
          e.skipType(7 & o)
      }
...
e.NodeDef = function () {
  ...
  return e.prototype.name = '',
  e.prototype.op = '',
  e.prototype.input = $util.emptyArray,
  e.prototype.device = '',
  e.prototype.attr = $util.emptyObject,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
...
e.VersionDef = function () {
  function e(e) {
    if (this.badConsumers = [
    ], e) for (var t = Object.keys(e), r = 0; r < t.length; ++r) null != e[t[r]] && (this[t[r]] = e[t[r]])
  }
  return e.prototype.producer = 0,
  e.prototype.minConsumer = 0,
  e.prototype.badConsumers = $util.emptyArray,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.VersionDef; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        ...
        case 2:
          ...
          break;
        case 3:
          if (n.badConsumers && n.badConsumers.length || (n.badConsumers = [
          ]), 2 == (7 & a)) for (var o = e.uint32() + e.pos; e.pos < o; ) n.badConsumers.push(e.int32());
...
e.GraphDef = function () {
  ...
  return e.prototype.node = $util.emptyArray,
  e.prototype.versions = null,
  e.prototype.library = null,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.GraphDef; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        case 1:
          n.node && n.node.length || (n.node = [
          ]),
          n.node.push($root.tensorflow.NodeDef.decode(e, e.uint32()));
          break;
        case 4:
...
e.CollectionDef = function () {
  ...
  e.prototype.nodeList = null,
  e.prototype.bytesList = null,
  e.prototype.int64List = null,
  e.prototype.floatList = null,
  e.prototype.anyList = null;
  var t = void 0;
  ...
  e.NodeList = function () {
    ...
    return e.prototype.value = $util.emptyArray,
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
      for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.CollectionDef.NodeList; e.pos < r; ) {
        ...
        switch (a >>> 3) {
          case 1:
            n.value && n.value.length || (n.value = [
            ]),
            n.value.push(e.string());
            break;
          default:
            e.skipType(7 & a)
        }
  ...
  e.Int64List = function () {
    ...
    e.decode = function (e, t) {
      ...
      for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.CollectionDef.Int64List; e.pos < r; ) {
        ...
        switch (a >>> 3) {
          case 1:
            if (n.value && n.value.length || (n.value = [
            ]), 2 == (7 & a)) for (var o = e.uint32() + e.pos; e.pos < o; ) n.value.push(e.int64());
    ...
    e.decode = function (e, t) {
      ...
      for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.CollectionDef.FloatList; e.pos < r; ) {
        ...
        switch (a >>> 3) {
          case 1:
            if (n.value && n.value.length || (n.value = [
            ]), 2 == (7 & a)) for (var o = e.uint32() + e.pos; e.pos < o; ) n.value.push(e.float());
      ...
      for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.CollectionDef.AnyList; e.pos < r; ) {
        ...
        switch (a >>> 3) {
          case 1:
            ...
            n.value.push($root.tensorflow.Any.decode(e, e.uint32()));
            break;
          default:
            e.skipType(7 & a)
        }
...
e.SaverDef = function () {
  ...
  return e.prototype.filenameTensorName = '',
  e.prototype.saveTensorName = '',
  e.prototype.restoreOpName = '',
  e.prototype.maxToKeep = 0,
  e.prototype.sharded = !1,
  e.prototype.keepCheckpointEveryNHours = 0,
...
e.TensorInfo = function () {
  ...
  e.CooSparse = function () {
    ...
    return e.prototype.valuesTensorName = '',
    e.prototype.indicesTensorName = '',
    e.prototype.denseShapeTensorName = '',
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
...
e.SignatureDef = function () {
  ...
  return e.prototype.inputs = $util.emptyObject,
  e.prototype.outputs = $util.emptyObject,
  e.prototype.methodName = '',
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r, n = void 0 === t ? e.len : e.pos + t, a = new $root.tensorflow.SignatureDef; e.pos < n; ) {
      ...
      switch (o >>> 3) {
        case 1:
          e.skip().pos++,
          a.inputs === $util.emptyObject && (a.inputs = {
          }),
          r = e.string(),
          e.pos++,
          a.inputs[r] = $root.tensorflow.TensorInfo.decode(e, e.uint32());
          break;
        case 2:
          e.skip().pos++,
          a.outputs === $util.emptyObject && (a.outputs = {
          }),
          r = e.string(),
          e.pos++,
          a.outputs[r] = $root.tensorflow.TensorInfo.decode(e, e.uint32());
          break;
        case 3:
...
e.AssetFileDef = function () {
  ...
  return e.prototype.tensorInfo = null,
...
e.OpDef = function () {
  ...
  return e.prototype.name = '',
  e.prototype.inputArg = $util.emptyArray,
  e.prototype.outputArg = $util.emptyArray,
  e.prototype.attr = $util.emptyArray,
  e.prototype.deprecation = null,
  e.prototype.summary = '',
  e.prototype.description = '',
  e.prototype.isCommutative = !1,
  e.prototype.isAggregate = !1,
  e.prototype.isStateful = !1,
  e.prototype.allowsUninitializedInput = !1,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.OpDef; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        case 1:
          ...
          break;
        case 2:
          n.inputArg && n.inputArg.length || (n.inputArg = [
          ]),
          n.inputArg.push($root.tensorflow.OpDef.ArgDef.decode(e, e.uint32()));
          break;
        case 3:
          n.outputArg && n.outputArg.length || (n.outputArg = [
          ]),
          n.outputArg.push($root.tensorflow.OpDef.ArgDef.decode(e, e.uint32()));
          break;
        case 4:
          n.attr && n.attr.length || (n.attr = [
          ]),
          n.attr.push($root.tensorflow.OpDef.AttrDef.decode(e, e.uint32()));
          break;
        case 8:
  ...
  e.ArgDef = function () {
    ...
    e.prototype.description = '',
    e.prototype.type = 0,
    e.prototype.typeAttr = '',
    e.prototype.numberAttr = '',
    e.prototype.typeListAttr = '',
    e.prototype.isRef = !1,
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
  ...
  e.AttrDef = function () {
    ...
    e.prototype.description = '',
    e.prototype.hasMinimum = !1,
    e.prototype.minimum = $util.Long ? $util.Long.fromBits(0, 0, !1)  : 0,
    e.prototype.allowedValues = null,
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
...
e.OpList = function () {
  ...
  return e.prototype.op = $util.emptyArray,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.OpList; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        case 1:
          n.op && n.op.length || (n.op = [
          ]),
          n.op.push($root.tensorflow.OpDef.decode(e, e.uint32()));
          break;
        default:
          e.skipType(7 & a)
      }
...
e.MetaGraphDef = function () {
  ...
  return e.prototype.metaInfoDef = null,
  e.prototype.graphDef = null,
  e.prototype.saverDef = null,
  e.prototype.collectionDef = $util.emptyObject,
  e.prototype.signatureDef = $util.emptyObject,
  e.prototype.assetFileDef = $util.emptyArray,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r, n = void 0 === t ? e.len : e.pos + t, a = new $root.tensorflow.MetaGraphDef; e.pos < n; ) {
      ...
      switch (o >>> 3) {
        ...
        case 4:
          e.skip().pos++,
          a.collectionDef === $util.emptyObject && (a.collectionDef = {
          }),
          r = e.string(),
          e.pos++,
          a.collectionDef[r] = $root.tensorflow.CollectionDef.decode(e, e.uint32());
          break;
        case 5:
          e.skip().pos++,
          a.signatureDef === $util.emptyObject && (a.signatureDef = {
          }),
          r = e.string(),
          e.pos++,
          a.signatureDef[r] = $root.tensorflow.SignatureDef.decode(e, e.uint32());
          break;
        case 6:
          a.assetFileDef && a.assetFileDef.length || (a.assetFileDef = [
          ]),
          a.assetFileDef.push($root.tensorflow.AssetFileDef.decode(e, e.uint32()));
          break;
        default:
          e.skipType(7 & o)
      }
  ...
  e.MetaInfoDef = function () {
    ...
    return e.prototype.metaGraphVersion = '',
    e.prototype.strippedOpList = null,
    e.prototype.anyInfo = null,
    e.prototype.tags = $util.emptyArray,
    e.prototype.tensorflowVersion = '',
    e.prototype.tensorflowGitVersion = '',
    e.decode = function (e, t) {
      e instanceof $Reader || (e = $Reader.create(e));
...
e.SavedModel = function () {
  ...
  return e.prototype.savedModelSchemaVersion = $util.Long ? $util.Long.fromBits(0, 0, !1)  : 0,
  e.prototype.metaGraphs = $util.emptyArray,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.SavedModel; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        case 1:
          ...
          break;
        case 2:
          n.metaGraphs && n.metaGraphs.length || (n.metaGraphs = [
          ]),
          n.metaGraphs.push($root.tensorflow.MetaGraphDef.decode(e, e.uint32()));
          break;
        default:
          e.skipType(7 & a)
      }
...
e.FunctionDefLibrary = function () {
  ...
  return e.prototype.function = $util.emptyArray,
  e.prototype.gradient = $util.emptyArray,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r = void 0 === t ? e.len : e.pos + t, n = new $root.tensorflow.FunctionDefLibrary; e.pos < r; ) {
      ...
      switch (a >>> 3) {
        case 1:
          n.function && n.function .length || (n.function = [
          ]),
          n.function .push($root.tensorflow.FunctionDef.decode(e, e.uint32()));
          break;
        case 2:
          n.gradient && n.gradient.length || (n.gradient = [
          ]),
          n.gradient.push($root.tensorflow.GradientDef.decode(e, e.uint32()));
          break;
        default:
          e.skipType(7 & a)
      }
...
e.FunctionDef = function () {
  ...
  return e.prototype.signature = null,
  e.prototype.attr = $util.emptyObject,
  e.prototype.nodeDef = $util.emptyArray,
  e.prototype.ret = $util.emptyObject,
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
    for (var r, n = void 0 === t ? e.len : e.pos + t, a = new $root.tensorflow.FunctionDef; e.pos < n; ) {
      ...
      switch (o >>> 3) {
        ...
        case 5:
          ...
          break;
        case 3:
          a.nodeDef && a.nodeDef.length || (a.nodeDef = [
          ]),
          a.nodeDef.push($root.tensorflow.NodeDef.decode(e, e.uint32()));
          break;
        case 4:
          e.skip().pos++,
          a.ret === $util.emptyObject && (a.ret = {
          }),
          r = e.string(),
          e.pos++,
          a.ret[r] = e.string();
...
e.GradientDef = function () {
  ...
  return e.prototype.functionName = '',
  e.prototype.gradientFunc = '',
  e.decode = function (e, t) {
    e instanceof $Reader || (e = $Reader.create(e));
...
function e() {
  var e = arithmetic.concat(basicMath, control, convolution, creation, logical, image$1, graph, matrices, normalization, reduction, sliceJoin, transformation);
  this.opMappers = e.reduce(function (e, t) {
...
e.prototype.transformGraph = function (e) {
  ...
  a = e.node.reduce(function (e, a) {
    return e[a.name] = t.mapNode(a),
    t.isControlFlow(a) && (r = !0),
    'Placeholder' === a.op && n.push(e[a.name]),
    e
  }, {
  }),
  o = [
...
case 'conv2d':
  ...
  return [conv2d(getParamValue('x', e, t, r), getParamValue('filter', e, t, r), [
    n[1],
    n[2]
  ], a, o, [
    s[0],
...
case 'conv2dTranspose':
  ...
  a = getParamValue('pad', e, t, r);
  return [conv2dTranspose(getParamValue('x', e, t, r), getParamValue('filter', e, t, r), u, [
    n[1],
    n[2]
  ], a)];
case 'depthwiseConv2d':
  ...
  s = getParamValue('dilations', e, t, r),
  o = getParamValue('dataFormat', e, t, r).toUpperCase();
  return [depthwiseConv2d(getParamValue('input', e, t, r), getParamValue('filter', e, t, r), [
    n[1],
    n[2]
  ], a, o, [
    s[0],
...
case 'avgPool':
  ...
  return [avgPool(getParamValue('x', e, t, r), [
    l[1],
    l[2]
  ], [
    n[1],
...
case 'maxPool':
  ...
  a = getParamValue('pad', e, t, r),
  l = getParamValue('kernelSize', e, t, r);
  return [maxPool(getParamValue('x', e, t, r), [
    l[1],
    l[2]
  ], [
    n[1],
...
for (var e = [
], t = 0; t < this.contexts.length - 1; t++) {
...
this.placeholders = e.placeholders.map(function (e) {
  return e.name
}),
...
if (!this.graph.withControlFlow) for (var e = this.graph.inputs.slice(), t = {
}; e.length > 0; ) {
  var r = e.pop();
  t[r.name] = !0,
  this.compiledOrder.push(r),
...
tidy(function () {
  ...
  a = r.compiledOrder.reduce(function (e, t) {
    return e[t.name] = executeOp$13(t, e, n),
    e
  }, __assign$1({
  }, r.weightMap, e));
...
return __awaiter$18(this, void 0, void 0, function () {
  ...
  return __generator$18(this, function (l) {
    switch (l.label) {
      case 0:
        return r = new ExecutionContext(this._weightMap),
        [
          4,
          this.executeWithControlFlow(e, r)
        ];
      case 1:
        return n = l.sent(),
        a = this.findOutputs(n, r, t),
  ...
  return __generator$18(this, function (c) {
    switch (c.label) {
      case 0:
        ...
        c.label = 1;
      case 1:
        return r.length > 0 ? (o = r.pop(), t.currentContext = o.contexts, i = executeOp$13(o.node, n, t), s = getNodeNameAndIndex(o.node.name, t) [0], u = n, l = s, [
          4,
          i
        ])  : [
          3,
      ...
      case 2:
        return u[l] = c.sent(),
        o.node.children.forEach(function (e) {
...
(r || this.graph.outputs.map(function (e) {
  return e.name
})).reduce(function (r, n) {
  return r[n] = getTensor(n, e, t),
  r
}, {
})
},
...
function e(e, t, r) {
this.modelUrl = e,
this.weightManifestUrl = t,
this.requestOption = r,
this.version = 'n/a',
  ...
  return __generator$19(this, function (o) {
    switch (o.label) {
      case 0:
        ...
        [
          4,
          fetch(this.modelUrl, this.requestOption)
        ];
      case 1:
        return e = o.sent(),
        r = (t = tensorflow.GraphDef).decode,
        n = Uint8Array.bind,
        [
          4,
          e.arrayBuffer()
      ...
      case 3:
        throw a = o.sent(),
        new Error(this.modelUrl + ' not found. ' + a);
      case 4:
        return [2]
    }
  })
  ...
  return __generator$19(this, function (n) {
    switch (n.label) {
      case 0:
        ...
        [
          4,
          fetch(this.weightManifestUrl, this.requestOption)
        ];
      case 1:
        return e = n.sent(),
        t = this,
      ...
      case 2:
        return t.weightManifest = n.sent(),
        [
          3,
          4
        ];
      case 3:
        throw r = n.sent(),
        new Error(this.weightManifestUrl + ' not found. ' + r);
      case 4:
        return [2]
    }
  })
...
return __awaiter$19(this, void 0, void 0, function () {
  ...
  return __generator$19(this, function (a) {
    switch (a.label) {
      case 0:
        return e = this.loadRemoteProtoFile(),
      ...
      case 1:
        ...
        [
          4,
          loadWeights(this.weightManifest, this.pathPrefix, void 0, this.requestOption)
        ];
      case 2:
        return n = a.sent(),
        this.executor = new GraphExecutor(OperationMapper.Instance.transformGraph(r)),
...
e.prototype.execute = function (e, t) {
if (this.executor.isControlFlowModel) throw new Error('The model contains control flow ops, please use executeAsync method');
